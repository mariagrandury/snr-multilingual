...
Fix aromanou's rights:

her:
B=/iopsstor/scratch/cscs/mariagrandury/data-mix-small/Megatron-LM/logs/eval_logs/mariagrandury-epflnlp/msnr
find "$B" -maxdepth 1 -mindepth 1 -type d -user aromanou \
  -exec setfacl -R -m u:mariagrandury:rwx -d -m u:mariagrandury:rwx {} +
...
Diagnose 90M:
python3.11 pretrain/launch_trainings.py cscs --size 90M --langs 2 --gbs 252 --dry-run
python3.11 pretrain/launch_trainings.py cscs --size 90M --langs 2 --gbs 84  --dry-run
...
e.g.: bash scripts/reservation_drain.sh --priority diag --once --hours 6 --max-nodes 42
