...
| en | `rf_bbh_mcq_hyperbaton` | 1.5 | 0.54 | 0.6 |
| es | `paws_es` | 1.1 | 0.75 | 0.3 |
| et | `include_v2_og_estonian_estonia` | 1.8 |  | 0.3 |
...
| kk | `include_v2_en_kazakh_kazakhstan` | 0.9 |  | 0.1 |
| ko | `rf_belebele_kor_Hang` | 0.4 | 0.65 | 0.6 |
| lt | `rf_include_base_44_lithuanian` | 0.8 |  | 0.2 |
| lv | `rf_belebele_lvs_Latn` | 0.1 |  | 0.3 |
| ml | `include_v2_en_malayalam_india` | 0.7 | 0.59 | 0.3 |
| mr | `include_v2_en_marathi_india` | 0.6 |  | 0.1 |
| ms | `include_v2_en_malay_malaysia` | 0.6 |  | 0.2 |
...
| sq | `include_v2_en_albanian_albania` | 0.6 |  | 0.3 |
| sr | `rfgm_include_base_44_serbian` | 0.6 |  | 0.2 |
| sv | `include_v2_og_swedish_sweden` | 0.4 | 0.63 | 0.3 |
...
| `predictivity_seeds` | `aad` | 0.95 | 1.00 | 3 |
...
| per_benchmark | `cultural_bench_easy` | 175M | 2.47 → 3.92 | +1.45 |
...
| `acp_bench_cloze` | 0.50 | 0.49 | 0.49 | 0.49 | 0.49 | 0.49 |
| `bbh_cloze` | 0.50 | 0.47 | 0.48 | 0.48 | 0.47 | 0.47 |
| `toxigen` | 0.50 | **0.54** | 0.47 | 0.43 | 0.42 | 0.43 |
| `bbq` | 0.08 |  |  | **0.40** | **0.41** | **0.44** |
| `truthfulqa_mc2` |  | 0.45 | 0.41 | 0.40 | 0.40 | 0.41 |
| `xnli` | 0.33 | 0.35 | **0.39** | **0.41** | **0.42** | **0.44** |
| `rf_acp_bench_mcq` | 0.25 | 0.35 | **0.38** | **0.39** | **0.40** | **0.40** |
| `rf_commonsense_qa` | 0.20 | **0.29** | **0.35** | **0.39** | **0.41** | **0.46** |
| `cultural_bench_hard` | 0.50 | 0.34 | 0.34 | 0.36 | 0.38 | 0.43 |
| `include_v2_en` | 0.25 | **0.29** | **0.31** | **0.33** | **0.35** | **0.37** |
| `lambada_openai_mt` |  | 0.16 | 0.27 | 0.33 | 0.37 | 0.42 |
| `rf_mmlu` | 0.25 | **0.27** | **0.29** | **0.31** | **0.33** | **0.36** |
| `rf_bbh_mcq` | 0.17 | 0.28 | 0.30 | **0.31** | **0.32** | **0.33** |
| `cultural_bench_easy` | 0.25 | **0.45** | 0.26 | 0.30 | 0.26 | 0.27 |
| `hellaswag` | 0.25 | **0.26** | **0.28** | **0.30** | **0.32** | **0.35** |
| `rf_cultural_bench_easy` | 0.25 | 0.23 | 0.27 | 0.30 | 0.32 | 0.37 |
| `rf_belebele` | 0.25 | **0.28** | **0.29** | **0.29** | **0.31** | **0.32** |
| `include_v2_og` | 0.25 | 0.26 | 0.28 | **0.29** | **0.30** | **0.32** |
...
| `acp_bench_mcq` | 0.25 | 0.26 | 0.25 | 0.25 | 0.25 | 0.26 |
| `include_base_44` | 0.25 | 0.25 | 0.25 | 0.25 | 0.26 | 0.25 |
| `blend_sample` | 0.25 | 0.25 | 0.25 | 0.24 | 0.25 | 0.25 |
| `mmlu` | 0.25 | 0.24 | 0.25 | 0.25 | 0.25 | 0.26 |
| `bbh_mcq` | 0.17 | 0.24 | 0.25 | 0.25 | 0.25 | 0.25 |
| `belebele` | 0.25 | 0.25 | 0.24 | 0.24 | 0.24 | 0.25 |
| `global_mmlu_full` | 0.25 | 0.24 | 0.25 | 0.24 | 0.24 | 0.25 |
| `arc` | 0.25 | 0.20 | 0.22 | 0.23 | 0.25 | 0.27 |
| `mathqa` | 0.20 | **0.21** | **0.23** | **0.23** | **0.24** | **0.25** |
| `truthfulqa-multi_mc1` | 0.25 | 0.25 | 0.23 | 0.23 | 0.23 | 0.22 |
| `openbookqa` | 0.25 | 0.16 | 0.20 | 0.22 | 0.24 | **0.28** |
| `global_piqa_parallel_cloze` | 0.25 | 0.20 | 0.21 | 0.21 | 0.22 | 0.23 |
| `commonsense_qa` | 0.20 | 0.20 | 0.20 | 0.20 | 0.20 | 0.21 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `acp_bench_cloze_app` | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `acp_bench_cloze_areach` | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `acp_bench_cloze_prog` | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `bbh_cloze_sports_understanding` | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `acp_bench_cloze_just` | **1.00** | **0.87** | **1.00** | **1.00** | **0.88** | **1.00** | **1.00** | **0.89** | **0.89** | **1.00** |
| `acp_bench_cloze_val` | **1.00** | **1.00** | **1.00** | **0.87** | **1.00** | **1.00** | **0.88** | **1.00** | **0.89** | **0.89** |
| `acp_bench_cloze_land` | **1.00** | **1.00** | **1.00** | **0.87** | **1.00** | **1.00** | **0.88** | **1.00** | **0.89** | **0.89** |
| `acp_bench_cloze_reach` | **0.87** | **0.87** | **0.87** | **0.87** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `rf_bbh_mcq_geometric_shapes` | **0.87** | 0.74 | 0.74 | **1.00** | **0.88** | **0.88** | **0.88** | **0.78** | **0.78** | **0.78** |
| `hellaswag` | 0.59 | 0.48 | 0.66 | 0.70 | 0.71 | 0.69 | **0.76** | 0.72 | **0.75** | **0.86** |
| `bbh_cloze_formal_fallacies` | 0.63 | 0.63 | 0.74 | **1.00** | 0.60 | 0.59 | 0.67 | 0.53 | 0.69 | **0.78** |
...
| `openbookqa` | 0.64 | 0.48 | 0.60 | 0.60 | 0.48 | 0.59 | 0.72 | 0.60 | 0.41 | 0.58 |
| `rf_global_mmlu_full` | 0.60 | 0.45 | 0.56 | 0.54 | 0.64 | 0.47 | 0.41 | 0.61 | 0.66 | 0.74 |
| `rf_mmlu` | 0.62 | 0.50 | 0.64 | 0.59 | 0.51 | 0.56 | 0.43 | 0.70 | 0.55 | 0.59 |
| `toxigen` | 0.59 | 0.47 | 0.52 | 0.45 | 0.57 | 0.62 | 0.49 | 0.61 | 0.71 | 0.50 |
| `arc_easy` | 0.47 | 0.42 | 0.59 | 0.67 | 0.71 | 0.52 | 0.60 | 0.53 | 0.52 | 0.50 |
| `rf_belebele` | 0.46 | 0.59 | 0.63 | 0.42 | 0.51 | 0.56 | 0.62 | 0.72 | 0.45 | 0.54 |
| `mathqa` | 0.50 | 0.50 | 0.42 | 0.52 | 0.63 | 0.60 | 0.54 | 0.54 | 0.58 | 0.56 |
| `truthfulqa_mc2` | 0.48 | 0.54 | 0.42 | 0.53 | 0.51 | 0.69 | 0.59 | 0.58 | 0.51 | 0.54 |
| `rf_commonsense_qa` | 0.41 | 0.57 | 0.53 | 0.63 | 0.54 | 0.57 | 0.40 | 0.47 | 0.60 | 0.57 |
| `xnli` | 0.54 | 0.65 | 0.48 | 0.58 | 0.62 | 0.60 | 0.41 | 0.39 | 0.59 | 0.41 |
| `commonsense_qa` | 0.67 | 0.51 | 0.52 | 0.57 | 0.43 | 0.47 | 0.58 | 0.48 | 0.46 | 0.50 |
| `mmlu` | 0.48 | 0.57 | 0.51 | 0.58 | 0.43 | 0.60 | 0.40 | 0.56 | 0.68 | 0.37 |
| `global_mmlu_full` | 0.52 | 0.54 | 0.50 | 0.54 | 0.46 | 0.50 | 0.45 | 0.54 | 0.58 | 0.49 |
| `blend_sample` | 0.61 | 0.35 | 0.47 | 0.62 | 0.54 | 0.49 | 0.42 | 0.41 | 0.56 | 0.52 |
...
| `rf_bbh_mcq_disambiguation_qa` | 0.54 | 0.48 | 0.27 | 0.54 | 0.66 | 0.38 | 0.54 | 0.37 | 0.54 | 0.52 |
| `rf_bbh_mcq_snarks` | 0.50 | 0.42 | 0.55 | 0.52 | 0.54 | 0.48 | 0.44 | 0.49 | 0.44 | 0.45 |
| `rf_cultural_bench_easy_canada` | 0.49 | 0.41 | 0.40 | 0.49 | 0.62 | 0.49 | 0.68 | 0.37 | 0.40 | 0.49 |
| `acp_bench_mcq_areach` | 0.44 | 0.47 | 0.50 | 0.47 | 0.49 | 0.51 | 0.32 | 0.61 | 0.48 | 0.52 |
| `rf_acp_bench_mcq_just` | 0.42 | 0.44 | 0.61 | **0.75** | 0.46 | 0.38 | 0.33 | 0.54 | 0.37 | 0.48 |
| `belebele` | 0.51 | 0.63 | 0.42 | 0.44 | 0.41 | 0.42 | 0.41 | 0.59 | 0.48 | 0.45 |
| `rf_bbh_mcq_hyperbaton` | 0.32 | 0.50 | 0.50 | 0.58 | 0.41 | 0.33 | 0.40 | 0.57 | 0.60 | 0.45 |
| `multiblimp` | 0.66 | 0.52 | 0.35 | 0.58 | 0.39 | 0.42 | 0.52 | 0.43 | 0.46 | 0.31 |
| `rf_acp_bench_mcq_app` | 0.33 | 0.63 | 0.52 | 0.37 | 0.33 | 0.45 | 0.40 | 0.55 | 0.44 | 0.57 |
| `rf_bbh_mcq_movie_recommendation` | 0.43 | 0.50 | 0.56 | 0.41 | 0.51 | 0.43 | 0.44 | 0.45 | 0.50 | 0.37 |
| `cultural_bench_hard_south_africa` | 0.50 | 0.45 | 0.48 | 0.39 | 0.47 | 0.46 | 0.55 | 0.54 | 0.39 | 0.37 |
| `rf_bbh_mcq_logical_deduction_seven_objects` | 0.35 | 0.42 | 0.41 | 0.50 | 0.51 | 0.47 | 0.43 | 0.52 | 0.53 | 0.44 |
| `acp_bench_mcq_val` | 0.43 | 0.65 | 0.35 | 0.43 | 0.51 | 0.40 | 0.54 | 0.44 | 0.44 | 0.40 |
| `rf_bbh_mcq_ruin_names` | 0.56 | 0.27 | 0.40 | 0.54 | 0.33 | 0.49 | 0.60 | 0.52 | 0.35 | 0.52 |
| `cultural_bench_easy_south_africa` | 0.50 | 0.50 | 0.46 | 0.51 | 0.42 | 0.37 | 0.48 | 0.40 | 0.48 | 0.41 |
| `cultural_bench_hard_nigeria` | 0.63 | 0.36 | 0.32 | 0.49 | 0.40 | 0.38 | 0.59 | 0.60 | 0.40 | 0.35 |
| `rf_bbh_mcq_logical_deduction_five_objects` | 0.42 | 0.45 | 0.43 | 0.32 | 0.46 | 0.53 | 0.54 | 0.57 | 0.44 | 0.35 |
| `bbh_mcq_ruin_names` | 0.28 | 0.46 | 0.45 | 0.35 | 0.57 | 0.39 | 0.52 | 0.50 | 0.49 | 0.50 |
| `rf_bbh_mcq_reasoning_about_colored_objects` | 0.38 | 0.44 | 0.48 | 0.50 | 0.63 | 0.51 | 0.41 | 0.43 | 0.24 | 0.46 |
| `rf_bbh_mcq_tracking_shuffled_objects_seven_objects` | 0.40 | 0.60 | 0.28 | 0.50 | 0.35 | 0.55 | 0.43 | 0.41 | 0.44 | 0.48 |
| `rf_bbh_mcq_tracking_shuffled_objects_three_objects` | 0.37 | 0.42 | 0.31 | 0.55 | 0.38 | 0.56 | 0.45 | 0.42 | 0.46 | 0.47 |
| `rf_bbh_mcq_logical_deduction_three_objects` | 0.44 | 0.37 | 0.58 | 0.51 | 0.48 | 0.38 | 0.44 | 0.50 | 0.38 | 0.25 |
| `bbh_mcq_movie_recommendation` | 0.46 | 0.37 | 0.31 | 0.29 | 0.54 | 0.40 | 0.61 | 0.39 | 0.52 | 0.44 |
| `cultural_bench_hard_united_kingdom` | 0.37 | 0.47 | 0.58 | 0.36 | 0.35 | 0.41 | 0.46 | 0.51 | 0.53 | 0.27 |
| `rf_bbh_mcq_penguins_in_a_table` | 0.43 | 0.60 | 0.35 | 0.60 | 0.46 | 0.50 | 0.41 | 0.30 | 0.32 | 0.33 |
| `truthfulqa-multi_mc1` | 0.40 | 0.17 | 0.58 | 0.42 | 0.46 | 0.54 | 0.32 | 0.44 | 0.61 | 0.35 |
| `rf_bbh_mcq_tracking_shuffled_objects_five_objects` | 0.40 | 0.15 | 0.52 | 0.35 | 0.43 | 0.39 | 0.47 | 0.44 | 0.54 | 0.58 |
| `rf_bbh_mcq_date_understanding` | 0.45 | 0.45 | 0.39 | 0.54 | 0.40 | 0.35 | 0.57 | 0.41 | 0.44 | 0.28 |
| `rf_bbh_mcq_salient_translation_error_detection` | 0.36 | 0.47 | 0.51 | 0.34 | 0.41 | 0.51 | 0.36 | 0.42 | 0.46 | 0.42 |
| `cultural_bench_easy_zimbabwe` | 0.43 | 0.45 | 0.45 | 0.47 | 0.32 | 0.37 | 0.52 | 0.45 | 0.50 | 0.30 |
| `cultural_bench_hard_united_states` | 0.40 | 0.50 | 0.46 | 0.45 | 0.32 | 0.45 | 0.54 | 0.44 | 0.44 | 0.24 |
| `cultural_bench_easy_united_kingdom` | 0.53 | 0.53 | 0.34 | 0.34 | 0.32 | 0.44 | 0.57 | 0.36 | 0.32 | 0.41 |
| `acp_bench_mcq_reach` | 0.43 | 0.44 | 0.39 | 0.38 | 0.36 | 0.47 | 0.41 | 0.50 | 0.39 | 0.37 |
| `rf_acp_bench_mcq_areach` | 0.42 | 0.31 | 0.50 | 0.45 | 0.38 | 0.52 | 0.49 | 0.27 | 0.48 | 0.31 |
| `cultural_bench_hard_australia` | 0.47 | 0.36 | 0.46 | 0.46 | 0.39 | 0.32 | 0.43 | 0.46 | 0.47 | 0.30 |
| `bbh_mcq_tracking_shuffled_objects_three_objects` | 0.35 | 0.43 | 0.43 | 0.31 | 0.47 | 0.42 | 0.56 | 0.36 | 0.31 | 0.45 |
| `cultural_bench_hard_zimbabwe` | 0.59 | 0.23 | 0.36 | 0.30 | 0.41 | 0.53 | 0.46 | 0.55 | 0.41 | 0.24 |
| `acp_bench_mcq_prog` | 0.22 | 0.55 | 0.24 | 0.56 | 0.29 | 0.40 | 0.40 | 0.37 | 0.50 | 0.53 |
| `rf_acp_bench_mcq_val` | 0.44 | 0.54 | 0.38 | 0.45 | 0.39 | 0.30 | 0.26 | 0.46 | 0.37 | 0.47 |
| `bbh_mcq_reasoning_about_colored_objects` | 0.17 | 0.28 | 0.23 | 0.38 | 0.54 | 0.59 | 0.49 | 0.47 | 0.37 | 0.46 |
| `acp_bench_mcq_app` | 0.33 | 0.36 | 0.32 | 0.49 | 0.37 | 0.40 | 0.35 | 0.41 | 0.48 | 0.46 |
| `bbh_mcq_snarks` | 0.44 | 0.42 | 0.45 | 0.44 | 0.37 | 0.32 | 0.43 | 0.32 | 0.34 | 0.42 |
| `acp_bench_mcq_land` | 0.43 | 0.38 | 0.39 | 0.39 | 0.39 | 0.51 | 0.31 | 0.37 | 0.41 | 0.34 |
| `rf_acp_bench_mcq_prog` | 0.31 | 0.31 | 0.49 | 0.46 | 0.26 | 0.48 | 0.43 | 0.38 | 0.41 | 0.39 |
| `rf_bbh_mcq_temporal_sequences` | 0.43 | 0.28 | 0.39 | 0.26 | 0.54 | 0.40 | 0.23 | 0.48 | 0.42 | 0.48 |
| `rf_acp_bench_mcq_land` | 0.43 | 0.48 | 0.31 | 0.49 | 0.47 | 0.33 | 0.49 | 0.18 | 0.35 | 0.36 |
| `cultural_bench_easy_united_states` | 0.41 | 0.50 | 0.42 | 0.33 | 0.29 | 0.37 | 0.42 | 0.44 | 0.37 | 0.32 |
| `acp_bench_mcq_just` | 0.23 | 0.34 | 0.36 | 0.47 | 0.39 | 0.43 | 0.40 | 0.49 | 0.36 | 0.36 |
| `cultural_bench_easy_canada` | 0.45 | 0.43 | 0.30 | 0.29 | 0.46 | 0.52 | 0.42 | 0.37 | 0.33 | 0.24 |
| `bbh_mcq_temporal_sequences` | 0.29 | 0.19 | 0.25 | 0.27 | 0.36 | 0.51 | 0.60 | 0.41 | 0.43 | 0.50 |
| `bbh_cloze_web_of_lies` | 0.49 | 0.21 | 0.36 | 0.28 | 0.46 | 0.51 | 0.29 | 0.37 | 0.30 | 0.44 |
| `cultural_bench_easy_nigeria` | 0.32 | 0.42 | 0.29 | 0.35 | 0.26 | 0.43 | 0.29 | 0.50 | 0.42 | 0.39 |
| `bbh_mcq_hyperbaton` | 0.23 | 0.33 | 0.39 | 0.30 | 0.32 | 0.49 | 0.53 | 0.36 | 0.33 | 0.41 |
| `bbh_mcq_date_understanding` | 0.20 | 0.26 | 0.30 | 0.31 | 0.54 | 0.62 | 0.38 | 0.38 | 0.34 | 0.35 |
| `cultural_bench_easy_australia` | 0.42 | 0.41 | 0.38 | 0.33 | 0.14 | 0.32 | 0.30 | 0.45 | 0.36 | 0.55 |
| `bbh_cloze_navigate` | 0.39 | 0.41 | 0.15 | 0.48 | 0.37 | 0.48 | 0.40 | 0.30 | 0.36 | 0.32 |
| `cultural_bench_hard_canada` | 0.33 | 0.44 | 0.23 | 0.49 | 0.31 | 0.35 | 0.37 | 0.41 | 0.46 | 0.25 |
| `rf_cultural_bench_easy_united_kingdom` | 0.38 | 0.28 | 0.33 | 0.28 | 0.29 | 0.38 | 0.48 | 0.58 | 0.32 | 0.29 |
| `rf_cultural_bench_easy_south_africa` | 0.24 | 0.31 | 0.38 | 0.36 | 0.46 | 0.43 | 0.33 | 0.38 | 0.38 | 0.31 |
| `bbh_mcq_penguins_in_a_table` | 0.23 | 0.30 | 0.17 | 0.22 | 0.51 | 0.51 | 0.40 | 0.50 | 0.37 | 0.34 |
| `bbh_cloze_boolean_expressions` | 0.34 | 0.20 | 0.19 | 0.42 | 0.39 | 0.43 | 0.46 | 0.43 | 0.29 | 0.37 |
| `rf_acp_bench_mcq_reach` | 0.41 | 0.20 | 0.18 | 0.42 | 0.38 | 0.40 | 0.32 | 0.49 | 0.43 | 0.28 |
| `bbh_mcq_tracking_shuffled_objects_five_objects` | 0.16 | 0.32 | 0.13 | 0.19 | 0.46 | 0.51 | 0.52 | 0.48 | 0.40 | 0.32 |
| `bbh_mcq_logical_deduction_five_objects` | 0.21 | 0.10 | 0.08 | 0.25 | 0.54 | 0.55 | 0.43 | 0.50 | 0.45 | 0.39 |
| `rf_cultural_bench_easy_nigeria` | 0.49 | 0.32 | 0.38 | 0.29 | 0.50 | 0.32 | 0.31 | 0.26 | 0.26 | 0.35 |
| `rf_cultural_bench_easy_australia` | 0.20 | 0.25 | 0.32 | 0.30 | 0.51 | 0.35 | 0.46 | 0.39 | 0.39 | 0.22 |
| `bbh_mcq_logical_deduction_three_objects` | 0.30 | 0.31 | 0.12 | 0.25 | 0.34 | 0.40 | 0.38 | 0.36 | 0.48 | 0.43 |
| `bbh_cloze_causal_judgement` | 0.35 | 0.40 | 0.27 | 0.11 | 0.31 | 0.28 | 0.47 | 0.37 | 0.40 | 0.27 |
| `bbh_mcq_geometric_shapes` | 0.11 | 0.08 | 0.13 | 0.13 | 0.54 | 0.57 | 0.47 | 0.40 | 0.44 | 0.35 |
| `rf_cultural_bench_easy_zimbabwe` | 0.32 | 0.30 | 0.30 | 0.60 | 0.29 | 0.24 | 0.40 | 0.15 | 0.31 | 0.24 |
| `bbh_mcq_disambiguation_qa` | 0.13 | 0.08 | 0.01 | 0.19 | 0.51 | 0.46 | 0.36 | 0.54 | 0.41 | 0.44 |
| `bbh_mcq_logical_deduction_seven_objects` | 0.12 | 0.11 | 0.09 | 0.09 | 0.57 | 0.38 | 0.49 | 0.42 | 0.51 | 0.35 |
| `rf_cultural_bench_easy_united_states` | 0.34 | 0.30 | 0.28 | 0.31 | 0.39 | 0.26 | 0.23 | 0.25 | 0.41 | 0.33 |
| `bbh_mcq_tracking_shuffled_objects_seven_objects` | 0.10 | 0.20 | 0.15 | 0.17 | 0.39 | 0.24 | 0.45 | 0.43 | 0.56 | 0.40 |
| `bbh_mcq_salient_translation_error_detection` | 0.10 | 0.05 | 0.05 | 0.03 | 0.58 | 0.39 | 0.44 | 0.39 | 0.44 | 0.47 |
...
| `include_v2_en_arabic_qatar` | 0.50 | 0.54 | 0.57 | 0.61 | 0.54 | 0.46 | 0.39 | 0.50 | **0.82** | 0.46 |
| `rf_include_base_44` | 0.50 | 0.68 | 0.57 | 0.43 | 0.46 | **0.75** | 0.50 | 0.39 | 0.43 | 0.46 |
| `include_v2_en_arabic_palestine` | 0.43 | 0.64 | 0.39 | 0.61 | 0.43 | 0.25 | 0.39 | 0.64 | 0.68 | 0.71 |
| `global_mmlu_full` | 0.54 | 0.46 | 0.54 | 0.61 | 0.57 | 0.50 | 0.43 | 0.43 | 0.50 | 0.57 |
| `include_v2_og_arabic_morocco` | 0.54 | 0.46 | 0.50 | 0.46 | 0.68 | 0.54 | 0.25 | 0.50 | 0.57 | 0.50 |
...
| `blend_sample` | 0.57 | 0.46 | 0.54 | 0.29 | 0.36 | 0.61 | 0.39 | 0.36 | 0.50 | 0.68 |
| `include_v2_en_arabic_morocco` | 0.46 | 0.36 | 0.39 | 0.50 | 0.39 | 0.21 | 0.54 | **0.79** | 0.57 | 0.54 |
| `arc` | 0.50 | 0.50 | 0.36 | 0.50 | 0.43 | 0.57 | 0.64 | 0.50 | 0.25 | 0.43 |
| `belebele_apc_Arab` | 0.50 | 0.36 | 0.68 | 0.46 | 0.43 | 0.43 | 0.25 | 0.64 | 0.46 | 0.43 |
| `include_v2_og_arabic_egypt` | 0.43 | 0.29 | 0.54 | 0.29 | 0.50 | 0.71 | 0.39 | 0.43 | 0.61 | 0.46 |
...
| `cultural_bench_easy_morocco` | 0.54 | 0.61 | 0.50 | 0.25 | 0.39 | 0.46 | 0.43 | 0.68 | 0.29 | 0.39 |
| `include_v2_en_arabic_egypt` | 0.64 | 0.36 | 0.64 | 0.50 | 0.43 | 0.39 | 0.57 | 0.61 | 0.14 | 0.25 |
| `rf_belebele_ary_Arab` | 0.25 | 0.54 | 0.64 | 0.43 | 0.43 | 0.29 | **0.75** | 0.61 | 0.36 | 0.21 |
| `cultural_bench_hard_saudi_arabia` | 0.68 | 0.64 | 0.46 | 0.39 | 0.43 | 0.57 | 0.21 | 0.39 | 0.50 | 0.18 |
| `rf_belebele_ars_Arab` | 0.50 | 0.36 | 0.64 | 0.18 | 0.57 | 0.50 | 0.46 | 0.43 | 0.57 | 0.21 |
| `include_v2_en_arabic_jordan` | 0.54 | 0.61 | 0.29 | 0.32 | 0.64 | 0.32 | 0.21 | 0.39 | 0.50 | 0.61 |
| `xstorycloze` | 0.50 | 0.43 | 0.43 | 0.39 | 0.61 | 0.54 | 0.25 | 0.54 | 0.32 | 0.43 |
| `include_v2_og_arabic_uae` | 0.11 | 0.39 | 0.71 | 0.21 | 0.46 | 0.32 | 0.61 | 0.54 | 0.57 | 0.46 |
...
| `include_v2_og_arabic_jordan` | 0.21 | 0.36 | 0.46 | 0.64 | 0.71 | 0.61 | 0.21 | 0.39 | 0.43 | 0.25 |
| `include_v2_og_arabic_palestine` | 0.18 | 0.61 | 0.54 | 0.39 | 0.32 | 0.57 | 0.43 | 0.43 | 0.39 | 0.43 |
...
| `include_v2_og_arabic_qatar` | 0.21 | 0.46 | 0.54 | 0.29 | 0.29 | 0.39 | 0.50 | 0.43 | 0.57 | 0.54 |
...
| `include_v2_en_arabic_ksa` | 0.68 | 0.14 | 0.46 | 0.39 | 0.11 | 0.46 | 0.50 | 0.54 | 0.32 | 0.54 |
| `cultural_bench_hard_morocco` | 0.43 | 0.43 | 0.46 | 0.46 | 0.29 | 0.36 | 0.32 | 0.36 | 0.50 | 0.43 |
| `include_v2_en_arabic_uae` | 0.32 | 0.29 | 0.14 | 0.64 | 0.46 | 0.57 | 0.54 | 0.39 | 0.29 | 0.36 |
...
| `cultural_bench_easy_saudi_arabia` | 0.32 | 0.46 | 0.29 | 0.04 | 0.29 | 0.50 | 0.39 | 0.50 | 0.39 | 0.46 |
| `global_piqa_parallel_cloze_ars_arab` | 0.36 | 0.46 | 0.46 | 0.32 | 0.11 | 0.46 | 0.29 | 0.43 | 0.29 | 0.36 |
| `include_v2_og_arabic_ksa` | 0.21 | 0.43 | 0.39 | 0.54 | 0.21 | 0.46 | 0.32 | 0.07 | 0.50 | 0.29 |
| `rf_cultural_bench_easy_saudi_arabia` | 0.25 | 0.25 | 0.36 | 0.46 | 0.21 | 0.29 | 0.64 | 0.32 | 0.25 | 0.36 |
| `global_piqa_parallel_cloze_apc_arab_syri` | 0.36 | 0.46 | 0.29 | 0.54 | 0.29 | 0.39 | 0.21 | 0.25 | 0.39 | 0.14 |
| `include_v2_en_arabic_kuwait` | 0.36 | 0.29 | 0.39 | 0.11 | 0.43 | 0.39 | 0.32 | 0.32 | 0.46 | 0.14 |
| `include_v2_og_arabic_kuwait` | 0.14 | 0.14 | 0.14 | 0.39 | 0.43 | 0.50 | 0.25 | 0.36 | 0.39 | 0.18 |
| `global_piqa_parallel_cloze_apc_arab_jord` | 0.50 | 0.14 | 0.29 | 0.54 | 0.14 | 0.21 | 0.32 | 0.21 | 0.21 | 0.32 |
| `rf_cultural_bench_easy_morocco` | 0.21 | 0.50 | 0.29 | 0.11 | 0.29 | 0.21 | 0.32 | 0.29 | 0.29 | 0.39 |
...
| `include_v2_en` | 0.33 | 0.17 | 0.50 | 0.33 | 0.50 | **0.83** | **1.00** | 0.33 | 0.50 | **0.83** |
...
| `include_v2_og` | **0.83** | 0.33 | 0.17 | 0.33 | 0.50 | 0.00 | 0.50 | 0.50 | 0.33 | 0.33 |
...
| `include_v2_og_bengali_bangladesh` | 0.50 | 0.71 | **0.75** | **0.89** | 0.43 | 0.46 | 0.46 | 0.61 | 0.61 | **0.79** |
...
| `include_v2_en_bengali_india` | 0.54 | 0.39 | 0.43 | 0.54 | 0.32 | 0.54 | 0.43 | 0.68 | 0.46 | 0.46 |
| `include_base_44` | 0.32 | **0.79** | 0.46 | 0.46 | 0.29 | 0.54 | 0.29 | 0.46 | 0.50 | 0.64 |
| `include_v2_en_bengali_bangladesh` | 0.50 | 0.50 | 0.18 | 0.32 | 0.43 | 0.54 | 0.61 | 0.54 | 0.39 | 0.64 |
...
| `include_v2_og_bengali_india` | 0.54 | 0.68 | 0.29 | 0.57 | 0.54 | 0.43 | 0.36 | 0.29 | 0.54 | 0.25 |
...
| `include_v2_en` | 0.67 | 0.60 | 0.73 | 0.40 | 0.67 | 0.53 | 0.27 | 0.60 | 0.47 | 0.27 |
...
| `include_v2_og` | 0.07 | 0.33 | 0.73 | 0.47 | 0.67 | 0.33 | 0.47 | 0.33 | 0.33 | 0.60 |
...
| `include_v2_og` | **1.00** | 0.67 | 0.33 | 0.50 | 0.67 | 0.33 | 0.50 | 0.67 | 0.17 | 0.17 |
| `belebele` | 0.50 | 0.50 | **0.83** | 0.33 | 0.33 | 0.50 | 0.67 | 0.50 | 0.00 | 0.50 |
| `multiblimp` | 0.50 | 0.33 | **1.00** | 0.50 | 0.17 | 0.50 | 0.17 | 0.33 | 0.50 | 0.50 |
| `include_v2_en` | 0.33 | 0.50 | 0.00 | 0.50 | 0.33 | 0.67 | 0.33 | 0.33 | **1.00** | 0.33 |
...
| `include_v2_og` | 0.34 | 0.60 | 0.58 | 0.47 | 0.57 | 0.62 | 0.59 | 0.67 | 0.66 | 0.63 |
| `arc` | 0.47 | 0.54 | 0.59 | 0.52 | 0.52 | 0.49 | 0.52 | 0.51 | 0.58 | 0.69 |
| `paws` | 0.32 | 0.74 | 0.40 | 0.43 | 0.51 | 0.52 | 0.51 | 0.51 | 0.48 | 0.73 |
| `include_v2_en` | 0.55 | 0.56 | 0.40 | 0.40 | 0.68 | 0.52 | 0.36 | 0.58 | 0.47 | 0.55 |
...
| `include_v2_en_greek_greece` | 0.33 | 0.60 | 0.40 | 0.47 | 0.38 | 0.31 | 0.58 | 0.67 | 0.49 | 0.47 |
...
| `include_v2_en_greek_cyprus` | 0.40 | 0.36 | 0.42 | 0.40 | 0.44 | 0.56 | 0.73 | 0.49 | 0.24 | 0.47 |
...
| `include_v2_og_greek_greece` | 0.56 | 0.31 | 0.47 | 0.31 | 0.38 | 0.27 | 0.44 | 0.42 | 0.60 | 0.29 |
| `include_v2_og_greek_cyprus` | 0.38 | 0.38 | 0.24 | 0.40 | 0.40 | 0.36 | 0.47 | 0.33 | 0.36 | 0.36 |
...
| `include_v2_og_spanish_espa_a` | 0.58 | 0.67 | 0.49 | 0.56 | 0.56 | 0.47 | 0.67 | 0.64 | 0.67 | 0.67 |
| `include_v2_og_spanish_chile` | 0.49 | 0.38 | 0.49 | 0.60 | 0.73 | 0.69 | 0.58 | 0.71 | 0.49 | 0.64 |
| `xstorycloze` | 0.38 | 0.42 | 0.40 | 0.40 | 0.67 | 0.56 | **0.76** | 0.67 | **0.89** | 0.67 |
| `include_v2_en_spanish_colombia` | 0.58 | 0.53 | 0.71 | 0.64 | 0.58 | 0.58 | 0.56 | 0.47 | 0.67 | 0.42 |
| `include_v2_og_spanish_m_xico` | 0.47 | 0.51 | 0.53 | 0.58 | 0.60 | 0.71 | 0.60 | 0.51 | 0.62 | 0.47 |
| `arc` | 0.42 | 0.29 | 0.49 | 0.49 | 0.60 | 0.62 | 0.73 | 0.51 | 0.62 | 0.71 |
| `include_v2_og_spanish_colombia` | 0.49 | 0.71 | 0.51 | 0.47 | 0.47 | 0.58 | 0.60 | 0.38 | 0.60 | 0.64 |
| `multiblimp` | 0.56 | 0.49 | 0.51 | **0.84** | 0.24 | 0.60 | 0.69 | 0.49 | 0.40 | 0.60 |
| `include_v2_en_spanish_ecuador` | 0.60 | **0.76** | 0.67 | 0.36 | 0.71 | 0.44 | 0.31 | 0.64 | 0.29 | 0.51 |
| `rf_global_mmlu_full` | 0.47 | 0.56 | 0.53 | 0.62 | 0.53 | 0.56 | 0.42 | 0.67 | 0.47 | 0.44 |
| `include_v2_en_spanish_uruguay` | 0.49 | 0.60 | 0.51 | 0.69 | 0.62 | 0.38 | 0.38 | 0.49 | 0.58 | 0.51 |
| `include_v2_en_spanish_chile` | 0.51 | 0.22 | 0.49 | 0.73 | 0.47 | 0.44 | 0.67 | 0.51 | 0.44 | 0.60 |
| `include_v2_en_spanish_bolivia` | 0.42 | 0.51 | 0.53 | 0.40 | 0.58 | 0.62 | 0.44 | 0.64 | 0.36 | 0.56 |
| `include_v2_og_spanish_ecuador` | 0.56 | 0.51 | 0.53 | 0.67 | 0.49 | 0.53 | 0.44 | 0.51 | 0.58 | 0.20 |
| `include_v2_og_spanish_bolivia` | 0.36 | 0.56 | 0.58 | 0.47 | 0.44 | 0.49 | 0.53 | 0.60 | 0.51 | 0.47 |
| `include_v2_en_spanish_m_xico` | 0.33 | 0.47 | 0.49 | 0.73 | **0.78** | 0.40 | 0.29 | 0.47 | 0.44 | 0.56 |
...
| `include_v2_en_spanish_el_salvador` | 0.64 | 0.56 | 0.33 | 0.53 | 0.73 | 0.38 | 0.40 | 0.36 | 0.29 | 0.67 |
| `cultural_bench_easy_mexico` | 0.51 | 0.51 | 0.67 | 0.44 | 0.33 | 0.49 | 0.51 | 0.40 | 0.56 | 0.47 |
| `include_v2_en_spanish_espa_a` | 0.53 | 0.42 | 0.49 | 0.69 | 0.49 | 0.64 | 0.49 | 0.29 | 0.40 | 0.44 |
| `cultural_bench_easy_peru` | 0.53 | 0.40 | 0.58 | 0.31 | 0.58 | 0.44 | 0.47 | 0.47 | 0.60 | 0.42 |
...
| `include_v2_og_spanish_el_salvador` | 0.27 | 0.47 | 0.56 | 0.44 | 0.40 | 0.36 | 0.40 | 0.73 | 0.49 | 0.64 |
| `cultural_bench_easy_argentina` | 0.44 | 0.49 | 0.44 | 0.56 | 0.29 | 0.31 | 0.62 | 0.51 | 0.53 | 0.53 |
| `truthfulqa-multi_mc1` | 0.40 | 0.56 | 0.33 | 0.69 | 0.53 | 0.53 | 0.53 | 0.27 | 0.60 | 0.27 |
| `include_v2_en_spanish_costa_rica` | 0.60 | 0.42 | 0.47 | 0.47 | 0.38 | 0.33 | 0.31 | 0.60 | 0.49 | 0.64 |
| `include_v2_en_spanish_argentina` | **0.76** | 0.36 | 0.47 | 0.20 | 0.40 | 0.40 | 0.42 | 0.49 | 0.71 | 0.42 |
| `rf_belebele` | 0.38 | 0.33 | 0.42 | 0.33 | 0.51 | 0.47 | 0.49 | 0.62 | 0.71 | 0.36 |
| `include_v2_og_spanish_costa_rica` | 0.51 | **0.76** | 0.40 | 0.29 | 0.60 | 0.60 | 0.22 | 0.42 | 0.31 | 0.47 |
| `include_v2_og_spanish_per_` | 0.49 | 0.44 | 0.49 | 0.38 | 0.49 | 0.42 | 0.36 | 0.44 | 0.36 | 0.69 |
| `cultural_bench_hard_peru` | 0.58 | 0.62 | 0.40 | 0.62 | 0.33 | 0.38 | 0.40 | 0.36 | 0.53 | 0.33 |
| `cultural_bench_hard_argentina` | 0.51 | 0.40 | 0.60 | 0.38 | 0.27 | 0.69 | 0.33 | 0.49 | 0.44 | 0.40 |
| `cultural_bench_hard_spain` | 0.51 | 0.69 | 0.67 | 0.33 | 0.47 | 0.40 | 0.36 | 0.51 | 0.31 | 0.27 |
| `include_v2_og_spanish_cuba` | 0.44 | 0.47 | 0.38 | 0.29 | **0.78** | 0.47 | 0.33 | 0.53 | 0.38 | 0.40 |
...
| `include_v2_og_spanish_uruguay` | 0.60 | 0.24 | 0.62 | 0.40 | 0.29 | 0.62 | 0.38 | 0.40 | 0.51 | 0.36 |
| `global_mmlu_full` | 0.40 | 0.64 | 0.22 | 0.44 | 0.51 | 0.60 | 0.47 | 0.29 | 0.40 | 0.42 |
| `include_v2_en_spanish_per_` | 0.38 | 0.40 | 0.33 | 0.71 | 0.31 | 0.62 | 0.53 | 0.53 | 0.27 | 0.31 |
| `cultural_bench_hard_mexico` | 0.58 | 0.53 | 0.62 | 0.40 | 0.24 | 0.73 | 0.20 | 0.38 | 0.58 | 0.11 |
| `blend_spain_sample` | 0.49 | 0.42 | 0.42 | 0.51 | 0.38 | 0.47 | 0.36 | 0.47 | 0.40 | 0.44 |
| `include_v2_og_spanish_argentina` | 0.31 | 0.27 | 0.38 | 0.44 | 0.53 | 0.67 | 0.38 | 0.42 | 0.44 | 0.51 |
| `include_v2_og_spanish_puerto_rico` | 0.49 | 0.51 | 0.44 | 0.47 | 0.27 | 0.33 | 0.60 | 0.42 | 0.42 | 0.40 |
| `include_v2_en_spanish_puerto_rico` | 0.53 | 0.27 | 0.36 | 0.42 | 0.33 | 0.42 | 0.44 | 0.40 | 0.42 | 0.73 |
| `blend_mexico_sample` | 0.62 | 0.33 | 0.47 | 0.56 | 0.60 | 0.33 | 0.53 | 0.38 | 0.27 | 0.24 |
| `include_base_44` | 0.44 | 0.49 | 0.38 | 0.58 | 0.38 | 0.44 | 0.29 | 0.44 | 0.42 | 0.36 |
| `include_v2_en_spanish_paraguay` | 0.11 | 0.29 | 0.51 | 0.40 | 0.51 | 0.33 | 0.64 | 0.53 | 0.49 | 0.36 |
...
| `include_v2_en_spanish_cuba` | 0.22 | 0.44 | 0.67 | 0.29 | 0.38 | 0.27 | 0.53 | 0.58 | 0.44 | 0.29 |
| `rf_cultural_bench_easy_spain` | 0.38 | **0.80** | 0.36 | 0.18 | 0.36 | 0.42 | 0.51 | 0.42 | 0.18 | 0.49 |
| `cultural_bench_easy_chile` | 0.27 | 0.42 | 0.42 | 0.20 | 0.33 | 0.44 | 0.64 | 0.36 | 0.51 | 0.44 |
| `include_v2_en_spanish_panam_` | 0.36 | 0.27 | 0.40 | 0.38 | 0.40 | 0.42 | 0.60 | 0.47 | 0.40 | 0.31 |
| `cultural_bench_hard_chile` | 0.40 | 0.40 | 0.44 | 0.38 | 0.22 | 0.51 | 0.29 | 0.36 | 0.42 | 0.53 |
| `include_v2_og_spanish_belice` | 0.53 | 0.47 | 0.20 | 0.51 | 0.49 | 0.38 | 0.44 | 0.29 | 0.33 | 0.24 |
| `cultural_bench_easy_spain` | 0.47 | 0.27 | 0.58 | 0.31 | 0.18 | 0.38 | 0.47 | 0.42 | 0.40 | 0.40 |
| `include_v2_en_spanish_venezuela` | 0.42 | 0.16 | 0.67 | 0.22 | 0.33 | 0.38 | 0.24 | 0.42 | 0.64 | 0.33 |
| `include_v2_og_spanish_venezuela` | 0.44 | 0.31 | 0.20 | 0.42 | 0.27 | 0.51 | 0.22 | 0.49 | 0.60 | 0.31 |
| `include_v2_og_spanish_paraguay` | 0.51 | 0.44 | 0.42 | 0.42 | 0.20 | 0.18 | 0.33 | 0.49 | 0.31 | 0.42 |
| `include_v2_en_spanish_nicaragua` | 0.40 | 0.29 | 0.24 | 0.11 | 0.44 | 0.56 | 0.18 | 0.42 | 0.51 | 0.49 |
| `include_v2_og_spanish_nicaragua` | 0.42 | 0.29 | 0.44 | 0.38 | 0.36 | 0.47 | 0.33 | 0.40 | 0.33 | 0.20 |
| `rf_cultural_bench_easy_peru` | 0.56 | 0.27 | 0.42 | 0.42 | 0.40 | 0.38 | 0.20 | 0.33 | 0.22 | 0.40 |
| `include_v2_og_spanish_panam_` | 0.27 | 0.44 | 0.31 | 0.24 | 0.31 | 0.38 | 0.49 | 0.31 | 0.38 | 0.44 |
| `include_v2_en_spanish_belice` | 0.47 | 0.33 | 0.56 | 0.38 | 0.29 | 0.27 | 0.49 | 0.40 | 0.16 | 0.20 |
| `include_v2_en_spanish_rep_blica_dominicana` | 0.31 | 0.44 | 0.51 | 0.42 | 0.24 | 0.56 | 0.16 | 0.27 | 0.40 | 0.20 |
| `include_v2_og_spanish_rep_blica_dominicana` | 0.29 | 0.42 | 0.22 | 0.40 | 0.29 | 0.56 | 0.22 | 0.33 | 0.40 | 0.16 |
| `include_v2_og_spanish_jamaica` | 0.29 | 0.18 | 0.24 | 0.36 | 0.24 | 0.33 | 0.42 | 0.47 | 0.40 | 0.27 |
| `rf_cultural_bench_easy_argentina` | 0.31 | 0.16 | 0.33 | 0.58 | 0.31 | 0.29 | 0.24 | 0.51 | 0.22 | 0.24 |
| `rf_cultural_bench_easy_mexico` | 0.38 | 0.22 | 0.33 | 0.20 | 0.33 | 0.29 | 0.09 | 0.44 | 0.38 | 0.38 |
| `rf_cultural_bench_easy_chile` | 0.53 | 0.31 | 0.27 | 0.22 | 0.31 | 0.29 | 0.20 | 0.29 | 0.29 | 0.27 |
| `include_v2_en_spanish_jamaica` | 0.36 | 0.20 | 0.22 | 0.31 | 0.31 | 0.27 | 0.24 | 0.11 | 0.24 | 0.24 |
...
| `include_v2_en` | 0.42 | **0.76** | 0.52 | 0.62 | 0.50 | 0.50 | 0.45 | 0.61 | 0.47 | 0.56 |
...
| `include_v2_og` | 0.41 | 0.44 | 0.50 | 0.73 | 0.58 | 0.32 | 0.44 | 0.44 | 0.50 | 0.45 |
...
| `include_v2_en` | 0.00 | 0.50 | **0.83** | 0.50 | 0.50 | 0.17 | 0.50 | 0.67 | 0.67 | 0.67 |
...
| `include_v2_og` | 0.50 | 0.17 | 0.17 | 0.50 | 0.17 | 0.67 | 0.17 | 0.50 | 0.67 | 0.17 |
...
| `include_v2_og_french_france` | 0.62 | 0.62 | 0.73 | 0.51 | **0.76** | 0.42 | 0.40 | 0.47 | 0.60 | 0.49 |
...
| `include_v2_og_french_canada` | 0.71 | 0.53 | 0.69 | 0.27 | 0.53 | 0.58 | 0.24 | 0.58 | 0.42 | 0.36 |
...
| `include_v2_en_french_france` | 0.67 | 0.29 | 0.60 | 0.51 | 0.40 | 0.36 | 0.56 | 0.44 | 0.36 | 0.49 |
| `include_v2_en_french_canada` | 0.64 | 0.49 | 0.51 | 0.51 | 0.36 | 0.49 | 0.38 | 0.40 | 0.36 | 0.53 |
...
| `include_v2_en` | 0.27 | 0.60 | 0.73 | 0.47 | 0.53 | 0.53 | 0.60 | 0.60 | 0.33 | 0.60 |
...
| `include_v2_og` | 0.07 | 0.67 | 0.40 | 0.47 | 0.20 | 0.60 | 0.33 | 0.40 | 0.47 | 0.47 |
...
| `include_v2_og` | 0.57 | 0.61 | **0.79** | 0.54 | 0.61 | 0.54 | 0.68 | 0.54 | 0.71 | 0.39 |
...
| `include_v2_en` | 0.36 | 0.64 | 0.68 | 0.32 | 0.64 | 0.32 | 0.46 | 0.54 | 0.39 | 0.36 |
...
| `cultural_bench_easy` | 0.54 | 0.43 | 0.68 | 0.32 | 0.39 | 0.46 | 0.68 | 0.36 | 0.43 | 0.32 |
...
| `cultural_bench_hard` | 0.43 | 0.32 | 0.46 | 0.21 | 0.29 | **0.82** | 0.25 | 0.46 | 0.43 | 0.14 |
| `rf_cultural_bench_easy` | 0.32 | 0.32 | 0.32 | 0.25 | 0.39 | 0.43 | 0.43 | 0.50 | 0.29 | 0.43 |
...
| `include_v2_og` | 0.40 | 0.53 | 0.27 | 0.73 | 0.33 | 0.53 | 0.33 | 0.53 | 0.73 | 0.53 |
...
| `include_v2_en` | 0.47 | 0.33 | 0.67 | 0.07 | 0.67 | 0.60 | 0.33 | 0.33 | 0.60 | 0.33 |
...
| `include_v2_en` | 0.46 | 0.46 | 0.57 | **0.79** | 0.57 | 0.50 | 0.68 | 0.61 | 0.54 | 0.57 |
...
| `include_v2_og` | 0.61 | 0.43 | 0.71 | 0.36 | 0.64 | 0.46 | 0.61 | 0.39 | 0.61 | 0.43 |
...
| `include_v2_og` | 0.40 | 0.58 | 0.53 | 0.62 | 0.51 | 0.42 | 0.42 | 0.53 | 0.64 | 0.73 |
...
| `include_v2_en` | 0.49 | 0.42 | 0.40 | 0.40 | 0.44 | 0.53 | 0.31 | 0.67 | 0.49 | 0.51 |
...
| `include_v2_en` | 0.60 | 0.42 | 0.68 | 0.41 | 0.47 | 0.62 | 0.49 | 0.51 | 0.49 | 0.56 |
| `paws` | 0.49 | 0.68 | 0.41 | 0.52 | 0.49 | 0.69 | 0.60 | 0.35 | 0.37 | 0.57 |
| `global_mmlu_full` | 0.54 | 0.48 | 0.48 | 0.73 | 0.40 | 0.29 | 0.52 | 0.63 | 0.40 | 0.38 |
| `include_v2_og` | 0.43 | 0.38 | 0.48 | 0.55 | 0.54 | 0.48 | 0.63 | 0.38 | 0.59 | 0.35 |
...
| `cultural_bench_easy` | 0.46 | 0.65 | 0.47 | 0.40 | 0.40 | 0.52 | 0.41 | 0.36 | 0.41 | 0.53 |
...
| `rf_cultural_bench_easy` | 0.41 | 0.38 | 0.25 | 0.42 | 0.34 | 0.27 | 0.54 | 0.59 | 0.48 | 0.53 |
| `rf_belebele` | 0.44 | 0.35 | 0.29 | 0.43 | 0.31 | 0.51 | 0.44 | 0.52 | 0.37 | 0.54 |
| `cultural_bench_hard` | 0.62 | 0.44 | 0.33 | 0.52 | 0.42 | 0.38 | 0.35 | 0.52 | 0.31 | 0.26 |
...
| `include_v2_og` | 0.67 | 0.53 | 0.53 | 0.47 | 0.33 | 0.47 | 0.40 | 0.47 | **0.80** | 0.40 |
...
| `include_v2_en` | 0.47 | 0.20 | 0.53 | 0.40 | 0.40 | **0.87** | 0.00 | 0.47 | 0.47 | 0.13 |
...
| `include_v2_en` | 0.57 | 0.54 | 0.18 | 0.29 | 0.71 | 0.46 | 0.57 | 0.43 | 0.57 | **0.75** |
...
| `include_v2_og` | 0.43 | 0.54 | 0.54 | 0.46 | **0.75** | 0.29 | 0.36 | 0.21 | 0.46 | 0.54 |
...
| `include_v2_en` | 0.60 | 0.40 | 0.53 | 0.67 | 0.40 | 0.40 | 0.67 | 0.40 | 0.47 | 0.73 |
...
| `include_v2_og` | 0.27 | 0.27 | 0.53 | 0.27 | **0.80** | 0.20 | 0.47 | 0.40 | 0.33 | 0.47 |
...
| `include_v2_og_dutch_netherlands` | 0.39 | 0.61 | 0.32 | 0.57 | 0.61 | **0.75** | 0.64 | 0.57 | 0.61 | 0.64 |
...
| `include_v2_en_dutch_netherlands` | 0.50 | 0.29 | 0.25 | 0.39 | 0.32 | 0.50 | 0.54 | 0.43 | 0.50 | 0.43 |
| `global_piqa_parallel_cloze` | 0.50 | 0.39 | 0.46 | 0.43 | 0.43 | 0.43 | 0.29 | 0.29 | 0.43 | 0.46 |
| `include_v2_en_dutch_belgium` | 0.39 | 0.54 | 0.54 | 0.25 | 0.25 | 0.46 | 0.50 | 0.43 | 0.36 | 0.11 |
| `include_v2_og_dutch_belgium` | 0.43 | 0.32 | 0.43 | 0.29 | 0.39 | 0.32 | 0.43 | 0.21 | 0.29 | 0.64 |
...
| `include_v2_en` | 0.50 | 0.29 | 0.43 | 0.21 | 0.54 | 0.71 | 0.50 | 0.43 | 0.43 | 0.57 |
| `include_v2_og` | 0.46 | 0.14 | 0.61 | 0.64 | 0.39 | 0.43 | 0.39 | 0.50 | 0.29 | 0.46 |
...
| `include_v2_og_portuguese_brazil` | 0.36 | 0.32 | 0.54 | 0.68 | 0.46 | 0.46 | 0.29 | 0.68 | 0.54 | 0.68 |
...
| `include_v2_og_portuguese_portugal` | 0.32 | 0.54 | 0.57 | **0.75** | 0.50 | 0.50 | 0.43 | 0.39 | 0.43 | 0.46 |
| `include_v2_en_portuguese_portugal` | 0.46 | 0.54 | 0.43 | 0.64 | 0.54 | 0.39 | 0.46 | 0.57 | 0.46 | 0.21 |
...
| `include_v2_en_portuguese_brazil` | 0.36 | 0.64 | 0.39 | 0.36 | 0.43 | 0.57 | 0.43 | 0.25 | 0.64 | 0.32 |
...
| `include_v2_og` | 0.35 | 0.62 | 0.64 | 0.53 | 0.69 | 0.63 | 0.72 | 0.70 | 0.68 | 0.74 |
...
| `include_v2_en` | 0.35 | 0.44 | 0.53 | 0.57 | 0.54 | 0.57 | 0.45 | 0.55 | 0.50 | 0.57 |
...
| `cultural_bench_easy` | 0.36 | 0.56 | 0.52 | 0.40 | 0.52 | 0.33 | 0.45 | 0.40 | 0.57 | 0.48 |
| `global_piqa_parallel_cloze` | 0.33 | 0.30 | 0.46 | 0.47 | 0.38 | 0.51 | 0.37 | 0.51 | 0.47 | 0.57 |
| `cultural_bench_hard` | 0.54 | 0.43 | 0.42 | 0.41 | 0.38 | 0.42 | 0.48 | 0.49 | 0.48 | 0.20 |
| `rf_cultural_bench_easy` | 0.26 | 0.40 | 0.38 | 0.34 | 0.42 | 0.28 | 0.33 | 0.33 | 0.27 | 0.34 |
...
| `include_v2_og` | 0.67 | 0.67 | 0.60 | 0.73 | 0.53 | 0.53 | 0.67 | 0.73 | **0.87** | **0.87** |
...
| `include_v2_en` | 0.73 | 0.40 | 0.47 | 0.40 | 0.27 | 0.33 | 0.13 | 0.47 | 0.67 | **0.80** |
...
| `include_v2_og` | 0.53 | 0.40 | 0.33 | 0.67 | 0.60 | 0.33 | 0.40 | 0.60 | 0.40 | 0.27 |
| `arc` | 0.53 | 0.60 | 0.47 | 0.53 | 0.53 | 0.33 | 0.47 | 0.13 | 0.73 | 0.13 |
| `rf_belebele` | 0.47 | 0.47 | 0.33 | 0.53 | 0.73 | 0.40 | 0.40 | 0.27 | 0.20 | 0.60 |
| `include_v2_en` | 0.40 | 0.40 | 0.40 | **0.80** | 0.13 | 0.33 | 0.33 | 0.53 | 0.47 | 0.60 |
...
| `include_v2_og` | 0.67 | 0.47 | 0.53 | 0.53 | 0.40 | 0.73 | 0.47 | 0.60 | **0.80** | 0.60 |
...
| `include_v2_en` | 0.73 | 0.67 | 0.33 | 0.20 | 0.40 | 0.33 | 0.20 | 0.40 | 0.40 | 0.60 |
...
| `include_v2_og` | 0.33 | 0.60 | 0.53 | 0.60 | 0.47 | 0.47 | 0.73 | 0.40 | 0.53 | 0.73 |
| `global_mmlu_full` | 0.73 | 0.33 | **0.87** | 0.47 | 0.20 | 0.73 | 0.47 | 0.47 | 0.33 | 0.47 |
| `include_v2_en` | 0.40 | 0.67 | 0.27 | 0.53 | 0.73 | 0.73 | 0.33 | 0.47 | 0.47 | 0.33 |
...
| `truthfulqa_mc2` | 0.46 | 0.50 | 0.50 | 0.71 | 0.46 | 0.61 | 0.18 | 0.36 | 0.36 | 0.50 |
| `rf_cultural_bench_easy` | 0.54 | 0.36 | 0.50 | 0.25 | **0.79** | 0.36 | 0.32 | 0.50 | 0.46 | 0.54 |
| `include_v2_og` | 0.46 | 0.43 | 0.43 | **0.75** | 0.21 | 0.36 | 0.61 | 0.57 | 0.25 | 0.46 |
...
| `cultural_bench_hard` | **0.75** | 0.39 | 0.43 | 0.54 | 0.25 | 0.43 | 0.39 | 0.25 | 0.57 | 0.25 |
| `include_v2_en` | 0.50 | 0.18 | 0.39 | 0.25 | 0.46 | 0.25 | 0.54 | 0.50 | 0.64 | 0.50 |
...
| `cultural_bench_easy` | 0.43 | 0.57 | 0.25 | 0.39 | 0.50 | 0.29 | 0.14 | 0.39 | 0.39 | 0.43 |
...
| `include_v2_og_chinese_china` | 0.52 | 0.53 | 0.55 | 0.59 | 0.74 | 0.64 | 0.68 | 0.69 | 0.63 | 0.54 |
...
| `include_v2_en_chinese_china` | 0.56 | 0.44 | 0.47 | 0.48 | 0.36 | 0.62 | 0.35 | 0.59 | **0.79** | 0.65 |
...
| `include_v2_en_chinese_hong_kong` | 0.48 | 0.60 | 0.46 | 0.51 | 0.60 | 0.33 | 0.47 | 0.58 | 0.48 | 0.42 |
| `rf_belebele_zho_Hans` | 0.52 | 0.74 | 0.52 | 0.35 | 0.51 | 0.47 | 0.31 | 0.66 | 0.41 | 0.47 |
| `truthfulqa_mc2` | 0.62 | 0.29 | 0.40 | 0.59 | 0.47 | 0.52 | 0.63 | 0.60 | 0.41 | 0.38 |
...
| `blend_sample` | 0.69 | 0.35 | 0.43 | 0.34 | 0.37 | 0.38 | 0.54 | 0.34 | 0.53 | 0.51 |
| `include_base_44` | 0.47 | 0.41 | 0.70 | 0.23 | 0.52 | 0.53 | 0.43 | 0.38 | 0.40 | 0.38 |
| `cultural_bench_hard` | 0.45 | 0.49 | 0.46 | 0.45 | 0.44 | 0.35 | 0.47 | 0.62 | 0.42 | 0.29 |
...
| `cultural_bench_easy` | 0.46 | 0.55 | 0.48 | 0.19 | 0.41 | 0.14 | 0.49 | 0.49 | 0.38 | 0.36 |
| `include_v2_og_chinese_hong_kong` | 0.37 | 0.45 | 0.38 | 0.38 | 0.41 | 0.43 | 0.40 | 0.52 | 0.34 | 0.21 |
| `rf_cultural_bench_easy` | 0.30 | 0.31 | 0.44 | 0.33 | 0.27 | 0.48 | 0.34 | 0.38 | 0.32 | 0.36 |
| `include_v2_og_chinese_singapore` | 0.36 | 0.34 | 0.31 | 0.23 | 0.49 | 0.41 | 0.22 | 0.46 | 0.23 | 0.27 |
| `include_v2_en_chinese_singapore` | 0.43 | 0.35 | 0.31 | 0.38 | 0.22 | 0.31 | 0.36 | 0.44 | 0.18 | 0.26 |
