...
|---|---|---|---|---|
| `predictivity` | `mpsd` | 0.19 | -0.50 | 3 |
| `predictivity_seeds` | `mpsd` | 0.69 | 0.50 | 3 |
...
|---|---|---|---|---|
| per_benchmark | `multiblimp` | 350M | 2.73 → 4.42 | +1.69 |
| per_benchmark | `multiblimp` | 600M | 2.76 → 4.06 | +1.30 |
| per_benchmark | `hellaswag` | 1B | 2.53 → 3.83 | +1.30 |
| per_benchmark | `xwinograd` | 1B | 2.68 → 3.52 | +0.83 |
| per_benchmark | `bpb` | 350M | 2.62 → 3.43 | +0.81 |
| per_benchmark | `bpb` | 175M | 2.84 → 3.64 | +0.79 |
| per_benchmark | `bpb` | 600M | 2.59 → 3.34 | +0.75 |
| per_benchmark | `multiblimp` | 1.7B | 2.45 → 3.20 | +0.74 |
...
| `multiblimp` | 0.50 | **0.70** | **0.77** | **0.82** | **0.84** | **0.85** | **0.84** |
| `xwinograd` | 0.50 | 0.51 | 0.54 | **0.59** | **0.64** | **0.68** | **0.73** |
| `xcopa` | 0.50 |  | 0.53 | 0.54 | **0.55** | **0.57** | **0.59** |
| `xstorycloze` | 0.50 | 0.48 | 0.49 | 0.52 | 0.54 | **0.56** | **0.57** |
| `paws` | 0.50 | 0.50 | 0.49 | 0.50 | 0.50 | 0.52 | 0.54 |
| `global_piqa_nonparallel_cloze` | 0.50 |  | 0.48 | 0.49 | 0.51 | 0.53 | 0.46 |
| `xnli` | 0.33 | 0.33 | 0.35 | **0.39** | **0.41** | **0.42** | **0.43** |
| `hellaswag` | 0.25 | 0.26 | 0.26 | 0.28 | 0.30 | **0.32** | **0.33** |
| `lambada_openai_mt` |  | 0.00 | 0.17 | 0.27 | 0.33 | 0.37 | 0.43 |
| `include_base_44` | 0.25 | 0.27 | 0.25 | 0.25 | 0.25 | 0.25 | 0.25 |
| `global_mmlu_full` | 0.25 | 0.23 | 0.24 | 0.25 | 0.24 | 0.24 | 0.25 |
| `belebele` | 0.25 | 0.23 | 0.25 | 0.24 | 0.24 | 0.24 | 0.25 |
| `truthfulqa-multi_mc1` | 0.25 | 0.24 | 0.25 | 0.23 | 0.23 | 0.22 | 0.22 |
| `arc` | 0.25 | 0.23 | 0.20 | 0.22 | 0.23 | 0.25 | 0.27 |
| `global_piqa_parallel_cloze` | 0.50 | 0.19 | 0.20 | 0.21 | 0.21 | 0.22 | 0.23 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `arc_challenge` | 0.58 | 0.58 | 0.61 | **0.78** | **0.87** | **0.75** | 0.72 | **0.86** | **0.81** | **0.90** |
| `xstorycloze` | 0.56 | 0.53 | 0.68 | 0.67 | 0.73 | **0.75** | **0.86** | **0.79** | **0.83** | **0.80** |
| `hellaswag` | 0.63 | 0.50 | 0.46 | **0.78** | 0.71 | 0.68 | **0.81** | **0.75** | **0.92** | **0.80** |
| `bpb` | 0.65 | 0.44 | 0.58 | **0.81** | 0.68 | 0.56 | 0.71 | **0.75** | **0.90** | 0.67 |
| `xwinograd` | 0.68 | 0.58 | 0.43 | 0.56 | 0.61 | 0.64 | **0.75** | **0.82** | 0.56 | 0.70 |
| `lambada_openai_mt` | 0.62 | 0.67 | 0.73 | 0.67 | 0.46 | 0.33 | 0.46 | **0.75** | **0.75** | 0.70 |
| `xnli` | 0.59 | 0.59 | 0.50 | 0.64 | 0.65 | 0.71 | 0.61 | 0.43 | 0.69 | 0.70 |
| `arc_easy` | 0.56 | 0.43 | 0.61 | **0.81** | 0.71 | 0.57 | **0.78** | 0.50 | 0.53 | 0.60 |
| `global_mmlu_full` | 0.49 | 0.55 | 0.54 | 0.69 | 0.42 | 0.46 | 0.44 | 0.68 | 0.61 | 0.60 |
| `global_piqa_parallel_cloze` | 0.41 | **0.77** | 0.67 | 0.40 | 0.43 | 0.52 | 0.61 | 0.39 | 0.44 | 0.30 |
| `belebele` | 0.48 | 0.71 | 0.54 | 0.53 | 0.44 | 0.50 | 0.19 | 0.50 | 0.56 | 0.50 |
| `multiblimp` | 0.70 | 0.50 | 0.50 | 0.61 | 0.40 | 0.46 | 0.61 | 0.32 | 0.47 | 0.30 |
| `truthfulqa-multi_mc1` | 0.35 | 0.17 | 0.60 | 0.40 | 0.52 | 0.43 | 0.43 | 0.57 | 0.64 | 0.70 |
| `paws` | 0.59 | 0.42 | 0.60 | 0.47 | 0.42 | 0.43 | 0.57 | 0.43 | 0.19 | 0.30 |
...
| `multiblimp` | **0.89** | 0.67 | **0.87** | 0.67 | 0.65 | **0.90** | **0.80** | **0.82** | 0.73 | **1.00** |
| `hellaswag` | 0.71 | 0.71 | 0.67 | **1.00** | 0.73 | **0.86** | **0.80** | **0.89** | 0.73 | 0.67 |
| `xstorycloze` | 0.71 | 0.73 | 0.67 | **0.83** | **0.80** | **0.86** | 0.70 | **0.75** | **0.80** | 0.67 |
| `belebele_apc_Arab` | 0.58 | 0.47 | 0.47 | **0.83** | 0.38 | 0.67 | 0.60 | 0.36 | 0.47 | 0.17 |
| `belebele_ary_Arab` | 0.38 | 0.42 | 0.67 | 0.50 | 0.67 | 0.24 | 0.60 | 0.21 | 0.67 | 0.33 |
| `global_piqa_parallel_cloze_apc_arab_leba` | 0.38 | 0.51 | 0.13 | 0.67 | 0.29 | 0.67 | 0.70 | 0.46 | 0.33 | 0.50 |
| `global_piqa_parallel_cloze_arz_arab` | 0.51 | 0.24 | 0.33 | **0.83** | 0.44 | 0.19 | 0.40 | 0.46 | 0.53 | 0.67 |
| `global_piqa_parallel_cloze_apc_arab_syri` | 0.27 | 0.42 | 0.40 | 0.50 | 0.38 | 0.71 | 0.60 | 0.32 | 0.47 | 0.50 |
| `belebele_arb_Latn` | 0.64 | 0.42 | 0.40 | 0.67 | 0.35 | 0.33 | 0.30 | 0.39 | 0.33 | 0.67 |
| `xnli` | 0.40 | 0.53 | **0.80** | 0.67 | 0.55 | 0.24 | 0.20 | 0.29 | 0.33 | 0.50 |
| `include_base_44` | 0.38 | 0.38 | 0.53 | 0.00 | 0.40 | 0.62 | **0.80** | 0.29 | 0.60 | 0.50 |
| `global_piqa_parallel_cloze_apc_arab_jord` | 0.36 | 0.44 | 0.27 | 0.33 | 0.27 | 0.62 | 0.60 | 0.43 | 0.20 | **0.83** |
| `global_piqa_parallel_cloze_apc_arab_pale` | 0.18 | 0.42 | 0.07 | 0.50 | 0.53 | **0.81** | 0.40 | 0.43 | 0.67 | 0.33 |
| `global_mmlu_full` | 0.49 | 0.53 | 0.60 | 0.17 | 0.36 | 0.43 | 0.10 | 0.61 | 0.40 | 0.50 |
| `belebele_ars_Arab` | 0.51 | 0.53 | 0.40 | 0.00 | 0.35 | 0.38 | 0.40 | 0.50 | 0.73 | 0.33 |
| `belebele_arb_Arab` | 0.33 | 0.53 | 0.20 | 0.17 | 0.49 | 0.29 | 0.40 | 0.39 | 0.67 | 0.67 |
| `global_piqa_parallel_cloze_ary_arab` | 0.58 | 0.38 | 0.40 | 0.67 | 0.35 | 0.29 | 0.40 | 0.36 | 0.47 | 0.17 |
| `arc` | 0.67 | 0.67 | 0.20 | 0.00 | 0.64 | 0.38 | 0.00 | 0.29 | 0.47 | 0.67 |
| `belebele_arz_Arab` | 0.33 | 0.53 | 0.40 | 0.33 | 0.25 | 0.19 | **0.80** | 0.50 | 0.33 | 0.17 |
| `global_piqa_parallel_cloze_arb_arab` | 0.27 | 0.40 | 0.47 | 0.50 | 0.24 | 0.48 | 0.10 | 0.14 | 0.27 | 0.50 |
| `global_piqa_parallel_cloze_ars_arab` | 0.31 | 0.40 | 0.07 | 0.00 | 0.16 | 0.43 | 0.50 | 0.54 | 0.27 | 0.67 |
...
| `include_base_44` | 0.25 | 0.36 | 0.73 | **1.00** | 0.64 | 0.43 | 0.33 | 0.32 | 0.00 | 0.67 |
| `belebele` | 0.61 | 0.43 | 0.40 | 0.00 | 0.47 | 0.43 | 0.67 | 0.54 | 0.17 | 0.33 |
| `global_piqa_parallel_cloze` | 0.68 | 0.32 | 0.33 | 0.00 | 0.28 | 0.33 | 0.00 | 0.36 | 0.17 | 0.67 |
...
| `xnli` | 0.69 | 0.67 | 0.73 | 0.67 | **0.78** | 0.57 | **1.00** | **0.79** | **0.90** | **1.00** |
| `include_base_44` | 0.39 | 0.64 | 0.20 | 0.67 | 0.49 | 0.71 | **0.83** | 0.43 | 0.40 | 0.67 |
| `belebele` | 0.44 | 0.61 | 0.67 | 0.67 | 0.36 | 0.67 | 0.17 | 0.39 | 0.40 | **1.00** |
| `global_piqa_parallel_cloze` | 0.25 | 0.36 | 0.40 | 0.33 | 0.62 | 0.67 | 0.67 | **0.79** | 0.50 | 0.67 |
...
| `hellaswag` | 0.61 | 0.58 | **0.80** | **1.00** | 0.73 | 0.71 | 0.70 | **0.79** | 0.73 | **1.00** |
| `multiblimp` | 0.69 | **0.75** | 0.60 | 0.67 | 0.73 | 0.62 | 0.70 | **0.79** | 0.67 | **0.83** |
| `belebele_ben_Beng` | 0.39 | 0.58 | 0.33 | 0.67 | 0.53 | 0.29 | 0.50 | 0.50 | 0.60 | **0.83** |
| `global_mmlu_full` | 0.44 | 0.28 | 0.67 | **0.83** | 0.42 | 0.52 | 0.30 | 0.50 | 0.40 | 0.33 |
| `arc` | 0.47 | 0.19 | 0.60 | **0.83** | 0.36 | 0.43 | 0.60 | 0.14 | 0.07 | **0.83** |
| `global_piqa_parallel_cloze_ben_latn` | 0.50 | 0.72 | 0.53 | 0.33 | 0.53 | 0.52 | 0.40 | 0.46 | 0.13 | 0.33 |
| `belebele_ben_Latn` | 0.28 | 0.42 | 0.27 | 0.33 | 0.44 | 0.71 | 0.60 | 0.36 | 0.20 | **0.83** |
| `include_base_44` | 0.42 | **0.81** | 0.67 | 0.33 | 0.51 | 0.48 | 0.10 | 0.43 | 0.20 | 0.50 |
| `global_piqa_parallel_cloze_ben_beng` | 0.31 | 0.17 | 0.53 | 0.50 | 0.67 | 0.43 | 0.40 | 0.32 | 0.47 | 0.50 |
...
| `global_piqa_nonparallel_cloze` | 0.36 | 0.57 | 0.20 | **1.00** | 0.53 | **0.81** | 0.00 | 0.54 | 0.50 | 0.67 |
...
| `hellaswag` | **0.82** | 0.71 | 0.73 | **1.00** | **0.86** | **0.86** | **1.00** | **0.82** | **0.83** | **1.00** |
| `multiblimp` | **0.86** | **0.75** | 0.67 | 0.00 | **0.86** | **0.90** | 0.67 | **0.79** | **1.00** | 0.67 |
| `xstorycloze` | **0.89** | 0.64 | 0.67 | 0.00 | 0.67 | 0.62 | 0.67 | **0.96** | **0.83** | 0.67 |
| `xnli` | **0.75** | 0.54 | 0.60 | **1.00** | 0.69 | **0.86** | 0.67 | 0.71 | 0.33 | 0.33 |
| `paws` | 0.61 | 0.43 | 0.67 | 0.00 | 0.64 | 0.67 | 0.67 | 0.57 | **0.83** | **1.00** |
| `global_piqa_parallel_cloze` | 0.36 | 0.43 | 0.60 | **1.00** | 0.56 | 0.38 | 0.67 | 0.46 | **0.83** | 0.00 |
| `arc` | 0.25 | 0.64 | 0.60 | 0.00 | 0.17 | 0.33 | **1.00** | 0.71 | 0.50 | **1.00** |
| `belebele` | 0.50 | 0.57 | 0.40 | **1.00** | 0.56 | 0.29 | 0.00 | 0.32 | 0.33 | 0.67 |
...
| `global_piqa_parallel_cloze` | 0.44 | 0.56 | 0.60 | 0.17 | 0.60 | 0.38 | **0.80** | 0.61 | 0.33 | 0.33 |
| `global_mmlu_full` | 0.61 | 0.53 | 0.47 | 0.33 | 0.36 | 0.43 | 0.60 | 0.36 | 0.67 | 0.17 |
| `belebele` | **0.75** | 0.56 | 0.07 | 0.00 | 0.53 | 0.33 | 0.50 | 0.43 | **0.80** | 0.33 |
...
| `multiblimp` | **0.75** | 0.72 | **0.87** | 0.67 | 0.69 | 0.67 | 0.67 | **0.75** | 0.60 | 0.67 |
| `arc` | 0.36 | 0.14 | 0.20 | 0.33 | 0.71 | 0.57 | **0.83** | 0.71 | **0.80** | 0.67 |
| `belebele` | 0.47 | 0.47 | 0.47 | 0.67 | 0.42 | 0.62 | 0.67 | 0.43 | 0.10 | **1.00** |
...
| `hellaswag` | 0.62 | 0.55 | 0.67 | **0.80** | **0.82** | 0.71 | **1.00** | **0.89** | **0.95** | **0.90** |
| `lambada_openai_mt` | 0.62 | 0.60 | 0.73 | 0.70 | 0.62 | 0.71 | **0.87** | **0.79** | 0.71 | **0.90** |
| `xnli` | 0.49 | 0.67 | 0.53 | 0.70 | 0.53 | 0.52 | 0.60 | **0.86** | **0.86** | **0.90** |
| `multiblimp` | 0.58 | 0.67 | 0.60 | 0.50 | 0.61 | 0.67 | 0.67 | **0.79** | 0.67 | **0.90** |
| `paws` | 0.29 | 0.67 | 0.47 | 0.30 | 0.52 | 0.71 | **0.80** | 0.39 | 0.62 | **1.00** |
| `arc` | 0.38 | 0.62 | 0.13 | 0.50 | 0.58 | 0.52 | 0.53 | 0.71 | **0.81** | **0.90** |
| `global_piqa_parallel_cloze` | 0.29 | 0.36 | 0.47 | 0.50 | 0.71 | 0.62 | 0.60 | 0.61 | 0.71 | 0.70 |
| `include_base_44` | 0.20 | 0.64 | 0.53 | **0.90** | 0.39 | 0.29 | 0.33 | 0.25 | **0.76** | 0.40 |
| `global_mmlu_full` | 0.29 | 0.45 | 0.53 | 0.60 | 0.38 | 0.43 | 0.53 | 0.39 | 0.67 | 0.30 |
| `belebele` | 0.35 | 0.27 | 0.33 | **0.80** | 0.56 | 0.38 | 0.20 | 0.54 | 0.33 | 0.70 |
...
| `belebele` | 0.31 | 0.69 | 0.60 | **0.80** | 0.40 | 0.57 | 0.67 | **0.79** | 0.71 | **0.80** |
| `global_mmlu_full` | **0.78** | 0.39 | 0.60 | 0.20 | 0.42 | 0.43 | 0.47 | 0.21 | 0.57 | 0.30 |
| `include_base_44` | 0.39 | 0.31 | 0.73 | 0.30 | 0.51 | 0.38 | 0.47 | 0.43 | 0.29 | 0.50 |
| `global_piqa_parallel_cloze` | 0.39 | 0.36 | 0.60 | 0.20 | 0.24 | 0.43 | 0.20 | 0.57 | 0.67 | 0.50 |
...
| `multiblimp` | 0.64 | 0.67 | **0.80** | **0.83** | 0.56 | **0.86** | **1.00** | **0.89** | 0.73 | **0.83** |
| `xstorycloze` | 0.53 | 0.56 | **0.87** | 0.33 | **0.80** | 0.71 | **0.80** | **0.79** | **0.93** | **1.00** |
| `lambada_openai_mt` | 0.55 | 0.65 | 0.73 | 0.50 | 0.61 | **0.90** | 0.50 | **0.79** | **0.87** | **1.00** |
| `xnli` | 0.60 | 0.58 | 0.67 | **0.83** | 0.67 | 0.71 | 0.70 | **0.82** | 0.73 | 0.67 |
| `arc` | 0.47 | 0.38 | **0.87** | 0.33 | **0.76** | **0.76** | 0.60 | 0.71 | **0.80** | **0.83** |
| `belebele` | 0.47 | 0.56 | 0.53 | **0.83** | 0.44 | 0.38 | **0.90** | 0.57 | 0.53 | **1.00** |
| `paws` | 0.55 | 0.64 | 0.53 | 0.33 | 0.70 | **0.76** | 0.60 | 0.64 | 0.47 | 0.67 |
| `truthfulqa-multi_mc1` | 0.40 | 0.42 | 0.40 | 0.50 | 0.56 | 0.57 | 0.40 | 0.54 | **0.80** | 0.67 |
| `include_base_44` | 0.29 | 0.45 | **0.80** | **0.83** | 0.48 | 0.33 | 0.50 | 0.50 | 0.53 | 0.50 |
| `global_mmlu_full` | 0.40 | 0.62 | 0.33 | 0.50 | 0.53 | 0.52 | 0.40 | 0.57 | 0.53 | 0.50 |
| `global_piqa_parallel_cloze_spa_latn_spai` | 0.53 | 0.11 | 0.60 | 0.33 | 0.44 | 0.33 | 0.60 | 0.14 | 0.47 | 0.50 |
| `global_piqa_parallel_cloze_spa_latn_mexi` | 0.44 | 0.33 | 0.40 | 0.33 | 0.39 | 0.52 | 0.50 | 0.18 | 0.73 | 0.17 |
| `global_piqa_parallel_cloze_spa_latn_peru` | 0.44 | 0.44 | 0.20 | 0.67 | 0.55 | 0.19 | 0.30 | 0.11 | 0.67 | 0.33 |
...
| `global_piqa_parallel_cloze` | 0.46 | 0.61 | 0.53 | 0.00 | 0.39 | 0.71 | 0.67 | 0.64 | 0.67 | **1.00** |
| `include_base_44` | 0.32 | 0.71 | **0.87** | 0.00 | 0.61 | 0.57 | 0.33 | 0.64 | 0.17 | **1.00** |
| `belebele` | 0.29 | **0.75** | 0.73 | **1.00** | 0.31 | 0.24 | 0.67 | 0.57 | 0.50 | 0.00 |
| `xcopa` | **0.89** | 0.71 | 0.47 | 0.00 | 0.61 | 0.43 | 0.33 | 0.50 | 0.67 | 0.00 |
...
| `multiblimp` | **0.82** | 0.69 | **0.80** | **0.80** | **0.82** | 0.71 | **0.87** | **0.75** | **1.00** | **0.90** |
| `include_base_44` | 0.49 | 0.58 | 0.67 | 0.40 | 0.40 | 0.43 | 0.33 | 0.68 | **0.76** | **0.90** |
| `global_mmlu_full` | 0.62 | 0.40 | **1.00** | 0.20 | 0.35 | 0.52 | 0.47 | 0.54 | 0.57 | 0.40 |
| `global_piqa_parallel_cloze` | 0.40 | 0.22 | 0.40 | 0.70 | 0.51 | 0.62 | 0.47 | **0.75** | 0.57 | 0.40 |
| `belebele` | 0.29 | 0.53 | 0.53 | 0.50 | 0.25 | 0.24 | 0.27 | 0.61 | 0.67 | 0.40 |
...
| `multiblimp` | 0.72 | **0.83** | 0.67 | **1.00** | **0.76** | **0.86** | **1.00** | **0.82** | **0.80** | 0.67 |
| `include_base_44` | **0.81** | 0.28 | 0.47 | 0.67 | 0.36 | 0.48 | 0.50 | 0.32 | 0.30 | 0.33 |
| `belebele` | 0.39 | 0.44 | 0.33 | 0.33 | 0.38 | 0.52 | 0.67 | 0.54 | 0.10 | 0.33 |
| `global_piqa_parallel_cloze` | 0.56 | 0.44 | 0.47 | 0.00 | 0.42 | 0.52 | 0.33 | 0.43 | 0.40 | 0.33 |
...
| `xnli` | 0.58 | 0.60 | **0.80** | 0.50 | 0.70 | **0.76** | **0.80** | **0.89** | 0.73 | 0.67 |
| `multiblimp` | 0.69 | 0.67 | 0.73 | 0.17 | 0.67 | **0.76** | 0.70 | **0.82** | **0.87** | **0.83** |
| `global_piqa_parallel_cloze_fra_latn_cana` | 0.55 | 0.64 | 0.67 | 0.50 | **0.83** | **0.86** | 0.60 | **0.82** | **0.80** | 0.50 |
| `xwinograd` | 0.33 | 0.51 | 0.20 | 0.67 | 0.61 | **0.76** | 0.70 | 0.71 | 0.73 | 0.67 |
| `include_base_44` | 0.49 | 0.45 | 0.67 | 0.33 | 0.45 | 0.48 | 0.50 | 0.43 | **0.87** | 0.67 |
| `global_piqa_parallel_cloze_fra_latn_fran` | 0.47 | 0.35 | 0.53 | 0.67 | 0.62 | 0.52 | 0.60 | 0.14 | 0.47 | 0.50 |
| `belebele` | 0.49 | 0.60 | 0.33 | 0.67 | 0.39 | 0.43 | 0.50 | 0.43 | 0.40 | 0.50 |
| `global_mmlu_full` | 0.27 | 0.40 | 0.27 | 0.67 | 0.48 | 0.57 | 0.40 | 0.50 | 0.40 | 0.50 |
| `paws` | 0.35 | 0.33 | 0.53 | 0.67 | 0.45 | 0.43 | 0.50 | 0.43 | 0.40 | 0.33 |
...
| `multiblimp` | **0.93** | **0.75** | 0.73 | **1.00** | 0.69 | 0.71 | **0.83** | **0.79** | 0.60 | 0.67 |
| `global_mmlu_full` | 0.57 | 0.57 | 0.67 | 0.67 | 0.36 | 0.62 | **0.83** | 0.54 | 0.30 | 0.50 |
| `belebele` | 0.46 | 0.71 | 0.53 | 0.33 | 0.69 | 0.52 | 0.67 | 0.50 | 0.50 | 0.67 |
| `include_base_44` | 0.46 | 0.64 | 0.13 | **1.00** | 0.44 | 0.43 | 0.67 | 0.25 | 0.30 | 0.50 |
| `global_piqa_parallel_cloze` | 0.29 | 0.36 | 0.40 | 0.33 | 0.33 | 0.38 | 0.33 | 0.43 | 0.40 | 0.50 |
...
| `multiblimp` | 0.72 | **0.81** | **0.93** | 0.67 | **0.76** | 0.71 | **0.80** | **0.79** | 0.73 | **1.00** |
| `xstorycloze` | 0.72 | **0.78** | **0.87** | **0.83** | 0.71 | **0.76** | **0.90** | 0.71 | 0.73 | **0.83** |
| `hellaswag` | 0.56 | 0.58 | 0.67 | **0.83** | **0.78** | **0.86** | 0.70 | **0.82** | **0.87** | **0.83** |
| `xnli` | 0.50 | 0.61 | 0.40 | **0.83** | **0.80** | **0.86** | **0.80** | **0.82** | 0.73 | **0.83** |
| `belebele_hin_Latn` | 0.47 | 0.56 | 0.53 | 0.67 | 0.69 | **0.81** | 0.30 | 0.64 | 0.33 | **0.83** |
| `global_piqa_parallel_cloze` | 0.50 | 0.56 | 0.73 | 0.67 | 0.64 | 0.48 | 0.30 | 0.54 | 0.33 | **0.83** |
| `belebele_hin_Deva` | 0.39 | 0.36 | 0.53 | **0.83** | 0.47 | 0.38 | **0.80** | 0.32 | 0.60 | 0.50 |
| `arc` | 0.64 | 0.53 | 0.67 | 0.67 | 0.24 | 0.43 | 0.50 | 0.54 | 0.53 | 0.33 |
| `include_base_44` | 0.25 | 0.64 | 0.40 | 0.50 | 0.51 | 0.57 | 0.40 | 0.57 | 0.73 | 0.33 |
...
| `belebele` | 0.50 | 0.64 | 0.33 | 0.00 | 0.53 | 0.48 | 0.33 | 0.61 | 0.33 | **1.00** |
| `global_piqa_parallel_cloze` | 0.25 | 0.57 | 0.60 | 0.00 | 0.44 | 0.33 | 0.67 | 0.64 | 0.17 | 0.33 |
| `include_base_44` | 0.43 | 0.21 | 0.33 | 0.00 | 0.39 | 0.14 | 0.67 | 0.39 | 0.33 | 0.00 |
...
| `multiblimp` | 0.72 | 0.69 | **0.87** | **0.83** | 0.73 | **0.76** | 0.60 | 0.64 | **0.80** | **1.00** |
| `hellaswag` | **0.83** | 0.72 | 0.60 | 0.67 | 0.73 | **0.81** | **0.90** | **0.89** | **0.80** | 0.67 |
| `global_piqa_parallel_cloze` | 0.39 | 0.22 | 0.53 | 0.33 | 0.60 | 0.48 | 0.70 | 0.46 | 0.67 | 0.67 |
| `arc` | 0.36 | 0.47 | 0.47 | 0.50 | 0.24 | 0.24 | 0.40 | **0.75** | 0.67 | **0.83** |
| `include_base_44` | 0.33 | 0.31 | 0.53 | 0.17 | 0.53 | 0.52 | 0.60 | 0.29 | 0.47 | **0.83** |
| `belebele` | 0.22 | 0.53 | 0.60 | 0.33 | 0.20 | 0.57 | 0.40 | 0.29 | 0.47 | 0.33 |
...
| `xcopa` | **0.82** | **0.76** | **0.87** | 0.67 | 0.67 | **0.95** | 0.70 | 0.71 | 0.73 | 0.67 |
| `xstorycloze` | 0.69 | 0.73 | **0.93** | 0.50 | **0.82** | 0.67 | **0.80** | 0.64 | **0.87** | **0.83** |
| `arc` | 0.58 | 0.51 | 0.60 | 0.50 | 0.73 | **0.76** | **0.90** | 0.61 | **0.93** | 0.67 |
| `belebele` | 0.49 | 0.44 | 0.67 | **0.83** | 0.42 | 0.29 | **0.80** | 0.71 | 0.60 | 0.33 |
| `include_base_44` | 0.40 | 0.60 | 0.47 | **0.83** | 0.31 | 0.24 | 0.10 | **0.75** | 0.67 | **0.83** |
| `global_mmlu_full` | 0.49 | 0.47 | 0.47 | 0.33 | 0.44 | 0.43 | 0.40 | **0.79** | 0.73 | 0.50 |
| `global_piqa_parallel_cloze` | 0.47 | 0.33 | 0.60 | 0.33 | 0.56 | 0.71 | 0.10 | 0.64 | 0.20 | 0.33 |
...
| `hellaswag` | 0.75 | 0.71 | 0.73 | 0.67 | **0.85** | **0.95** | **0.80** | **0.93** | **0.87** | **0.83** |
| `lambada_openai_mt` | **0.80** | **0.82** | **0.80** | 0.67 | **0.77** | **0.81** | **0.80** | **0.89** | 0.73 | **0.83** |
| `multiblimp` | 0.65 | 0.58 | 0.73 | 0.50 | **0.83** | **0.90** | **0.90** | **0.79** | **0.80** | **0.83** |
| `xcopa` | 0.40 | 0.45 | 0.40 | 0.50 | 0.62 | **0.76** | **1.00** | **0.75** | 0.60 | **1.00** |
| `include_base_44` | 0.45 | 0.33 | 0.60 | 0.33 | 0.39 | 0.62 | 0.60 | 0.43 | 0.53 | **0.83** |
| `global_mmlu_full` | 0.44 | 0.53 | 0.47 | 0.50 | 0.38 | 0.67 | 0.30 | 0.50 | 0.60 | 0.50 |
| `belebele` | 0.64 | 0.44 | 0.33 | **0.83** | 0.45 | 0.43 | 0.30 | 0.46 | 0.13 | 0.50 |
| `arc` | 0.45 | 0.40 | 0.00 | 0.17 | 0.53 | 0.38 | 0.30 | **0.79** | **0.80** | 0.67 |
| `global_piqa_parallel_cloze` | 0.51 | 0.25 | 0.33 | 0.33 | 0.33 | 0.29 | 0.50 | 0.54 | 0.67 | 0.50 |
...
| `xwinograd` | 0.55 | 0.55 | 0.33 | 0.60 | 0.44 | 0.57 | 0.73 | **0.89** | 0.71 | 0.70 |
| `include_base_44` | 0.47 | 0.42 | 0.47 | **0.90** | 0.56 | **0.81** | 0.53 | 0.61 | 0.48 | 0.50 |
| `global_mmlu_full` | 0.45 | 0.47 | 0.60 | **0.80** | 0.44 | 0.33 | 0.53 | 0.61 | 0.52 | 0.10 |
| `belebele` | 0.38 | 0.56 | 0.60 | 0.60 | 0.36 | 0.38 | 0.40 | 0.25 | 0.67 | 0.30 |
| `global_piqa_parallel_cloze` | 0.40 | 0.31 | 0.47 | 0.10 | 0.70 | 0.10 | 0.27 | 0.46 | 0.52 | 0.60 |
...
| `multiblimp` | 0.61 | 0.64 | 0.73 | **1.00** | 0.64 | **0.76** | **0.83** | 0.64 | 0.50 | **1.00** |
| `include_base_44` | 0.68 | 0.29 | **0.80** | 0.67 | 0.44 | **0.86** | 0.50 | 0.54 | 0.40 | 0.67 |
| `belebele` | 0.71 | 0.57 | 0.47 | 0.67 | 0.44 | 0.43 | 0.67 | 0.29 | 0.10 | 0.50 |
| `global_piqa_parallel_cloze` | 0.64 | 0.46 | 0.27 | 0.67 | 0.28 | 0.48 | 0.50 | 0.32 | 0.10 | 0.50 |
...
| `belebele` | 0.61 | 0.71 | 0.53 | 0.00 | 0.50 | 0.52 | 0.67 | 0.39 | 0.67 | **1.00** |
| `multiblimp` | **0.75** | 0.71 | 0.53 | 0.00 | **0.86** | 0.62 | 0.33 | 0.71 | 0.33 | 0.67 |
| `global_piqa_nonparallel_cloze` | 0.39 | 0.29 | 0.67 | **1.00** | **0.75** | 0.67 | 0.33 | 0.57 | 0.17 | 0.00 |
| `include_base_44` | 0.46 | 0.32 | 0.00 | 0.00 | 0.64 | 0.71 | 0.33 | 0.61 | 0.50 | 0.00 |
...
| `global_piqa_parallel_cloze` | 0.64 | 0.47 | **0.80** | 0.67 | 0.42 | 0.67 | 0.70 | 0.54 | 0.60 | **0.83** |
| `paws` | 0.72 | 0.67 | 0.53 | 0.50 | 0.58 | 0.57 | 0.70 | 0.39 | 0.73 | 0.50 |
| `include_base_44` | 0.44 | **0.83** | 0.73 | 0.67 | 0.31 | 0.57 | **0.80** | 0.57 | 0.47 | 0.00 |
| `global_mmlu_full` | 0.61 | 0.33 | 0.73 | 0.50 | 0.40 | 0.48 | 0.50 | 0.57 | 0.40 | 0.50 |
| `belebele` | 0.25 | 0.39 | 0.60 | 0.33 | 0.64 | 0.33 | 0.60 | 0.36 | 0.53 | 0.50 |
...
| `multiblimp` | **0.75** | **0.75** | 0.47 | **1.00** | 0.67 | 0.52 | 0.33 | 0.57 | 0.67 | 0.33 |
| `belebele` | **0.75** | 0.39 | 0.53 | 0.00 | 0.36 | 0.38 | 0.67 | 0.46 | 0.33 | 0.67 |
| `global_piqa_parallel_cloze` | 0.29 | 0.43 | 0.40 | 0.00 | 0.44 | 0.24 | 0.67 | 0.36 | 0.67 | **1.00** |
| `global_mmlu_full` | 0.39 | 0.50 | 0.33 | 0.00 | 0.50 | 0.33 | **1.00** | 0.32 | **1.00** | 0.00 |
| `include_base_44` | 0.50 | 0.54 | 0.47 | 0.00 | 0.61 | 0.14 | 0.33 | 0.39 | 0.17 | 0.33 |
...
| `belebele` | 0.46 | 0.64 | 0.53 | 0.00 | 0.50 | 0.38 | **1.00** | 0.46 | 0.33 | 0.67 |
...
| `hellaswag` | **0.89** | 0.71 | 0.73 | 0.67 | 0.67 | 0.71 | 0.50 | **0.75** | 0.40 | 0.50 |
| `include_base_44` | 0.64 | 0.64 | 0.53 | 0.67 | 0.39 | 0.43 | 0.50 | 0.61 | 0.60 | 0.33 |
| `arc` | 0.57 | 0.46 | 0.40 | 0.00 | 0.69 | 0.71 | 0.67 | **0.75** | 0.70 | 0.33 |
| `belebele` | **0.79** | 0.50 | 0.60 | 0.00 | 0.39 | 0.62 | **0.83** | 0.61 | 0.50 | 0.33 |
| `global_piqa_parallel_cloze` | 0.57 | 0.39 | 0.13 | 0.00 | 0.50 | 0.19 | 0.00 | 0.25 | **0.80** | 0.17 |
...
| `hellaswag` | 0.54 | 0.68 | 0.73 | **1.00** | **0.78** | 0.67 | **1.00** | **0.75** | **0.83** | 0.67 |
| `global_piqa_parallel_cloze` | 0.54 | **0.75** | 0.40 | **1.00** | 0.50 | 0.67 | **1.00** | 0.46 | 0.17 | 0.67 |
| `multiblimp` | 0.32 | 0.46 | 0.73 | **1.00** | 0.47 | 0.52 | **1.00** | 0.54 | 0.00 | 0.67 |
| `arc` | 0.46 | 0.46 | 0.53 | **1.00** | 0.64 | 0.57 | 0.33 | **0.75** | 0.33 | 0.33 |
| `belebele` | 0.68 | 0.43 | 0.33 | 0.00 | 0.56 | 0.33 | 0.67 | 0.43 | 0.50 | **1.00** |
...
| `belebele` | 0.14 | 0.46 | **0.80** | **1.00** | 0.31 | 0.19 | 0.67 | **0.75** | 0.33 | 0.67 |
| `include_base_44` | 0.57 | 0.21 | 0.60 | **1.00** | 0.58 | 0.48 | 0.67 | 0.43 | 0.33 | 0.33 |
| `global_piqa_parallel_cloze` | 0.57 | 0.11 | 0.27 | **1.00** | 0.25 | 0.19 | 0.00 | 0.46 | 0.33 | **1.00** |
...
| `arc` | 0.36 | 0.61 | 0.40 | **1.00** | 0.67 | 0.67 | 0.00 | **0.79** | **0.83** | **1.00** |
| `hellaswag` | 0.54 | 0.68 | 0.53 | **1.00** | 0.69 | **0.86** | 0.67 | 0.68 | 0.33 | 0.33 |
| `belebele_npi_Latn` | **0.75** | 0.54 | 0.53 | 0.00 | 0.56 | 0.62 | **1.00** | 0.57 | 0.17 | 0.67 |
| `include_base_44` | 0.57 | 0.43 | 0.53 | 0.00 | 0.58 | 0.62 | 0.67 | 0.68 | 0.50 | 0.33 |
| `belebele_npi_Deva` | 0.46 | 0.54 | 0.27 | 0.00 | 0.36 | 0.62 | **1.00** | 0.25 | 0.33 | 0.67 |
| `global_piqa_parallel_cloze` | 0.61 | 0.61 | 0.60 | 0.00 | 0.64 | 0.62 | 0.00 | 0.43 | 0.17 | 0.67 |
| `global_mmlu_full` | 0.57 | 0.50 | 0.60 | 0.00 | 0.22 | 0.43 | 0.67 | 0.50 | 0.17 | 0.67 |
...
| `arc` | 0.49 | 0.36 | 0.27 | 0.50 | 0.58 | **0.86** | **0.80** | **0.82** | **0.87** | **1.00** |
| `global_piqa_parallel_cloze` | 0.53 | 0.44 | 0.67 | 0.33 | 0.64 | 0.48 | 0.70 | 0.57 | 0.73 | **1.00** |
| `belebele` | 0.49 | 0.47 | 0.27 | 0.67 | 0.53 | 0.52 | 0.50 | 0.21 | 0.33 | 0.67 |
...
| `global_piqa_parallel_cloze` | 0.50 | 0.39 | 0.33 | 0.33 | 0.53 | 0.48 | 0.50 | 0.54 | 0.50 | 0.67 |
| `belebele` | 0.31 | 0.44 | 0.33 | 0.67 | 0.47 | 0.48 | 0.50 | 0.21 | 0.30 | 0.67 |
...
| `multiblimp` | 0.73 | 0.67 | **0.80** | 0.67 | 0.75 | **0.86** | **0.80** | **0.96** | **1.00** | **1.00** |
| `include_base_44` | 0.47 | 0.58 | 0.53 | 0.00 | 0.45 | 0.71 | 0.30 | 0.57 | 0.73 | 0.50 |
| `belebele` | 0.38 | 0.44 | 0.13 | 0.50 | 0.55 | 0.48 | 0.10 | 0.57 | 0.60 | 0.50 |
| `global_mmlu_full` | 0.40 | 0.33 | 0.53 | 0.00 | 0.45 | 0.38 | 0.70 | 0.57 | 0.60 | 0.17 |
| `global_piqa_parallel_cloze` | 0.51 | 0.51 | 0.13 | 0.00 | 0.38 | 0.19 | 0.30 | 0.46 | **0.80** | **0.83** |
...
| `hellaswag` | 0.69 | 0.69 | **0.87** | 0.67 | **0.87** | **0.86** | **1.00** | **0.89** | **1.00** | **1.00** |
| `multiblimp` | **0.87** | **0.76** | **0.80** | 0.67 | **0.84** | **0.81** | 0.70 | **0.86** | **0.93** | **0.83** |
| `arc` | 0.69 | 0.64 | 0.60 | 0.67 | **0.82** | **0.90** | **0.90** | **0.79** | **0.87** | 0.67 |
| `xwinograd` | 0.58 | 0.73 | 0.73 | 0.67 | 0.65 | 0.71 | **0.80** | **0.82** | 0.73 | **0.83** |
| `global_piqa_parallel_cloze_por_latn_port` | 0.69 | 0.49 | 0.27 | 0.67 | 0.62 | 0.52 | 0.40 | 0.36 | 0.47 | 0.67 |
| `global_piqa_parallel_cloze_por_latn_braz` | 0.60 | 0.29 | 0.33 | 0.33 | 0.38 | 0.67 | 0.60 | 0.32 | 0.47 | 0.50 |
| `include_base_44` | 0.44 | 0.40 | 0.27 | 0.50 | 0.51 | 0.52 | 0.70 | 0.54 | 0.33 | 0.17 |
| `global_mmlu_full` | 0.42 | 0.60 | 0.47 | 0.33 | 0.56 | 0.38 | 0.70 | 0.36 | 0.53 | 0.00 |
| `belebele` | 0.44 | 0.40 | 0.67 | 0.33 | 0.75 | 0.33 | 0.10 | 0.36 | 0.13 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `hellaswag` | 0.58 | 0.64 | **0.87** | **0.83** | **0.78** | 0.71 | **0.90** | **0.75** | **0.80** | **1.00** |
| `bpb` | **0.78** | 0.69 | **0.83** | 0.67 | **0.89** | **0.81** | 0.67 | **0.83** | 0.71 | **0.80** |
| `multiblimp` | **0.83** | 0.64 | **0.80** | **0.83** | 0.73 | **0.81** | **0.80** | **0.75** | **0.80** | 0.67 |
| `belebele` | 0.61 | 0.39 | 0.60 | 0.17 | 0.73 | 0.38 | 0.40 | 0.57 | 0.47 | 0.67 |
| `global_mmlu_full` | 0.58 | 0.25 | **0.80** | 0.33 | 0.38 | 0.57 | 0.70 | 0.25 | **0.93** | 0.17 |
| `arc` | 0.58 | 0.14 | 0.27 | 0.33 | 0.24 | 0.38 | 0.50 | 0.61 | **0.80** | **0.83** |
| `global_piqa_parallel_cloze` | 0.42 | 0.25 | 0.67 | 0.00 | 0.51 | 0.52 | 0.30 | 0.21 | 0.60 | 0.00 |
...
| `hellaswag` | 0.68 | 0.63 | 0.52 | **0.86** | **0.82** | **0.81** | **0.90** | **0.89** | **0.93** | **0.90** |
| `multiblimp` | **0.77** | **0.76** | 0.67 | 0.71 | **0.86** | **0.81** | 0.71 | **0.82** | **0.82** | **0.90** |
| `xstorycloze` | **0.78** | 0.65 | 0.57 | 0.67 | 0.65 | 0.52 | 0.71 | **0.86** | **0.89** | **0.90** |
| `arc` | 0.65 | 0.56 | 0.43 | 0.67 | 0.62 | **0.76** | **0.81** | **0.93** | **0.75** | **0.80** |
| `xnli` | 0.51 | 0.53 | 0.52 | 0.67 | 0.46 | 0.38 | 0.24 | 0.68 | **0.82** | 0.70 |
| `belebele` | 0.46 | 0.71 | 0.71 | 0.57 | 0.44 | 0.29 | 0.24 | 0.64 | 0.57 | 0.60 |
| `xwinograd` | 0.41 | 0.38 | 0.67 | 0.57 | 0.42 | 0.19 | 0.52 | 0.50 | 0.71 | 0.70 |
| `global_piqa_parallel_cloze` | 0.35 | 0.25 | 0.40 | 0.10 | 0.38 | 0.62 | 0.43 | 0.64 | 0.68 | **1.00** |
| `include_base_44` | 0.51 | 0.33 | 0.43 | 0.62 | 0.56 | 0.67 | 0.38 | 0.57 | 0.32 | 0.40 |
...
| `arc` | 0.21 | 0.32 | 0.33 | 0.00 | 0.64 | 0.71 | 0.67 | **0.79** | **0.83** | 0.67 |
| `belebele` | 0.68 | 0.54 | 0.27 | **1.00** | 0.31 | 0.48 | 0.67 | 0.50 | 0.33 | 0.33 |
| `global_piqa_parallel_cloze_slk_latn` | 0.43 | 0.39 | 0.33 | **1.00** | 0.22 | 0.43 | 0.67 | 0.32 | 0.50 | 0.67 |
| `global_piqa_parallel_cloze_slk_latn_sari` | 0.50 | 0.50 | 0.13 | **1.00** | 0.47 | 0.38 | **1.00** | 0.21 | 0.17 | 0.33 |
...
| `global_piqa_parallel_cloze_slv_latn` | 0.71 | 0.54 | 0.53 | **1.00** | 0.33 | 0.48 | 0.33 | 0.57 | 0.67 | 0.67 |
| `belebele` | 0.61 | 0.71 | 0.20 | 0.00 | 0.42 | 0.29 | 0.33 | 0.43 | 0.33 | 0.67 |
| `global_piqa_parallel_cloze_slv_latn_cerk` | 0.46 | 0.25 | 0.47 | **1.00** | 0.47 | 0.33 | 0.33 | 0.43 | 0.00 | 0.00 |
...
| `belebele` | 0.29 | 0.57 | 0.67 | **1.00** | 0.47 | 0.43 | 0.00 | 0.46 | 0.17 | **1.00** |
| `include_base_44` | 0.36 | 0.50 | 0.47 | 0.00 | 0.42 | 0.62 | 0.33 | 0.21 | 0.50 | 0.67 |
| `global_piqa_parallel_cloze` | 0.50 | 0.36 | 0.47 | 0.00 | 0.39 | 0.52 | 0.00 | 0.36 | 0.17 | 0.33 |
...
| `arc` | 0.29 | 0.46 | 0.27 | 0.00 | **0.75** | 0.71 | **1.00** | **0.75** | 0.67 | **1.00** |
| `belebele` | 0.46 | 0.39 | 0.53 | 0.00 | 0.61 | 0.48 | 0.67 | 0.61 | **1.00** | 0.33 |
| `global_piqa_parallel_cloze_srp_cyrl` | 0.54 | 0.57 | 0.27 | **1.00** | 0.64 | 0.43 | 0.00 | 0.39 | 0.17 | 0.33 |
| `global_piqa_parallel_cloze_srp_latn` | 0.43 | 0.39 | 0.40 | 0.00 | 0.56 | 0.57 | 0.33 | 0.57 | 0.33 | 0.67 |
| `include_base_44` | 0.54 | 0.57 | 0.40 | 0.00 | **0.75** | 0.48 | 0.33 | 0.64 | 0.17 | 0.33 |
...
| `multiblimp` | **0.75** | **0.83** | 0.73 | 0.67 | **0.76** | 0.57 | 0.70 | **0.75** | **0.80** | 0.67 |
| `arc` | 0.28 | 0.14 | 0.27 | 0.50 | 0.71 | **0.76** | 0.70 | **0.79** | **0.87** | **1.00** |
| `global_mmlu_full` | 0.56 | 0.47 | 0.60 | 0.17 | 0.36 | 0.52 | 0.60 | 0.64 | 0.67 | 0.67 |
| `belebele` | 0.25 | 0.36 | 0.33 | 0.50 | 0.53 | 0.67 | **0.80** | 0.29 | 0.47 | 0.50 |
| `global_piqa_parallel_cloze` | 0.33 | 0.42 | 0.33 | 0.50 | 0.62 | 0.62 | 0.60 | 0.46 | 0.40 | 0.17 |
...
| `multiblimp` | 0.64 | **0.75** | **0.87** | 0.67 | 0.67 | 0.67 | **1.00** | 0.68 | 0.70 | 0.67 |
| `xcopa` | 0.68 | 0.64 | 0.67 | 0.00 | 0.72 | 0.48 | 0.50 | 0.32 | 0.30 | **0.83** |
| `global_piqa_parallel_cloze` | 0.50 | 0.57 | 0.67 | 0.33 | 0.67 | 0.62 | 0.33 | 0.54 | 0.20 | 0.50 |
| `arc` | 0.25 | 0.11 | 0.07 | 0.00 | 0.72 | 0.52 | 0.67 | 0.71 | **1.00** | 0.67 |
| `belebele` | 0.46 | 0.36 | 0.33 | 0.33 | 0.42 | 0.38 | 0.67 | 0.43 | 0.50 | **0.83** |
| `include_base_44` | 0.46 | 0.11 | 0.53 | 0.67 | 0.36 | 0.38 | 0.67 | 0.39 | 0.20 | 0.33 |
...
| `belebele` | 0.36 | 0.53 | 0.40 | 0.40 | 0.49 | 0.48 | 0.53 | 0.68 | 0.38 | 0.20 |
| `xcopa` | 0.19 | 0.72 | 0.67 | 0.10 | 0.29 | 0.14 | 0.67 | **0.75** | 0.38 | 0.30 |
| `global_piqa_parallel_cloze` | 0.61 | 0.64 | 0.40 | 0.20 | 0.42 | 0.29 | 0.47 | 0.36 | 0.14 | 0.50 |
...
| `multiblimp` | 0.72 | 0.53 | 0.73 | 0.33 | 0.69 | 0.67 | **0.80** | **0.79** | **0.87** | 0.67 |
| `xnli` | 0.33 | 0.50 | 0.33 | 0.50 | 0.73 | **0.76** | **0.80** | 0.71 | **0.87** | **1.00** |
| `xcopa` | 0.67 | 0.50 | 0.73 | **0.83** | 0.36 | 0.67 | 0.40 | 0.46 | 0.53 | **0.83** |
| `belebele` | 0.53 | 0.61 | 0.53 | **1.00** | 0.51 | 0.48 | 0.30 | 0.57 | 0.47 | **0.83** |
| `global_mmlu_full` | 0.56 | 0.56 | 0.53 | 0.67 | 0.31 | 0.33 | 0.50 | 0.50 | **0.80** | **0.83** |
| `include_base_44` | 0.56 | 0.67 | 0.67 | 0.17 | 0.33 | 0.14 | 0.40 | 0.57 | 0.47 | 0.50 |
| `global_piqa_parallel_cloze` | 0.44 | 0.39 | 0.33 | 0.33 | 0.38 | 0.05 | 0.10 | 0.57 | 0.33 | 0.50 |
...
| `global_piqa_parallel_cloze` | 0.36 | 0.61 | 0.67 | 0.50 | 0.58 | 0.52 | 0.30 | 0.71 | 0.67 | **1.00** |
| `include_base_44` | 0.36 | 0.56 | 0.53 | 0.17 | 0.51 | 0.52 | 0.70 | **0.79** | 0.47 | 0.17 |
| `belebele` | 0.47 | 0.67 | 0.53 | 0.17 | 0.56 | 0.48 | 0.30 | 0.54 | 0.53 | 0.50 |
...
| `global_piqa_parallel_cloze_urd_arab` | 0.50 | 0.57 | 0.60 | **1.00** | 0.72 | 0.62 | **1.00** | 0.61 | 0.67 | **1.00** |
| `include_base_44` | 0.61 | 0.57 | 0.53 | **1.00** | 0.56 | **0.81** | 0.67 | 0.61 | **1.00** | 0.67 |
| `multiblimp` | **0.75** | **0.75** | 0.47 | 0.00 | **0.83** | 0.57 | **1.00** | 0.64 | 0.67 | 0.33 |
| `belebele_urd_Latn` | 0.57 | 0.32 | 0.53 | **1.00** | 0.36 | 0.52 | 0.67 | 0.36 | 0.33 | **1.00** |
| `xnli` | 0.36 | 0.64 | 0.47 | **1.00** | 0.44 | 0.71 | 0.33 | 0.54 | 0.50 | 0.00 |
| `global_piqa_parallel_cloze_urd_latn` | 0.46 | 0.18 | 0.53 | **1.00** | 0.53 | 0.19 | 0.67 | 0.29 | 0.33 | 0.67 |
| `belebele_urd_Arab` | 0.43 | 0.54 | 0.60 | 0.00 | 0.28 | 0.71 | 0.33 | 0.21 | 0.67 | 0.00 |
...
| `xcopa` | 0.69 | **0.84** | 0.67 | **0.83** | 0.67 | **0.81** | **0.90** | **0.75** | 0.67 | **0.83** |
| `xnli` | **0.82** | 0.60 | 0.73 | 0.67 | **0.78** | **0.76** | **0.80** | 0.71 | **0.80** | **0.83** |
...
| `arc` | 0.42 | 0.44 | 0.20 | 0.33 | 0.51 | 0.52 | 0.60 | 0.43 | 0.60 | **0.83** |
| `belebele` | 0.27 | 0.44 | 0.53 | **0.83** | 0.49 | 0.62 | 0.10 | 0.39 | 0.33 | 0.33 |
| `include_base_44` | 0.47 | 0.40 | 0.33 | 0.17 | 0.56 | 0.29 | 0.40 | 0.25 | 0.73 | 0.50 |
| `global_piqa_parallel_cloze` | 0.60 | 0.33 | 0.07 | 0.50 | 0.45 | 0.10 | 0.70 | 0.29 | 0.40 | 0.33 |
...
| `xstorycloze` | 0.75 | 0.53 | **0.80** | 0.50 | 0.61 | **0.95** | 0.73 | 0.71 | **0.90** | **0.80** |
| `arc` | 0.45 | 0.55 | 0.60 | 0.50 | 0.56 | **0.81** | 0.67 | **0.75** | **0.81** | **0.90** |
| `paws` | 0.47 | 0.69 | 0.40 | 0.50 | 0.71 | 0.52 | 0.73 | **0.79** | 0.57 | 0.60 |
| `xwinograd` | 0.38 | 0.35 | 0.13 | 0.00 | 0.47 | **0.86** | 0.60 | **0.86** | **0.86** | **0.90** |
| `xnli` | 0.35 | 0.55 | 0.47 | 0.20 | 0.59 | 0.62 | 0.53 | 0.61 | 0.52 | 0.60 |
| `belebele_zho_Hant` | 0.65 | 0.47 | 0.67 | 0.50 | 0.56 | 0.57 | 0.53 | 0.71 | 0.14 | 0.20 |
| `xcopa` | 0.38 | 0.38 | 0.13 | 0.50 | 0.38 | 0.48 | 0.47 | **0.79** | 0.71 | 0.60 |
| `global_mmlu_full` | 0.44 | 0.53 | 0.73 | 0.20 | 0.53 | 0.19 | 0.47 | 0.54 | 0.43 | 0.50 |
| `global_piqa_parallel_cloze_cmn_hans` | 0.45 | 0.55 | 0.53 | 0.10 | 0.41 | 0.43 | 0.33 | 0.57 | 0.43 | 0.50 |
| `include_base_44` | 0.55 | 0.40 | **0.80** | 0.10 | 0.58 | 0.43 | 0.20 | 0.29 | 0.52 | 0.40 |
| `global_piqa_parallel_cloze_cmn_hant` | 0.47 | 0.44 | 0.53 | 0.40 | 0.26 | 0.62 | 0.60 | 0.14 | 0.14 | 0.60 |
| `belebele_zho_Hans` | 0.58 | 0.60 | 0.53 | 0.10 | 0.39 | 0.14 | 0.33 | 0.54 | 0.38 | 0.40 |
