...
|---|---|---|---|
| ar | `multiblimp_arb` | 16.4 | 0.84 |
| bg | `multiblimp_bul` | 9.1 | 0.92 |
| bn | `bpb_ben_Beng` | 2.8 | 0.96 |
| ca | `multiblimp_cat` | 12.0 | 0.87 |
| cs | `multiblimp_ces` | 7.5 | 0.88 |
| da | `multiblimp_dan` | 8.1 | 0.72 |
| de | `multiblimp_deu` | 51.1 | 0.82 |
| el | `multiblimp_ell` | 24.7 | 0.82 |
| en | `multiblimp_eng` | 113.2 | 0.46 |
| es | `multiblimp_spa` | 36.7 | 0.85 |
| et | `multiblimp_est` | 9.7 | 0.74 |
| fa | `multiblimp_fas` | 8.1 | 0.83 |
| fi | `multiblimp_fin` | 7.0 | 0.78 |
| fr | `multiblimp_fra` | 40.0 | 0.72 |
| he | `multiblimp_heb` | 7.6 | 0.84 |
| hi | `multiblimp_hin` | 17.9 | 0.78 |
| hu | `multiblimp_hun` | 14.1 | 0.85 |
| id | `hellaswag_id` | 9.4 | 0.86 |
| it | `multiblimp_ita` | 14.5 | 0.81 |
| ja | `xwinograd_jp` | 4.8 | 0.72 |
| ka | `multiblimp_kat` | 7.7 | 0.78 |
| kk | `multiblimp_kaz` | 5.3 | 0.76 |
| lt | `multiblimp_lit` | 11.0 | 0.61 |
| ml | `bpb_mal_Mlym` | 3.8 | 0.93 |
| mr | `bpb_mar_Deva` | 20.5 | 0.86 |
| ne | `bpb_npi_Deva` | 9.0 | 0.92 |
| nl | `multiblimp_nld` | 12.6 | 0.88 |
| pl | `multiblimp_pol` | 11.7 | 0.93 |
| pt | `multiblimp_por` | 33.5 | 0.87 |
| ro | `multiblimp_ron` | 18.1 | 0.88 |
| ru | `multiblimp_rus` | 61.0 | 0.86 |
| sk | `multiblimp_slk` | 4.0 | 0.90 |
| sl | `multiblimp_slv` | 8.2 | 0.85 |
| sv | `multiblimp_swe` | 73.1 | 0.87 |
| ta | `multiblimp_tam` | 11.4 | 0.86 |
| th | `xcopa_th` | 4.7 | 0.61 |
| tr | `multiblimp_tur` | 12.1 | 0.75 |
| uk | `multiblimp_ukr` | 12.6 | 0.90 |
| ur | `multiblimp_urd` | 5.8 | 0.78 |
| vi | `hellaswag_vi` | 8.8 | 0.79 |
| zh | `xstorycloze_zh` | 8.9 | 0.84 |
...
|---|---|---|---|---|
| `predictivity` | `quartile_deviation` | 1.00 | 1.00 | 3 |
| `predictivity_seeds` | `projection` | 1.00 | 1.00 | 3 |
...
|---|---|---|---|---|
| global_mmlu_full_per_language | `global_mmlu_full_he` | 1.7B | 0.32 → 2.43 | +2.12 |
| global_mmlu_full_per_language | `global_mmlu_full_fr` | 1B | 0.73 → 2.83 | +2.09 |
| global_mmlu_full_subjects | `global_mmlu_full` | 175M | 2.62 → 4.64 | +2.02 |
| global_mmlu_full_per_language | `global_mmlu_full_zh` | 1B | 1.01 → 3.01 | +1.99 |
| per_benchmark | `global_piqa_parallel_cloze` | 175M | 1.71 → 3.70 | +1.99 |
| global_mmlu_full_per_language | `global_mmlu_full_ja` | 175M | 1.78 → 3.74 | +1.97 |
| global_mmlu_full_per_language | `global_mmlu_full_zh` | 175M | 1.96 → 3.79 | +1.83 |
| global_mmlu_full_per_language | `global_mmlu_full_ky` | 1B | 1.14 → 2.91 | +1.78 |
...
|---|---|---|---|
| `xstorycloze` | 4.08 | 2 | completion |
| `multiblimp` | 2.78 | 2 | minimal_pair |
| `hellaswag` | 2.74 | 4 | completion |
| `xwinograd` | 2.05 | 2 | completion |
| `xcopa` | 1.55 | 2 | completion |
| `xnli` | 1.27 | 3 | classification |
| `paws` | 1.00 | 2 | classification |
...
|---|---|---|---|---|---|---|---|
| `loss` |  | 4.85 | 3.15 | 2.66 | 2.47 | 2.36 | 2.22 |
| `bpb` |  | 4.36 | 1.96 | 1.66 | 1.56 | 1.48 | 1.43 |
| `multiblimp` | 0.50 | **0.70** | **0.74** | **0.77** | **0.78** | **0.78** | **0.80** |
| `xwinograd` | 0.50 | 0.51 | 0.54 | **0.58** | **0.62** | **0.65** | **0.69** |
| `xcopa` | 0.50 |  | 0.53 | 0.53 | 0.54 | 0.55 | **0.56** |
| `xstorycloze` | 0.50 | 0.48 | 0.49 | 0.51 | 0.53 | 0.54 | **0.55** |
| `paws` | 0.50 | 0.50 | 0.49 | 0.50 | 0.51 | 0.52 | 0.54 |
| `global_piqa_nonparallel_cloze` | 0.50 |  | 0.47 | 0.47 | 0.47 | 0.46 | 0.46 |
| `xnli` | 0.33 | 0.33 | 0.35 | 0.38 | **0.39** | **0.40** | **0.41** |
| `hellaswag` | 0.25 | 0.26 | 0.26 | 0.27 | 0.28 | 0.29 | **0.31** |
| `include_base_44` | 0.25 | 0.27 | 0.25 | 0.25 | 0.25 | 0.26 | 0.25 |
| `global_mmlu_full` | 0.25 | 0.23 | 0.24 | 0.25 | 0.25 | 0.24 | 0.25 |
| `belebele` | 0.25 | 0.23 | 0.24 | 0.24 | 0.24 | 0.24 | 0.25 |
| `lambada_openai_mt` |  | 0.00 | 0.16 | 0.25 | 0.30 | 0.33 | 0.39 |
| `truthfulqa-multi_mc1` | 0.25 | 0.24 | 0.24 | 0.23 | 0.23 | 0.23 | 0.22 |
| `arc` | 0.25 | 0.23 | 0.20 | 0.21 | 0.22 | 0.23 | 0.25 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `arc_challenge` | 0.60 | 0.60 | 0.64 | **0.81** | **0.89** | **0.75** | **0.78** | **0.86** | **0.83** | **1.00** |
| `xstorycloze` | 0.59 | 0.57 | 0.71 | 0.69 | **0.75** | **0.75** | **0.89** | **0.82** | **0.86** | **0.80** |
| `hellaswag` | 0.64 | 0.51 | 0.46 | **0.78** | 0.72 | 0.68 | **0.81** | **0.75** | **0.92** | **0.80** |
| `bpb` | 0.65 | 0.44 | 0.58 | **0.81** | 0.68 | 0.56 | 0.71 | **0.75** | **0.90** | 0.67 |
| `xwinograd` | 0.70 | 0.58 | 0.43 | 0.58 | 0.62 | 0.64 | **0.75** | **0.82** | 0.56 | 0.70 |
| `arc_easy` | 0.56 | 0.44 | 0.61 | **0.81** | 0.72 | 0.57 | **0.78** | 0.54 | 0.58 | 0.60 |
| `lambada_openai_mt` | 0.62 | 0.67 | 0.73 | 0.67 | 0.47 | 0.33 | 0.46 | **0.75** | **0.75** | 0.70 |
| `xnli` | 0.59 | 0.59 | 0.50 | 0.64 | 0.66 | 0.71 | 0.61 | 0.43 | 0.72 | 0.70 |
| `global_piqa_parallel_cloze` | 0.47 | **0.82** | 0.67 | 0.40 | 0.53 | 0.62 | **0.79** | 0.43 | 0.50 | 0.50 |
| `global_mmlu_full` | 0.49 | 0.55 | 0.54 | 0.69 | 0.42 | 0.46 | 0.44 | 0.68 | 0.61 | 0.60 |
| `multiblimp` | 0.71 | 0.58 | 0.50 | 0.64 | 0.49 | 0.50 | 0.67 | 0.32 | 0.58 | 0.30 |
| `belebele` | 0.51 | 0.74 | 0.54 | 0.56 | 0.47 | 0.54 | 0.19 | 0.50 | 0.58 | 0.50 |
| `truthfulqa-multi_mc1` | 0.41 | 0.18 | 0.60 | 0.40 | 0.57 | 0.48 | 0.50 | 0.57 | 0.69 | 0.70 |
| `paws` | 0.59 | 0.45 | 0.60 | 0.47 | 0.43 | 0.43 | 0.57 | 0.43 | 0.19 | 0.30 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb_arz_Arab` | **0.79** | 0.73 | **0.75** | **0.76** | **0.92** | **1.00** | **0.95** | **0.97** | **0.95** | **1.00** |
| `bpb_ary_Arab` | **0.80** | **0.75** | **0.81** | **0.76** | **0.95** | **1.00** | **0.90** | **1.00** | **0.90** | **0.93** |
| `bpb_ars_Arab` | **0.80** | 0.72 | **0.78** | **0.76** | **0.90** | **0.97** | **0.95** | **0.94** | **0.95** | **1.00** |
| `bpb_arb_Arab` | **0.81** | **0.75** | **0.78** | **0.76** | **0.92** | **0.97** | **0.86** | **0.94** | **0.86** | **0.87** |
| `multiblimp` | **0.93** | 0.71 | **0.93** | 0.67 | 0.69 | **0.90** | **0.80** | **0.82** | 0.73 | **1.00** |
| `hellaswag` | 0.71 | 0.71 | 0.67 | **1.00** | 0.73 | **0.86** | **0.80** | **0.89** | 0.73 | 0.67 |
| `xstorycloze` | 0.71 | 0.73 | 0.67 | **0.83** | **0.82** | **0.86** | 0.70 | **0.79** | **0.80** | **0.83** |
| `global_piqa_parallel_cloze_arz_arab` | 0.69 | 0.51 | 0.40 | **0.83** | 0.60 | 0.43 | 0.70 | 0.64 | 0.73 | **1.00** |
| `global_piqa_parallel_cloze_apc_arab_syri` | 0.36 | 0.44 | 0.40 | 0.50 | 0.44 | **0.95** | **0.90** | 0.43 | 0.47 | 0.67 |
| `global_piqa_parallel_cloze_apc_arab_leba` | 0.53 | 0.56 | 0.27 | 0.67 | 0.35 | **0.76** | 0.70 | 0.61 | 0.40 | 0.67 |
| `global_piqa_parallel_cloze_apc_arab_jord` | 0.53 | 0.64 | 0.40 | 0.33 | 0.47 | 0.67 | 0.70 | 0.57 | 0.20 | **0.83** |
| `global_piqa_parallel_cloze_apc_arab_pale` | 0.31 | 0.58 | 0.07 | 0.67 | 0.55 | **0.86** | 0.50 | 0.57 | 0.73 | 0.50 |
| `global_piqa_parallel_cloze_ary_arab` | 0.71 | 0.49 | 0.60 | 0.67 | 0.53 | 0.38 | 0.60 | 0.54 | 0.60 | 0.17 |
| `belebele_apc_Arab` | 0.60 | 0.47 | 0.47 | **0.83** | 0.38 | 0.71 | 0.60 | 0.39 | 0.47 | 0.33 |
| `global_piqa_parallel_cloze_arb_arab` | 0.47 | 0.56 | 0.53 | 0.67 | 0.40 | 0.62 | 0.30 | 0.21 | 0.33 | **0.83** |
| `belebele_ary_Arab` | 0.38 | 0.47 | 0.67 | 0.50 | 0.71 | 0.24 | 0.60 | 0.21 | 0.67 | 0.33 |
| `xnli` | 0.42 | 0.58 | **0.80** | 0.67 | 0.62 | 0.29 | 0.20 | 0.29 | 0.33 | 0.50 |
| `belebele_arb_Latn` | 0.67 | 0.44 | 0.40 | 0.67 | 0.40 | 0.33 | 0.30 | 0.39 | 0.40 | 0.67 |
| `include_base_44` | 0.40 | 0.38 | 0.53 | 0.00 | 0.42 | 0.62 | **0.80** | 0.32 | 0.60 | 0.50 |
| `belebele_arb_Arab` | 0.36 | 0.53 | 0.27 | 0.17 | 0.53 | 0.29 | 0.40 | 0.39 | 0.73 | **0.83** |
| `belebele_ars_Arab` | 0.53 | 0.53 | 0.40 | 0.00 | 0.35 | 0.38 | 0.50 | 0.57 | 0.73 | 0.33 |
| `global_piqa_parallel_cloze_ars_arab` | 0.33 | 0.49 | 0.20 | 0.17 | 0.27 | 0.57 | 0.50 | 0.64 | 0.40 | 0.67 |
| `arc` | 0.69 | 0.71 | 0.27 | 0.00 | 0.67 | 0.38 | 0.10 | 0.29 | 0.47 | 0.67 |
| `global_mmlu_full` | 0.49 | 0.53 | 0.60 | 0.17 | 0.36 | 0.43 | 0.10 | 0.61 | 0.40 | 0.50 |
| `belebele_arz_Arab` | 0.33 | 0.53 | 0.40 | 0.33 | 0.29 | 0.24 | **0.80** | 0.50 | 0.33 | 0.17 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.80** | **0.78** | **0.94** | **0.86** | **0.92** | **0.92** | **0.81** | **0.97** | **0.90** | **0.80** |
| `include_base_44` | 0.25 | 0.36 | **0.80** | **1.00** | 0.64 | 0.43 | 0.33 | 0.32 | 0.00 | 0.67 |
| `global_piqa_parallel_cloze` | **0.75** | 0.54 | 0.33 | 0.00 | 0.44 | 0.33 | 0.00 | 0.46 | 0.33 | **1.00** |
| `belebele` | 0.61 | 0.43 | 0.40 | 0.00 | 0.47 | 0.43 | 0.67 | 0.54 | 0.17 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.93** | **0.87** | **0.89** | **1.00** | **0.93** | **0.94** | **1.00** | **0.94** | **0.95** | **1.00** |
| `multiblimp` | **0.78** | **0.78** | **0.87** | **1.00** | **0.87** | **0.86** | **1.00** | **0.89** | **1.00** | **1.00** |
| `xnli` | 0.72 | 0.69 | **0.80** | 0.67 | **0.78** | 0.57 | **1.00** | **0.79** | **0.90** | **1.00** |
| `global_piqa_parallel_cloze` | 0.39 | 0.56 | 0.67 | 0.33 | 0.71 | 0.71 | 0.67 | **0.82** | 0.70 | 0.67 |
| `belebele` | 0.50 | 0.64 | 0.67 | 0.67 | 0.44 | 0.67 | 0.17 | 0.46 | 0.40 | **1.00** |
| `include_base_44` | 0.42 | 0.64 | 0.20 | 0.67 | 0.51 | 0.71 | **0.83** | 0.46 | 0.40 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.88** | **0.77** | **0.83** | **0.86** | **0.86** | **0.92** | **0.86** | **0.94** | **0.86** | **1.00** |
| `multiblimp` | **0.81** | **0.78** | **0.80** | **0.83** | **0.78** | **0.81** | **0.80** | **0.86** | **0.80** | **1.00** |
| `hellaswag` | 0.64 | 0.61 | **0.80** | **1.00** | **0.76** | 0.71 | 0.70 | **0.79** | 0.73 | **1.00** |
| `global_piqa_parallel_cloze_ben_latn` | 0.64 | **0.81** | **0.80** | 0.33 | 0.71 | 0.71 | 0.40 | 0.68 | 0.20 | 0.50 |
| `belebele_ben_Beng` | 0.42 | 0.61 | 0.33 | 0.67 | 0.56 | 0.29 | 0.50 | 0.50 | 0.60 | **0.83** |
| `arc` | 0.47 | 0.22 | 0.60 | **0.83** | 0.42 | 0.43 | 0.60 | 0.21 | 0.13 | **0.83** |
| `global_piqa_parallel_cloze_ben_beng` | 0.31 | 0.22 | 0.53 | 0.50 | **0.76** | 0.43 | 0.40 | 0.46 | 0.47 | 0.67 |
| `global_mmlu_full` | 0.44 | 0.28 | 0.67 | **0.83** | 0.42 | 0.52 | 0.30 | 0.50 | 0.40 | 0.33 |
| `include_base_44` | 0.44 | **0.83** | 0.67 | 0.33 | 0.51 | 0.52 | 0.10 | 0.43 | 0.27 | 0.50 |
| `belebele_ben_Latn` | 0.28 | 0.44 | 0.27 | 0.33 | 0.49 | 0.71 | 0.60 | 0.36 | 0.20 | **0.83** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.74 | 0.70 | **0.83** | 0.67 | **0.91** | **0.89** | 0.71 | **0.97** | **0.86** | **0.93** |
| `global_piqa_nonparallel_cloze` | 0.43 | 0.68 | 0.27 | **1.00** | 0.58 | **0.90** | 0.00 | 0.61 | 0.67 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | **0.80** | **0.89** | **0.95** | **0.90** | **0.94** | **0.86** | **0.89** | **0.95** | **0.93** |
| `hellaswag` | **0.89** | **0.75** | 0.73 | **1.00** | **0.89** | **0.86** | **1.00** | **0.82** | **0.83** | **1.00** |
| `multiblimp` | **0.89** | **0.75** | **0.80** | 0.00 | **0.86** | **0.95** | 0.67 | **0.82** | **1.00** | 0.67 |
| `xstorycloze` | **0.89** | 0.64 | 0.67 | 0.00 | 0.67 | 0.62 | 0.67 | **0.96** | **0.83** | 0.67 |
| `xnli` | **0.75** | 0.54 | 0.60 | **1.00** | 0.69 | **0.86** | 0.67 | 0.71 | 0.33 | 0.33 |
| `paws` | 0.61 | 0.46 | 0.67 | 0.00 | 0.67 | 0.67 | 0.67 | 0.61 | **0.83** | **1.00** |
| `global_piqa_parallel_cloze` | 0.54 | 0.61 | 0.67 | **1.00** | 0.69 | 0.48 | 0.67 | 0.50 | **1.00** | 0.00 |
| `arc` | 0.36 | **0.75** | **0.80** | 0.00 | 0.25 | 0.43 | **1.00** | 0.71 | 0.50 | **1.00** |
| `belebele` | 0.54 | 0.57 | 0.40 | **1.00** | 0.61 | 0.52 | 0.00 | 0.36 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.75** | 0.71 | **0.83** | **0.81** | **0.94** | **0.94** | **0.95** | **0.97** | **1.00** | **0.93** |
| `multiblimp` | **0.86** | 0.72 | **0.93** | 0.67 | **0.84** | **0.81** | **0.80** | 0.71 | **0.87** | **1.00** |
| `global_piqa_parallel_cloze` | 0.58 | 0.67 | 0.67 | 0.50 | 0.67 | 0.43 | **0.80** | 0.64 | 0.47 | 0.33 |
| `global_mmlu_full` | 0.61 | 0.53 | 0.47 | 0.33 | 0.36 | 0.43 | 0.60 | 0.36 | 0.67 | 0.17 |
| `belebele` | **0.75** | 0.58 | 0.07 | 0.00 | 0.56 | 0.38 | 0.50 | 0.43 | **0.80** | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | **0.76** | **0.81** | **0.76** | **0.89** | **0.86** | **0.76** | **0.81** | **0.86** | **1.00** |
| `hellaswag` | **0.75** | **0.89** | **0.93** | **1.00** | **0.82** | 0.62 | **1.00** | **0.79** | **0.80** | 0.67 |
| `multiblimp` | **0.83** | **0.89** | **0.93** | 0.67 | **0.76** | 0.67 | **0.83** | **0.93** | 0.60 | 0.67 |
| `arc` | 0.39 | 0.14 | 0.20 | 0.33 | 0.71 | 0.57 | **0.83** | **0.75** | **0.80** | 0.67 |
| `belebele` | 0.47 | 0.47 | 0.53 | 0.67 | 0.42 | 0.62 | 0.67 | 0.43 | 0.10 | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.79** | 0.74 | **0.83** | **0.90** | **0.95** | **0.97** | **1.00** | **0.94** | **1.00** | **0.93** |
| `hellaswag` | 0.64 | 0.56 | 0.67 | **0.80** | **0.82** | 0.71 | **1.00** | **0.89** | **0.95** | **0.90** |
| `lambada_openai_mt` | 0.62 | 0.60 | 0.73 | 0.70 | 0.62 | 0.71 | **0.87** | **0.79** | 0.71 | **0.90** |
| `xnli` | 0.53 | 0.67 | 0.53 | 0.70 | 0.55 | 0.52 | 0.60 | **0.86** | **0.86** | **0.90** |
| `multiblimp` | 0.60 | 0.67 | 0.60 | 0.50 | 0.64 | 0.67 | 0.67 | **0.79** | 0.67 | **0.90** |
| `global_piqa_parallel_cloze` | 0.38 | 0.44 | 0.53 | 0.60 | 0.74 | 0.67 | 0.73 | 0.68 | 0.71 | 0.70 |
| `paws` | 0.31 | 0.69 | 0.47 | 0.40 | 0.55 | 0.71 | **0.80** | 0.39 | 0.62 | **1.00** |
| `arc` | 0.38 | 0.64 | 0.20 | 0.60 | 0.59 | 0.52 | 0.53 | 0.71 | **0.86** | **0.90** |
| `include_base_44` | 0.22 | 0.69 | 0.60 | **0.90** | 0.42 | 0.29 | 0.33 | 0.32 | **0.81** | 0.60 |
| `belebele` | 0.38 | 0.31 | 0.40 | **0.80** | 0.61 | 0.38 | 0.27 | 0.57 | 0.38 | **0.80** |
| `global_mmlu_full` | 0.29 | 0.45 | 0.53 | 0.60 | 0.38 | 0.43 | 0.53 | 0.39 | 0.67 | 0.30 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | **0.82** | **0.92** | **0.86** | **0.91** | **0.94** | **0.90** | **0.97** | **0.86** | **0.87** |
| `multiblimp` | **0.75** | **0.75** | 0.40 | 0.70 | **0.76** | 0.67 | **0.87** | **0.75** | **0.90** | **0.90** |
| `xnli` | **0.81** | 0.50 | **0.80** | **0.90** | 0.53 | **0.81** | **0.87** | 0.68 | 0.67 | **0.80** |
| `belebele` | 0.31 | 0.69 | 0.60 | **0.80** | 0.40 | 0.57 | 0.67 | **0.82** | 0.71 | **0.80** |
| `global_piqa_parallel_cloze` | 0.47 | 0.56 | **0.80** | 0.40 | 0.36 | 0.52 | 0.20 | **0.75** | 0.71 | 0.50 |
| `include_base_44` | 0.39 | 0.33 | **0.87** | 0.40 | 0.53 | 0.43 | 0.47 | 0.46 | 0.33 | 0.50 |
| `global_mmlu_full` | **0.78** | 0.39 | 0.67 | 0.20 | 0.42 | 0.43 | 0.47 | 0.25 | 0.57 | 0.30 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.82** | **0.77** | **0.94** | **0.81** | **0.91** | **0.92** | **0.86** | **0.89** | **0.86** | **0.87** |
| `hellaswag` | 0.75 | 0.73 | **0.93** | **0.83** | **0.92** | **0.95** | **1.00** | **0.86** | **0.93** | 0.67 |
| `multiblimp` | 0.65 | 0.69 | **0.80** | **0.83** | 0.58 | **0.86** | **1.00** | **0.89** | 0.73 | **0.83** |
| `xstorycloze` | 0.53 | 0.56 | **0.87** | 0.33 | **0.80** | 0.71 | **0.80** | **0.79** | **0.93** | **1.00** |
| `lambada_openai_mt` | 0.55 | 0.67 | 0.73 | 0.50 | 0.61 | **0.90** | 0.50 | **0.79** | **0.87** | **1.00** |
| `xnli` | 0.60 | 0.58 | 0.67 | **0.83** | 0.67 | 0.71 | 0.70 | **0.82** | 0.73 | 0.67 |
| `arc` | 0.49 | 0.40 | **0.87** | 0.33 | **0.76** | **0.76** | 0.60 | **0.75** | **0.80** | **0.83** |
| `belebele` | 0.53 | 0.58 | 0.53 | **0.83** | 0.44 | 0.43 | **0.90** | 0.57 | 0.53 | **1.00** |
| `paws` | 0.56 | 0.65 | 0.53 | 0.33 | 0.70 | **0.76** | 0.60 | 0.64 | 0.47 | 0.67 |
| `include_base_44` | 0.31 | 0.51 | **0.87** | **0.83** | 0.50 | 0.33 | 0.50 | 0.57 | 0.67 | 0.67 |
| `truthfulqa-multi_mc1` | 0.44 | 0.44 | 0.40 | 0.50 | 0.61 | 0.57 | 0.50 | 0.61 | **0.80** | **0.83** |
| `global_piqa_parallel_cloze_spa_latn_spai` | 0.62 | 0.27 | 0.73 | 0.50 | 0.55 | 0.52 | 0.70 | 0.32 | 0.67 | 0.67 |
| `global_piqa_parallel_cloze_spa_latn_mexi` | 0.47 | 0.47 | 0.53 | 0.33 | 0.45 | 0.57 | 0.60 | 0.43 | **0.80** | 0.67 |
| `global_mmlu_full` | 0.40 | 0.62 | 0.33 | 0.50 | 0.55 | 0.52 | 0.40 | 0.57 | 0.53 | 0.50 |
| `global_piqa_parallel_cloze_spa_latn_peru` | 0.58 | 0.56 | 0.47 | 0.67 | 0.67 | 0.24 | 0.40 | 0.11 | 0.73 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.70 | 0.66 | 0.67 | 0.57 | **0.95** | **0.94** | **0.76** | **0.92** | **0.76** | **0.93** |
| `multiblimp` | **0.79** | 0.61 | 0.47 | **1.00** | 0.67 | **0.81** | 0.33 | 0.71 | 0.33 | 0.67 |
| `global_piqa_parallel_cloze` | 0.54 | 0.68 | 0.53 | 0.00 | 0.42 | **0.81** | 0.67 | 0.68 | 0.67 | **1.00** |
| `xcopa` | **0.93** | **0.75** | 0.53 | 0.00 | 0.69 | 0.52 | 0.67 | 0.57 | **0.83** | 0.00 |
| `include_base_44` | 0.32 | 0.71 | **0.87** | 0.00 | 0.61 | 0.57 | 0.33 | 0.64 | 0.17 | **1.00** |
| `belebele` | 0.32 | **0.79** | 0.73 | **1.00** | 0.33 | 0.24 | 0.67 | 0.57 | 0.50 | 0.00 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | **0.82** | **0.89** | **0.81** | **0.92** | **0.94** | **0.90** | **0.92** | **0.90** | **0.93** |
| `multiblimp` | **0.84** | 0.69 | **0.80** | **0.80** | **0.84** | 0.71 | **0.87** | **0.75** | **1.00** | **0.90** |
| `global_piqa_parallel_cloze` | 0.53 | 0.31 | 0.40 | **0.80** | 0.62 | 0.71 | 0.67 | **0.82** | 0.57 | 0.40 |
| `include_base_44` | 0.49 | 0.60 | 0.67 | 0.40 | 0.44 | 0.43 | 0.33 | 0.68 | **0.76** | **0.90** |
| `global_mmlu_full` | 0.62 | 0.40 | **1.00** | 0.20 | 0.35 | 0.52 | 0.47 | 0.54 | 0.57 | 0.40 |
| `belebele` | 0.33 | 0.56 | 0.53 | 0.50 | 0.33 | 0.33 | 0.27 | 0.64 | 0.67 | 0.40 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `multiblimp` | **0.75** | **0.83** | 0.73 | **1.00** | **0.76** | **0.86** | **1.00** | **0.82** | **0.80** | 0.67 |
| `bpb` | **0.82** | **0.76** | **0.75** | **0.76** | **0.89** | **0.86** | **0.76** | **0.89** | **0.86** | **0.87** |
| `global_piqa_parallel_cloze` | **0.75** | 0.50 | 0.47 | 0.67 | 0.51 | 0.57 | 0.50 | 0.50 | 0.60 | 0.33 |
| `include_base_44` | **0.83** | 0.33 | 0.53 | 0.67 | 0.38 | 0.52 | 0.50 | 0.32 | 0.30 | 0.33 |
| `belebele` | 0.44 | 0.47 | 0.33 | 0.33 | 0.44 | 0.57 | 0.67 | 0.54 | 0.10 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | **0.77** | **0.92** | **0.86** | **0.91** | **0.86** | **0.90** | **0.86** | **0.95** | **0.93** |
| `hellaswag` | **0.76** | **0.76** | **0.80** | 0.67 | **0.92** | **0.86** | **0.90** | **0.79** | **1.00** | **1.00** |
| `lambada_openai_mt` | **0.78** | **0.82** | **0.87** | **0.83** | 0.73 | **0.86** | 0.70 | **0.89** | **0.87** | 0.67 |
| `arc` | 0.75 | 0.69 | **0.80** | 0.50 | 0.67 | **1.00** | **0.90** | 0.64 | 0.67 | **0.83** |
| `global_piqa_parallel_cloze_fra_latn_cana` | 0.65 | 0.73 | 0.67 | 0.50 | **0.88** | **0.86** | 0.70 | **0.86** | **0.87** | 0.67 |
| `xnli` | 0.60 | 0.62 | **0.80** | 0.50 | 0.70 | **0.76** | **0.80** | **0.89** | 0.73 | 0.67 |
| `multiblimp` | 0.71 | 0.67 | 0.73 | 0.17 | 0.67 | **0.76** | 0.70 | **0.82** | **0.87** | **0.83** |
| `xwinograd` | 0.49 | 0.64 | 0.33 | 0.67 | 0.70 | **0.76** | 0.70 | 0.71 | 0.73 | 0.67 |
| `global_piqa_parallel_cloze_fra_latn_fran` | 0.53 | 0.47 | 0.60 | 0.67 | 0.68 | 0.57 | 0.70 | 0.21 | 0.67 | 0.50 |
| `include_base_44` | 0.53 | 0.45 | 0.73 | 0.33 | 0.48 | 0.48 | 0.50 | 0.46 | **0.87** | 0.67 |
| `belebele` | 0.51 | 0.60 | 0.33 | 0.67 | 0.41 | 0.43 | 0.50 | 0.43 | 0.40 | 0.50 |
| `paws` | 0.38 | 0.36 | 0.53 | 0.67 | 0.45 | 0.43 | 0.50 | 0.46 | 0.40 | 0.33 |
| `global_mmlu_full` | 0.27 | 0.40 | 0.27 | 0.67 | 0.48 | 0.57 | 0.40 | 0.50 | 0.40 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | 0.70 | **0.81** | **0.86** | **0.81** | **0.78** | **0.76** | **0.86** | **0.81** | **0.80** |
| `multiblimp` | **0.93** | **0.75** | 0.73 | **1.00** | 0.69 | 0.71 | **0.83** | **0.82** | 0.60 | 0.67 |
| `belebele` | 0.46 | 0.71 | 0.53 | 0.33 | 0.69 | 0.57 | 0.67 | 0.54 | 0.50 | 0.67 |
| `global_mmlu_full` | 0.57 | 0.57 | 0.67 | 0.67 | 0.36 | 0.62 | **0.83** | 0.54 | 0.30 | 0.50 |
| `include_base_44` | 0.46 | 0.64 | 0.13 | **1.00** | 0.47 | 0.43 | 0.67 | 0.32 | 0.30 | 0.50 |
| `global_piqa_parallel_cloze` | 0.39 | 0.43 | 0.40 | 0.67 | 0.42 | 0.43 | 0.33 | 0.54 | 0.70 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.85** | **0.75** | **0.86** | **0.81** | **0.83** | **0.86** | **0.86** | **0.89** | **0.95** | **1.00** |
| `xstorycloze` | 0.72 | **0.78** | **0.87** | **0.83** | 0.71 | **0.76** | **0.90** | **0.75** | **0.80** | **0.83** |
| `multiblimp` | 0.72 | **0.81** | **0.93** | 0.67 | **0.78** | 0.71 | **0.80** | **0.79** | 0.73 | **1.00** |
| `hellaswag` | 0.56 | 0.58 | 0.67 | **0.83** | **0.78** | **0.86** | 0.70 | **0.82** | **0.87** | **0.83** |
| `xnli` | 0.50 | 0.61 | 0.40 | **0.83** | **0.82** | **0.90** | **0.80** | **0.82** | 0.73 | **0.83** |
| `global_piqa_parallel_cloze` | 0.58 | 0.72 | **0.80** | 0.67 | **0.80** | 0.48 | 0.40 | 0.64 | 0.60 | **0.83** |
| `belebele_hin_Latn` | 0.50 | 0.58 | 0.53 | 0.67 | 0.73 | **0.81** | 0.30 | 0.68 | 0.40 | **1.00** |
| `arc` | 0.67 | 0.58 | 0.73 | 0.67 | 0.27 | 0.43 | 0.50 | 0.61 | 0.60 | 0.33 |
| `belebele_hin_Deva` | 0.42 | 0.42 | 0.53 | **0.83** | 0.51 | 0.38 | **0.80** | 0.32 | 0.60 | 0.50 |
| `include_base_44` | 0.25 | 0.64 | 0.40 | 0.50 | 0.51 | 0.67 | 0.40 | 0.68 | **0.80** | 0.33 |
| `global_mmlu_full` | 0.67 | 0.33 | 0.53 | 0.33 | 0.27 | 0.48 | 0.50 | 0.71 | 0.47 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.77** | 0.71 | **0.86** | 0.67 | **0.92** | **0.92** | 0.71 | **0.94** | **0.81** | **0.87** |
| `hellaswag` | 0.64 | **0.86** | **0.87** | **1.00** | **0.83** | 0.71 | 0.67 | **0.75** | 0.67 | **1.00** |
| `arc` | 0.71 | 0.64 | 0.47 | **1.00** | **0.75** | 0.67 | **1.00** | 0.71 | 0.33 | 0.67 |
| `belebele` | 0.50 | 0.64 | 0.40 | 0.00 | 0.58 | 0.52 | 0.33 | 0.64 | 0.50 | **1.00** |
| `global_piqa_parallel_cloze` | 0.32 | 0.64 | 0.67 | 0.00 | 0.53 | 0.57 | 0.67 | 0.68 | 0.50 | 0.33 |
| `include_base_44` | 0.50 | 0.29 | 0.33 | 0.00 | 0.44 | 0.14 | 0.67 | 0.43 | 0.33 | 0.00 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | **0.75** | **0.97** | 0.71 | **0.87** | **0.86** | **0.76** | **0.83** | **0.81** | 0.73 |
| `multiblimp` | 0.72 | 0.72 | **0.87** | **0.83** | **0.78** | **0.76** | 0.60 | 0.71 | **0.87** | **1.00** |
| `hellaswag` | **0.83** | 0.72 | 0.60 | 0.67 | **0.76** | **0.81** | **0.90** | **0.93** | **0.80** | 0.67 |
| `global_piqa_parallel_cloze` | 0.58 | 0.33 | 0.67 | 0.33 | 0.69 | 0.67 | 0.70 | 0.57 | 0.67 | 0.67 |
| `arc` | 0.39 | 0.50 | 0.47 | 0.67 | 0.33 | 0.29 | 0.50 | **0.79** | 0.67 | **0.83** |
| `include_base_44` | 0.36 | 0.33 | 0.60 | 0.17 | 0.53 | 0.52 | 0.60 | 0.29 | 0.47 | **0.83** |
| `belebele` | 0.31 | 0.56 | 0.73 | 0.33 | 0.27 | 0.57 | 0.50 | 0.36 | 0.47 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.87** | **0.80** | **0.89** | **0.90** | **0.90** | **0.94** | **0.95** | **0.94** | **1.00** | **1.00** |
| `hellaswag` | **0.84** | 0.73 | **0.87** | **0.83** | **0.85** | **0.90** | **0.90** | **0.89** | **0.93** | **0.83** |
| `xcopa` | **0.82** | **0.76** | **0.87** | 0.67 | 0.67 | **0.95** | 0.70 | **0.82** | 0.73 | 0.67 |
| `xstorycloze` | 0.69 | 0.73 | **0.93** | 0.50 | **0.82** | 0.67 | **0.80** | 0.64 | **0.87** | **0.83** |
| `arc` | 0.58 | 0.53 | 0.60 | 0.50 | 0.75 | **0.76** | **0.90** | 0.61 | **0.93** | 0.67 |
| `belebele` | 0.49 | 0.51 | 0.67 | **0.83** | 0.44 | 0.29 | **0.80** | **0.75** | 0.60 | 0.33 |
| `include_base_44` | 0.44 | 0.60 | 0.47 | **0.83** | 0.40 | 0.29 | 0.20 | **0.79** | 0.67 | **0.83** |
| `global_piqa_parallel_cloze` | 0.58 | 0.49 | 0.60 | 0.50 | 0.64 | 0.71 | 0.20 | 0.71 | 0.27 | 0.50 |
| `global_mmlu_full` | 0.49 | 0.47 | 0.47 | 0.33 | 0.44 | 0.43 | 0.50 | **0.79** | 0.73 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | **0.80** | **0.94** | **0.81** | **0.90** | **0.92** | **0.81** | **0.89** | **0.86** | **0.87** |
| `hellaswag` | **0.76** | 0.73 | 0.73 | 0.67 | **0.85** | **0.95** | **0.80** | **0.93** | **0.87** | **0.83** |
| `lambada_openai_mt` | **0.80** | **0.82** | **0.80** | 0.67 | **0.77** | **0.81** | **0.90** | **0.89** | **0.80** | **0.83** |
| `multiblimp` | 0.65 | 0.58 | 0.73 | 0.50 | **0.83** | **0.90** | **1.00** | **0.79** | **0.87** | **0.83** |
| `xcopa` | 0.44 | 0.56 | 0.47 | 0.50 | 0.65 | **0.76** | **1.00** | **0.75** | 0.60 | **1.00** |
| `global_piqa_parallel_cloze` | 0.67 | 0.51 | 0.53 | 0.50 | 0.47 | 0.48 | 0.50 | 0.71 | **0.80** | **1.00** |
| `include_base_44` | 0.47 | 0.35 | 0.60 | 0.33 | 0.45 | 0.62 | 0.60 | 0.46 | 0.60 | **0.83** |
| `global_mmlu_full` | 0.44 | 0.55 | 0.47 | 0.50 | 0.38 | 0.67 | 0.30 | 0.50 | 0.60 | 0.50 |
| `arc` | 0.51 | 0.42 | 0.07 | 0.17 | 0.56 | 0.38 | 0.30 | **0.79** | **0.87** | **0.83** |
| `belebele` | 0.65 | 0.45 | 0.40 | **0.83** | 0.47 | 0.43 | 0.30 | 0.46 | 0.13 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.79** | **0.75** | **0.86** | **0.90** | **0.94** | **0.92** | **0.90** | **0.89** | **0.95** | **0.87** |
| `xwinograd` | 0.58 | 0.56 | 0.33 | 0.60 | 0.47 | 0.62 | 0.73 | **0.89** | **0.76** | 0.70 |
| `paws` | 0.51 | 0.67 | 0.60 | **0.80** | 0.47 | 0.62 | 0.47 | 0.61 | 0.67 | 0.70 |
| `include_base_44` | 0.47 | 0.45 | 0.47 | **0.90** | 0.61 | **0.81** | 0.53 | 0.64 | 0.48 | 0.50 |
| `global_mmlu_full` | 0.47 | 0.47 | 0.60 | **0.80** | 0.45 | 0.38 | 0.53 | 0.61 | 0.52 | 0.10 |
| `global_piqa_parallel_cloze` | 0.45 | 0.40 | 0.60 | 0.20 | **0.76** | 0.24 | 0.27 | 0.64 | 0.57 | 0.60 |
| `belebele` | 0.40 | 0.56 | 0.67 | 0.60 | 0.36 | 0.43 | 0.40 | 0.29 | 0.67 | 0.30 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.79** | **0.81** | **0.83** | **0.81** | **0.96** | **0.89** | **0.90** | **0.92** | **0.90** | **1.00** |
| `multiblimp` | 0.71 | 0.68 | **0.80** | **1.00** | 0.72 | **0.81** | **0.83** | 0.68 | 0.50 | **1.00** |
| `include_base_44` | 0.71 | 0.29 | **0.80** | 0.67 | 0.44 | **0.86** | 0.67 | 0.54 | 0.50 | **0.83** |
| `belebele` | 0.71 | 0.57 | 0.47 | 0.67 | 0.47 | 0.43 | 0.67 | 0.29 | 0.30 | 0.50 |
| `global_piqa_parallel_cloze` | **0.75** | 0.54 | 0.33 | 0.67 | 0.33 | 0.52 | 0.50 | 0.32 | 0.20 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.81** | **0.77** | **0.78** | **0.81** | **0.96** | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
| `global_piqa_nonparallel_cloze` | 0.54 | 0.46 | 0.73 | **1.00** | **0.81** | **0.76** | 0.67 | 0.64 | 0.33 | 0.00 |
| `multiblimp` | **0.79** | **0.79** | 0.60 | 0.00 | **0.92** | 0.67 | 0.33 | **0.75** | 0.33 | 0.67 |
| `belebele` | 0.64 | 0.71 | 0.53 | 0.00 | 0.50 | 0.57 | 0.67 | 0.39 | 0.67 | **1.00** |
| `include_base_44` | 0.54 | 0.36 | 0.07 | **1.00** | 0.67 | **0.76** | 0.33 | 0.68 | 0.50 | 0.00 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | 0.72 | **0.83** | 0.71 | **0.90** | **0.97** | **0.90** | **1.00** | **1.00** | **1.00** |
| `global_piqa_parallel_cloze` | **0.78** | 0.61 | **0.87** | **0.83** | 0.58 | 0.67 | **0.80** | 0.64 | 0.73 | **0.83** |
| `paws` | 0.72 | 0.67 | 0.53 | 0.50 | 0.58 | 0.57 | 0.70 | 0.46 | 0.73 | 0.50 |
| `include_base_44` | 0.44 | **0.83** | 0.73 | 0.67 | 0.31 | 0.71 | **0.80** | 0.61 | 0.47 | 0.00 |
| `global_mmlu_full` | 0.61 | 0.33 | 0.73 | 0.50 | 0.40 | 0.48 | 0.50 | 0.57 | 0.40 | 0.50 |
| `belebele` | 0.28 | 0.42 | 0.60 | 0.33 | 0.69 | 0.43 | 0.60 | 0.43 | 0.60 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.69 | 0.64 | **0.81** | 0.43 | **0.88** | **0.83** | 0.57 | **0.86** | 0.57 | 0.67 |
| `multiblimp` | **0.82** | **0.79** | 0.53 | **1.00** | 0.67 | 0.52 | 0.33 | 0.57 | 0.67 | 0.33 |
| `global_piqa_parallel_cloze` | 0.43 | 0.54 | 0.47 | **1.00** | 0.58 | 0.24 | 0.67 | 0.46 | **0.83** | **1.00** |
| `belebele` | **0.79** | 0.39 | 0.53 | 0.00 | 0.36 | 0.43 | 0.67 | 0.46 | 0.33 | 0.67 |
| `global_mmlu_full` | 0.39 | 0.50 | 0.33 | 0.00 | 0.50 | 0.33 | **1.00** | 0.32 | **1.00** | 0.00 |
| `include_base_44` | 0.57 | 0.61 | 0.47 | 0.00 | 0.67 | 0.24 | 0.33 | 0.39 | 0.17 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.56 | 0.69 | 0.67 | **0.88** | **0.75** | 0.62 | **0.78** | 0.67 | **1.00** |
| `belebele` | 0.46 | 0.68 | 0.60 | 0.00 | 0.53 | 0.38 | **1.00** | 0.50 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.86** | 0.69 | **0.89** | **0.81** | **0.79** | **0.86** | 0.71 | **0.92** | **0.81** | **0.87** |
| `hellaswag` | **0.89** | 0.71 | **0.80** | 0.67 | 0.67 | 0.71 | 0.50 | **0.79** | 0.40 | 0.50 |
| `arc` | 0.64 | 0.50 | 0.47 | 0.00 | 0.72 | **0.81** | 0.67 | **0.79** | **0.80** | 0.33 |
| `include_base_44` | 0.68 | 0.71 | 0.60 | 0.67 | 0.44 | 0.43 | 0.50 | 0.64 | 0.60 | 0.33 |
| `belebele` | **0.82** | 0.54 | 0.60 | 0.33 | 0.39 | 0.62 | **0.83** | 0.61 | 0.50 | 0.33 |
| `global_piqa_parallel_cloze` | 0.64 | 0.57 | 0.27 | 0.33 | 0.64 | 0.38 | 0.00 | 0.61 | **0.80** | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.82** | 0.73 | **0.86** | **0.86** | **0.86** | **0.92** | 0.67 | **0.94** | 0.71 | 0.73 |
| `hellaswag` | 0.54 | 0.68 | 0.73 | **1.00** | **0.78** | 0.67 | **1.00** | **0.75** | **1.00** | 0.67 |
| `global_piqa_parallel_cloze` | 0.57 | **0.86** | 0.53 | **1.00** | 0.58 | **0.76** | **1.00** | 0.61 | 0.17 | 0.67 |
| `multiblimp` | 0.32 | 0.46 | 0.73 | **1.00** | 0.47 | 0.57 | **1.00** | 0.54 | 0.00 | 0.67 |
| `arc` | 0.46 | 0.46 | 0.53 | **1.00** | 0.64 | 0.57 | 0.33 | **0.79** | 0.33 | 0.33 |
| `belebele` | 0.68 | 0.46 | 0.33 | 0.00 | 0.58 | 0.33 | 0.67 | 0.43 | 0.50 | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | **0.86** | **0.92** | **0.90** | **0.92** | **0.97** | **0.95** | **0.94** | **1.00** | **0.93** |
| `include_base_44` | 0.64 | 0.29 | 0.67 | **1.00** | 0.61 | 0.67 | 0.67 | 0.61 | 0.33 | 0.33 |
| `global_mmlu_full` | 0.71 | 0.46 | 0.40 | **1.00** | 0.22 | 0.43 | 0.67 | 0.64 | 0.33 | 0.67 |
| `global_piqa_parallel_cloze` | 0.71 | 0.18 | 0.67 | **1.00** | 0.31 | 0.29 | 0.33 | 0.57 | 0.33 | **1.00** |
| `belebele` | 0.18 | 0.46 | **0.80** | **1.00** | 0.31 | 0.19 | 0.67 | **0.75** | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.87** | **0.76** | **0.83** | **0.86** | **0.80** | **0.83** | 0.67 | **0.89** | **0.81** | **0.87** |
| `hellaswag` | 0.54 | 0.71 | 0.53 | **1.00** | 0.72 | **0.86** | 0.67 | 0.68 | 0.50 | 0.33 |
| `arc` | 0.36 | 0.64 | 0.40 | **1.00** | 0.69 | 0.67 | 0.00 | **0.82** | **0.83** | **1.00** |
| `belebele_npi_Latn` | **0.75** | 0.54 | 0.53 | 0.00 | 0.56 | 0.62 | **1.00** | 0.57 | 0.17 | 0.67 |
| `global_piqa_parallel_cloze` | 0.68 | 0.71 | 0.60 | 0.00 | 0.67 | 0.62 | 0.00 | 0.54 | 0.33 | **1.00** |
| `include_base_44` | 0.61 | 0.46 | 0.53 | 0.00 | 0.61 | 0.67 | 0.67 | 0.71 | 0.50 | 0.33 |
| `global_mmlu_full` | 0.57 | 0.50 | 0.60 | 0.00 | 0.22 | 0.43 | **1.00** | 0.50 | 0.17 | 0.67 |
| `belebele_npi_Deva` | 0.50 | 0.57 | 0.27 | 0.00 | 0.36 | 0.62 | **1.00** | 0.25 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | **0.77** | **0.89** | **0.76** | **0.90** | **0.89** | **0.86** | **0.92** | **1.00** | **0.93** |
| `hellaswag` | **0.76** | 0.69 | 0.73 | **1.00** | **0.91** | **0.86** | **0.90** | **0.86** | **0.80** | **0.83** |
| `multiblimp` | 0.71 | 0.73 | **0.80** | **0.83** | **0.84** | **0.90** | **0.80** | **0.82** | **0.87** | 0.67 |
| `global_piqa_parallel_cloze` | 0.60 | 0.53 | 0.67 | 0.50 | 0.71 | 0.62 | **0.90** | 0.68 | **0.80** | **1.00** |
| `arc` | 0.53 | 0.40 | 0.27 | 0.50 | 0.60 | **0.86** | **0.80** | **0.82** | **0.87** | **1.00** |
| `belebele` | 0.49 | 0.47 | 0.27 | 0.67 | 0.55 | 0.62 | 0.50 | 0.21 | 0.40 | 0.67 |
| `global_mmlu_full` | 0.38 | 0.44 | 0.60 | 0.17 | 0.31 | 0.52 | 0.60 | 0.39 | 0.60 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | **0.81** | **0.94** | **0.86** | **0.89** | **0.97** | **0.81** | **0.89** | **0.86** | **0.93** |
| `global_piqa_parallel_cloze` | 0.58 | 0.47 | 0.40 | 0.33 | 0.58 | 0.52 | 0.50 | 0.61 | 0.70 | 0.67 |
| `belebele` | 0.31 | 0.44 | 0.33 | 0.67 | 0.49 | 0.48 | 0.50 | 0.25 | 0.30 | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.76** | 0.73 | **0.89** | **0.76** | **0.90** | **0.89** | **0.90** | **0.89** | **1.00** | **0.93** |
| `multiblimp` | 0.73 | 0.67 | **0.80** | 0.67 | **0.76** | **0.86** | **0.80** | **0.96** | **1.00** | **1.00** |
| `global_piqa_parallel_cloze` | 0.71 | 0.58 | 0.20 | 0.17 | 0.51 | 0.29 | 0.40 | 0.50 | **0.80** | **0.83** |
| `include_base_44` | 0.47 | 0.60 | 0.53 | 0.00 | 0.45 | 0.71 | 0.30 | 0.57 | 0.73 | 0.50 |
| `belebele` | 0.38 | 0.47 | 0.20 | 0.50 | 0.56 | 0.48 | 0.30 | 0.57 | 0.60 | 0.67 |
| `global_mmlu_full` | 0.40 | 0.33 | 0.53 | 0.00 | 0.45 | 0.38 | 0.70 | 0.57 | 0.60 | 0.17 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.89** | **0.84** | **0.92** | **0.86** | **0.90** | **0.86** | **0.86** | **0.92** | **0.95** | **0.93** |
| `hellaswag` | 0.71 | 0.71 | **0.87** | 0.67 | **0.89** | **0.86** | **1.00** | **0.89** | **1.00** | **1.00** |
| `multiblimp` | **0.87** | **0.78** | **0.80** | 0.67 | **0.85** | **0.81** | 0.70 | **0.86** | **0.93** | **0.83** |
| `arc` | 0.69 | 0.64 | 0.60 | **0.83** | **0.82** | **0.90** | **1.00** | **0.82** | **0.93** | **0.83** |
| `xwinograd` | 0.64 | 0.73 | **0.80** | 0.67 | 0.69 | **0.86** | **0.80** | **0.82** | 0.73 | **0.83** |
| `global_piqa_parallel_cloze_por_latn_port` | 0.71 | 0.56 | 0.33 | **0.83** | 0.69 | 0.57 | 0.50 | 0.43 | 0.53 | **0.83** |
| `global_piqa_parallel_cloze_por_latn_braz` | 0.69 | 0.36 | 0.47 | 0.33 | 0.45 | **0.76** | 0.70 | 0.46 | 0.53 | 0.67 |
| `include_base_44` | 0.47 | 0.47 | 0.33 | 0.67 | 0.56 | 0.52 | 0.70 | 0.57 | 0.33 | 0.17 |
| `global_mmlu_full` | 0.42 | 0.60 | 0.47 | 0.33 | 0.56 | 0.38 | 0.70 | 0.36 | 0.53 | 0.00 |
| `belebele` | 0.49 | 0.44 | 0.67 | 0.33 | **0.80** | 0.33 | 0.10 | 0.36 | 0.13 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `hellaswag` | 0.61 | 0.64 | **0.87** | **0.83** | **0.78** | 0.71 | **0.90** | **0.75** | **0.80** | **1.00** |
| `multiblimp` | **0.83** | 0.64 | **0.80** | **0.83** | **0.78** | **0.81** | **0.80** | **0.79** | **0.80** | 0.67 |
| `bpb` | **0.78** | 0.69 | **0.83** | 0.67 | **0.89** | **0.81** | 0.67 | **0.83** | 0.71 | **0.80** |
| `belebele` | 0.61 | 0.42 | 0.60 | 0.17 | 0.73 | 0.38 | 0.40 | 0.61 | 0.53 | **0.83** |
| `global_mmlu_full` | 0.58 | 0.25 | **0.80** | 0.33 | 0.38 | 0.57 | 0.70 | 0.25 | **0.93** | 0.17 |
| `arc` | 0.61 | 0.22 | 0.33 | 0.33 | 0.29 | 0.43 | 0.50 | 0.61 | **0.80** | **0.83** |
| `global_piqa_parallel_cloze` | 0.53 | 0.33 | 0.73 | 0.33 | 0.60 | 0.52 | 0.40 | 0.29 | 0.60 | 0.00 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.85** | **0.78** | **0.89** | **0.95** | **0.91** | **0.92** | **0.95** | **0.92** | **1.00** | **0.93** |
| `hellaswag` | 0.69 | 0.63 | 0.52 | **0.86** | **0.83** | **0.81** | **0.95** | **0.89** | **0.93** | **0.90** |
| `multiblimp` | **0.77** | **0.76** | 0.67 | 0.71 | **0.86** | **0.81** | 0.71 | **0.82** | **0.82** | **0.90** |
| `xstorycloze` | **0.79** | 0.69 | 0.57 | 0.67 | 0.67 | 0.52 | 0.71 | **0.86** | **0.89** | **0.90** |
| `arc` | 0.68 | 0.59 | 0.48 | 0.67 | 0.63 | **0.76** | **0.86** | **0.93** | **0.75** | **0.80** |
| `global_piqa_parallel_cloze` | 0.47 | 0.35 | 0.53 | 0.20 | 0.47 | 0.67 | 0.57 | 0.64 | 0.71 | **1.00** |
| `xnli` | 0.51 | 0.54 | 0.52 | 0.71 | 0.46 | 0.38 | 0.24 | 0.71 | **0.82** | 0.70 |
| `belebele` | 0.49 | 0.73 | 0.71 | 0.62 | 0.47 | 0.33 | 0.29 | 0.64 | 0.61 | 0.70 |
| `xwinograd` | 0.42 | 0.44 | 0.71 | 0.62 | 0.47 | 0.24 | 0.57 | 0.57 | **0.75** | 0.70 |
| `include_base_44` | 0.55 | 0.40 | 0.52 | 0.67 | 0.59 | 0.67 | 0.38 | 0.61 | 0.32 | 0.40 |
| `global_mmlu_full` | 0.49 | 0.46 | 0.29 | 0.62 | 0.46 | 0.48 | 0.43 | 0.61 | 0.54 | 0.30 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `multiblimp` | **0.93** | **0.89** | **0.93** | **1.00** | **0.86** | **1.00** | 0.67 | **0.82** | **1.00** | **1.00** |
| `bpb` | **0.79** | 0.73 | **0.83** | 0.67 | **0.92** | **0.92** | **0.86** | **0.97** | **1.00** | **0.93** |
| `hellaswag` | **0.82** | **0.79** | **0.93** | **1.00** | **0.83** | **0.86** | **1.00** | **0.86** | 0.67 | 0.67 |
| `global_piqa_parallel_cloze_slk_latn` | 0.57 | 0.39 | 0.53 | **1.00** | 0.36 | 0.67 | 0.67 | 0.46 | 0.50 | 0.67 |
| `global_piqa_parallel_cloze_slk_latn_sari` | 0.57 | 0.64 | 0.27 | **1.00** | 0.61 | 0.48 | **1.00** | 0.50 | 0.33 | 0.33 |
| `arc` | 0.43 | 0.36 | 0.40 | 0.00 | 0.67 | **0.81** | 0.67 | **0.79** | **0.83** | 0.67 |
| `belebele` | 0.68 | 0.54 | 0.27 | **1.00** | 0.36 | 0.52 | 0.67 | 0.50 | 0.33 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.68 | 0.69 | **0.81** | **0.81** | **0.95** | **0.92** | **0.86** | **0.92** | **1.00** | **0.87** |
| `multiblimp` | 0.57 | 0.71 | 0.60 | 0.00 | **0.75** | **0.76** | **1.00** | **0.96** | **1.00** | **1.00** |
| `global_piqa_parallel_cloze_slv_latn` | 0.71 | 0.68 | 0.53 | **1.00** | 0.53 | 0.52 | **1.00** | 0.64 | **0.83** | 0.67 |
| `global_piqa_parallel_cloze_slv_latn_cerk` | 0.57 | 0.39 | 0.47 | **1.00** | 0.61 | 0.43 | 0.33 | 0.54 | 0.00 | 0.00 |
| `belebele` | 0.61 | **0.79** | 0.27 | 0.00 | 0.47 | 0.29 | 0.33 | 0.50 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.66 | 0.67 | **0.83** | 0.71 | **0.80** | **0.81** | 0.67 | **0.81** | 0.71 | **0.87** |
| `belebele` | 0.36 | 0.61 | 0.67 | **1.00** | 0.50 | 0.48 | 0.00 | 0.46 | 0.17 | **1.00** |
| `global_piqa_parallel_cloze` | 0.54 | 0.46 | 0.53 | 0.00 | 0.47 | 0.67 | 0.33 | 0.61 | 0.17 | 0.67 |
| `include_base_44` | 0.39 | 0.50 | 0.53 | 0.00 | 0.42 | 0.62 | 0.33 | 0.21 | 0.50 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb_srp_Cyrl` | **0.81** | **0.76** | **0.81** | **0.95** | **0.93** | **0.94** | **0.90** | **0.94** | **0.90** | **1.00** |
| `bpb_srp_Latn` | 0.74 | 0.71 | **0.89** | 0.67 | **0.91** | **0.92** | 0.71 | **0.97** | **0.81** | **0.87** |
| `hellaswag` | **0.75** | **0.86** | **0.87** | **1.00** | 0.69 | 0.52 | 0.00 | 0.64 | 0.33 | 0.67 |
| `arc` | 0.36 | 0.57 | 0.33 | 0.00 | **0.78** | 0.71 | **1.00** | **0.79** | 0.67 | **1.00** |
| `global_piqa_parallel_cloze_srp_cyrl` | 0.71 | 0.71 | 0.27 | **1.00** | 0.72 | 0.57 | 0.00 | 0.54 | 0.67 | 0.67 |
| `belebele` | 0.46 | 0.39 | 0.53 | 0.00 | 0.61 | 0.48 | 0.67 | 0.61 | **1.00** | 0.33 |
| `global_piqa_parallel_cloze_srp_latn` | 0.46 | 0.46 | 0.47 | 0.00 | 0.67 | 0.67 | 0.33 | 0.71 | 0.33 | 0.67 |
| `include_base_44` | 0.54 | 0.57 | 0.40 | 0.00 | **0.75** | 0.48 | 0.33 | 0.64 | 0.33 | 0.67 |
| `global_mmlu_full` | 0.57 | 0.50 | 0.40 | 0.00 | 0.33 | 0.43 | 0.33 | 0.46 | 0.17 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.76** | **0.76** | **0.92** | **0.86** | **0.83** | **0.81** | **0.76** | **0.89** | **0.90** | **1.00** |
| `multiblimp` | **0.86** | **0.86** | **0.87** | 0.67 | **0.87** | **0.76** | **0.80** | **0.82** | **0.87** | **1.00** |
| `hellaswag` | **0.78** | 0.67 | 0.67 | **0.83** | **0.80** | **0.81** | **0.80** | **0.86** | 0.67 | **1.00** |
| `arc` | 0.28 | 0.14 | 0.33 | 0.50 | 0.73 | **0.76** | 0.70 | **0.82** | **0.87** | **1.00** |
| `global_piqa_parallel_cloze` | 0.39 | 0.50 | 0.33 | 0.50 | **0.76** | 0.71 | 0.70 | 0.57 | 0.53 | 0.50 |
| `global_mmlu_full` | 0.58 | 0.47 | 0.60 | 0.17 | 0.36 | 0.52 | 0.60 | 0.64 | 0.67 | 0.67 |
| `belebele` | 0.25 | 0.36 | 0.33 | 0.50 | 0.53 | 0.67 | **0.80** | 0.32 | 0.53 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | 0.72 | **0.81** | **0.81** | 0.73 | **0.94** | **1.00** | **0.89** | **0.81** | **1.00** |
| `multiblimp` | 0.68 | **0.79** | **0.87** | 0.67 | 0.72 | 0.67 | **1.00** | 0.71 | 0.70 | 0.67 |
| `hellaswag` | 0.61 | 0.54 | **0.87** | 0.67 | 0.61 | 0.62 | **1.00** | **0.75** | **0.90** | **0.83** |
| `global_piqa_parallel_cloze` | 0.64 | 0.64 | 0.73 | 0.67 | **0.81** | 0.71 | 0.33 | 0.57 | 0.30 | **0.83** |
| `belebele` | 0.54 | 0.36 | 0.40 | 0.67 | 0.42 | 0.43 | 0.67 | 0.43 | 0.50 | **1.00** |
| `xcopa` | 0.68 | 0.64 | 0.67 | 0.00 | **0.78** | 0.48 | 0.50 | 0.32 | 0.30 | **0.83** |
| `arc` | 0.25 | 0.11 | 0.13 | 0.00 | **0.75** | 0.62 | 0.67 | **0.82** | **1.00** | **0.83** |
| `include_base_44` | 0.50 | 0.14 | 0.53 | 0.67 | 0.39 | 0.38 | 0.67 | 0.43 | 0.20 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.87** | **0.80** | **0.86** | **0.95** | **0.90** | **0.94** | **0.95** | **0.97** | **0.95** | **0.93** |
| `xnli` | 0.53 | 0.67 | 0.73 | 0.50 | 0.71 | 0.71 | 0.67 | **0.86** | **0.81** | **0.80** |
| `global_piqa_parallel_cloze` | **0.75** | 0.72 | 0.47 | 0.40 | 0.49 | 0.52 | 0.60 | 0.36 | 0.29 | 0.70 |
| `belebele` | 0.36 | 0.56 | 0.47 | 0.40 | 0.51 | 0.52 | 0.53 | **0.75** | 0.38 | 0.20 |
| `xcopa` | 0.25 | **0.78** | 0.67 | 0.10 | 0.29 | 0.19 | **0.80** | **0.82** | 0.38 | 0.40 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.84** | **0.75** | **0.86** | **0.95** | **0.90** | **0.92** | **0.95** | **0.92** | **0.95** | **0.87** |
| `multiblimp` | **0.75** | 0.53 | 0.73 | 0.33 | 0.73 | 0.67 | **0.90** | **0.79** | **0.87** | 0.67 |
| `xnli` | 0.36 | 0.56 | 0.33 | 0.50 | **0.76** | **0.81** | **0.80** | **0.75** | **0.93** | **1.00** |
| `xcopa` | 0.69 | 0.53 | 0.73 | **0.83** | 0.42 | 0.67 | 0.40 | 0.57 | 0.60 | **0.83** |
| `belebele` | 0.58 | 0.61 | 0.53 | **1.00** | 0.53 | 0.48 | 0.40 | 0.57 | 0.47 | **0.83** |
| `global_mmlu_full` | 0.56 | 0.56 | 0.53 | 0.67 | 0.31 | 0.33 | 0.50 | 0.50 | **0.80** | **0.83** |
| `include_base_44` | 0.58 | 0.67 | 0.67 | 0.17 | 0.36 | 0.14 | 0.40 | 0.57 | 0.53 | 0.50 |
| `global_piqa_parallel_cloze` | 0.53 | 0.53 | 0.47 | 0.33 | 0.53 | 0.19 | 0.20 | 0.68 | 0.47 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.91** | **0.86** | **0.92** | **0.95** | **0.92** | **0.92** | **1.00** | **0.92** | **0.95** | **0.93** |
| `hellaswag` | **0.92** | 0.72 | **0.80** | **0.83** | **0.82** | **0.90** | **0.90** | **0.96** | **0.87** | **0.83** |
| `multiblimp` | **0.83** | **0.75** | 0.73 | 0.67 | **0.80** | **0.81** | **0.80** | **0.93** | **1.00** | **1.00** |
| `arc` | 0.69 | **0.75** | 0.60 | 0.50 | 0.64 | 0.62 | 0.70 | **0.86** | **0.80** | **1.00** |
| `global_piqa_parallel_cloze` | 0.42 | 0.64 | **0.80** | 0.50 | 0.67 | 0.62 | 0.40 | **0.79** | 0.67 | **1.00** |
| `include_base_44` | 0.36 | 0.58 | 0.53 | 0.17 | 0.58 | 0.52 | 0.70 | **0.79** | 0.47 | 0.17 |
| `belebele` | 0.47 | 0.67 | 0.53 | 0.17 | 0.60 | 0.52 | 0.30 | 0.54 | 0.53 | 0.50 |
| `global_mmlu_full` | 0.67 | 0.47 | 0.53 | 0.17 | 0.40 | 0.67 | 0.40 | 0.57 | 0.47 | 0.17 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.90** | 0.72 | **0.78** | **0.90** | **0.77** | **0.89** | **0.90** | **0.92** | **0.76** | **0.80** |
| `global_piqa_parallel_cloze_urd_arab` | 0.54 | 0.64 | 0.60 | **1.00** | **0.75** | 0.62 | **1.00** | 0.64 | **0.83** | **1.00** |
| `include_base_44` | 0.61 | 0.57 | 0.53 | **1.00** | 0.56 | **0.81** | 0.67 | 0.64 | **1.00** | **1.00** |
| `xnli` | 0.39 | **0.75** | 0.53 | **1.00** | 0.61 | **0.81** | 0.33 | 0.64 | **1.00** | 0.00 |
| `multiblimp` | **0.75** | **0.75** | 0.47 | 0.00 | **0.83** | 0.57 | **1.00** | 0.64 | 0.67 | 0.33 |
| `global_piqa_parallel_cloze_urd_latn` | 0.61 | 0.46 | 0.67 | **1.00** | 0.61 | 0.38 | 0.67 | 0.46 | 0.33 | 0.67 |
| `belebele_urd_Latn` | 0.57 | 0.36 | 0.53 | **1.00** | 0.42 | 0.57 | 0.67 | 0.39 | 0.33 | **1.00** |
| `belebele_urd_Arab` | 0.43 | 0.57 | 0.60 | 0.00 | 0.39 | **0.76** | 0.33 | 0.25 | 0.67 | 0.00 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.87** | **0.79** | **0.92** | **0.76** | **0.90** | **0.89** | **0.81** | **0.89** | **0.90** | **0.80** |
| `xcopa` | 0.73 | **0.87** | 0.73 | **0.83** | 0.69 | **0.86** | **1.00** | **0.82** | 0.67 | **0.83** |
| `xnli` | **0.84** | 0.60 | 0.73 | 0.67 | **0.78** | **0.76** | **0.80** | 0.71 | **0.80** | **0.83** |
| `hellaswag` | 0.73 | 0.67 | 0.67 | **0.83** | 0.69 | 0.67 | **0.90** | **0.86** | 0.60 | **0.83** |
| `global_mmlu_full` | 0.69 | 0.51 | **0.87** | 0.67 | 0.56 | 0.62 | 0.70 | **0.82** | 0.60 | 0.50 |
| `arc` | 0.47 | 0.47 | 0.20 | 0.33 | 0.58 | 0.57 | 0.60 | 0.50 | 0.67 | **0.83** |
| `global_piqa_parallel_cloze` | 0.71 | 0.47 | 0.20 | 0.50 | 0.55 | 0.19 | 0.70 | 0.43 | 0.47 | 0.67 |
| `include_base_44` | 0.47 | 0.42 | 0.40 | 0.33 | 0.60 | 0.29 | 0.50 | 0.36 | **0.80** | 0.67 |
| `belebele` | 0.29 | 0.44 | 0.53 | **0.83** | 0.49 | 0.67 | 0.20 | 0.39 | 0.33 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | **0.75** | **0.92** | **0.95** | **0.92** | **0.97** | **1.00** | **0.92** | **1.00** | **0.93** |
| `xstorycloze` | **0.76** | 0.55 | **0.80** | 0.50 | 0.64 | **0.95** | **0.80** | 0.71 | **0.90** | **0.80** |
| `arc` | 0.49 | 0.56 | 0.67 | 0.50 | 0.56 | **0.81** | 0.67 | **0.75** | **0.81** | **0.90** |
| `paws` | 0.47 | 0.71 | 0.40 | 0.60 | 0.71 | 0.52 | 0.73 | **0.79** | 0.57 | 0.60 |
| `xcopa` | 0.42 | 0.44 | 0.47 | 0.50 | 0.44 | 0.57 | 0.60 | **0.82** | **0.76** | 0.70 |
| `xwinograd` | 0.42 | 0.42 | 0.13 | 0.00 | 0.52 | **0.86** | 0.60 | **0.86** | **0.86** | **0.90** |
| `global_piqa_parallel_cloze_cmn_hans` | 0.58 | 0.62 | 0.60 | 0.10 | 0.48 | 0.62 | 0.40 | 0.64 | 0.57 | 0.60 |
| `belebele_zho_Hant` | 0.69 | 0.49 | 0.67 | 0.50 | 0.64 | 0.57 | 0.53 | 0.71 | 0.14 | 0.20 |
| `xnli` | 0.36 | 0.58 | 0.47 | 0.20 | 0.59 | 0.62 | 0.53 | 0.61 | 0.52 | 0.60 |
| `global_piqa_parallel_cloze_cmn_hant` | 0.55 | 0.53 | 0.67 | 0.50 | 0.35 | 0.71 | 0.67 | 0.29 | 0.14 | 0.60 |
| `global_mmlu_full` | 0.44 | 0.53 | 0.73 | 0.20 | 0.53 | 0.19 | 0.47 | 0.54 | 0.43 | 0.50 |
| `include_base_44` | 0.58 | 0.40 | **0.87** | 0.20 | 0.59 | 0.48 | 0.20 | 0.29 | 0.52 | 0.40 |
| `belebele_zho_Hans` | 0.60 | 0.62 | 0.53 | 0.10 | 0.41 | 0.14 | 0.33 | 0.57 | 0.38 | 0.40 |
