...
| az | `rf_include_base_44_azerbaijani` | 0.5 |  |  |
| bg | `multiblimp_bul` | 1.3 | 0.59 | 0.1 |
| bn | `multiblimp_ben` | 1.2 | 0.37 | 0.2 |
| bs | `global_piqa_nonparallel_cloze_bos_latn` | 0.4 |  |  |
| ca | `xstorycloze_ca` | 2.1 |  |  |
| cs | `multiblimp_ces` | 0.7 | 0.67 | 0.2 |
| da | `multiblimp_dan` | 3.1 | 0.50 | 0.2 |
| de | `multiblimp_deu` | 1.1 | 0.58 | 0.5 |
| el | `multiblimp_ell` | 1.0 | 0.62 | 0.2 |
| en | `xwinograd_en` | 1.0 | 0.74 | 0.7 |
| es | `paws_es` | 1.1 | 0.75 | 0.3 |
| et | `multiblimp_est` | 1.2 |  |  |
...
| hr | `belebele_hrv_Latn` | 0.5 |  |  |
| hu | `multiblimp_hun` | 1.4 | 0.55 | 0.2 |
| id | `xstorycloze_id` | 0.4 | 0.62 | 0.2 |
| it | `multiblimp_ita` | 0.9 | 0.64 | 0.4 |
| ja | `xwinograd_jp` | 1.0 | 0.69 | 0.7 |
| ka | `multiblimp_kat` | 1.1 | 0.53 | 0.1 |
| kk | `rf_include_base_44_kazakh` | 0.5 |  |  |
| ko | `rfgm_include_base_44_korean` | 0.6 |  | 0.4 |
| lt | `rf_include_base_44_lithuanian` | 0.8 |  |  |
| lv | `rf_belebele_lvs_Latn` | 0.1 |  |  |
| ml | `rf_belebele_mal_Mlym` | 0.1 | 0.61 | 0.2 |
| mr | `multiblimp_mar` | 0.5 |  |  |
| ms | `rf_belebele_zsm_Latn` | 0.1 |  |  |
| ne | `rf_belebele_npi_Latn` | 0.6 |  |  |
| nl | `multiblimp_nld` | 1.3 | 0.63 | 0.2 |
| no | `rf_belebele_nob_Latn` | 0.4 | 0.69 | 0.2 |
| pl | `multiblimp_pol` | 1.0 | 0.60 | 0.2 |
| pt | `xwinograd_pt` | 1.4 | 0.61 | 0.2 |
| ro | `multiblimp_ron` | 0.7 | 0.53 | 0.2 |
| ru | `xnli_ru` | 1.0 | 0.67 | 0.7 |
| sk | `multiblimp_slk` | 0.3 |  |  |
| sl | `rf_belebele_slv_Latn` | 0.7 |  |  |
| sq | `rf_include_base_44_albanian` | 0.5 |  |  |
| sr | `rf_global_mmlu_full_sr` | 0.4 |  |  |
| sv | `rf_belebele_swe_Latn` | 0.3 | 0.47 | 0.3 |
| ta | `xcopa_ta` | 0.6 | 0.44 | 0.2 |
| th | `xnli_th` | 0.7 | 0.63 | 0.4 |
| tr | `multiblimp_tur` | 1.2 | 0.59 | 0.2 |
| uk | `multiblimp_ukr` | 0.8 | 0.53 | 0.1 |
| ur | `rf_belebele_urd_Arab` | 0.6 |  |  |
...
|---|---|---|---|---|
| per_benchmark | `multiblimp` | 350M | 2.98 → 4.29 | +1.31 |
| per_benchmark | `arc` | 1B | 2.57 → 3.86 | +1.30 |
| global_mmlu_full_subjects | `global_mmlu_full` | 600M | 2.14 → 3.33 | +1.18 |
| per_benchmark | `rf_belebele` | 350M | 2.93 → 4.02 | +1.09 |
...
| global_mmlu_full_subjects | `global_mmlu_full` | 350M | 3.23 → 4.09 | +0.87 |
...
| `rfgm_include_base_44` | 0.53 | 4 | statement_continuation |
...
|---|---|---|---|---|---|---|
| `loss` |  | 3.15 | 2.65 | 2.47 | 2.36 | 2.22 |
| `bpb` |  | 1.96 | 1.66 | 1.56 | 1.47 | 1.40 |
...
| `rfgm_include_base_44` | 0.25 | 0.26 | 0.27 | 0.29 | **0.31** | **0.33** |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `hellaswag` | 0.63 | 0.50 | 0.70 | 0.71 | 0.71 | 0.69 | **0.77** | 0.71 | **0.76** | **0.86** |
| `bpb` | 0.65 | 0.44 | **0.77** | **0.79** | 0.68 | 0.65 | 0.74 | 0.63 | 0.68 | **0.89** |
| `xstorycloze` | 0.56 | 0.53 | 0.59 | 0.61 | 0.73 | 0.71 | 0.69 | 0.75 | **0.75** | 0.67 |
| `arc_challenge` | 0.58 | 0.58 | 0.52 | 0.54 | **0.87** | 0.64 | 0.68 | 0.68 | 0.74 | 0.66 |
| `xwinograd` | 0.68 | 0.58 | 0.63 | 0.50 | 0.61 | 0.75 | 0.70 | 0.70 | 0.54 | 0.68 |
| `lambada_openai_mt` | 0.62 | 0.67 | 0.65 | 0.71 | 0.46 | 0.45 | 0.46 | **0.77** | 0.68 | **0.83** |
| `rf_global_mmlu_full` | 0.64 | 0.48 | 0.61 | 0.50 | 0.60 | 0.50 | 0.42 | 0.70 | 0.73 | **0.77** |
| `arc_easy` | 0.56 | 0.43 | 0.63 | 0.67 | 0.71 | 0.55 | 0.69 | 0.57 | 0.49 | 0.51 |
| `rf_belebele` | 0.42 | 0.56 | 0.65 | 0.47 | 0.47 | 0.55 | 0.69 | 0.73 | 0.48 | 0.53 |
| `xnli` | 0.59 | 0.59 | 0.53 | 0.56 | 0.65 | 0.65 | 0.47 | 0.38 | 0.58 | 0.41 |
| `global_mmlu_full` | 0.49 | 0.55 | 0.56 | 0.58 | 0.42 | 0.52 | 0.45 | 0.53 | 0.53 | 0.49 |
| `belebele` | 0.48 | 0.71 | 0.47 | 0.43 | 0.44 | 0.49 | 0.37 | 0.57 | 0.49 | 0.49 |
| `global_piqa_parallel_cloze` | 0.41 | **0.77** | 0.55 | 0.48 | 0.43 | 0.46 | 0.44 | 0.42 | 0.50 | 0.45 |
| `multiblimp` | 0.70 | 0.50 | 0.41 | 0.60 | 0.40 | 0.53 | 0.59 | 0.40 | 0.42 | 0.34 |
| `paws` | 0.59 | 0.42 | 0.50 | 0.35 | 0.42 | 0.41 | 0.64 | 0.43 | 0.43 | 0.50 |
| `truthfulqa-multi_mc1` | 0.35 | 0.17 | 0.59 | 0.38 | 0.52 | 0.49 | 0.41 | 0.47 | 0.61 | 0.31 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.57 | 0.43 | 0.62 | 0.60 | **0.76** | **0.86** | **0.80** | 0.71 | 0.50 | 0.60 |
| `rfgm_include_base_44` | 0.00 | 0.67 | 0.67 | 0.67 | 0.33 | 0.33 | 0.33 | **1.00** | **1.00** | **1.00** |
| `hellaswag` | 0.48 | 0.48 | 0.57 | 0.67 | 0.52 | 0.71 | 0.62 | 0.71 | 0.52 | 0.68 |
| `multiblimp` | **0.81** | 0.43 | **0.81** | 0.48 | 0.38 | 0.67 | 0.43 | 0.48 | **0.76** | 0.50 |
| `rf_belebele_arz_Arab` | 0.57 | 0.19 | 0.62 | 0.52 | 0.57 | **0.76** | 0.71 | 0.52 | 0.57 | 0.43 |
| `rf_belebele_arb_Latn` | 0.43 | 0.48 | 0.52 | 0.52 | 0.62 | 0.24 | **0.76** | 0.29 | **0.86** | 0.32 |
| `rf_global_mmlu_full` | 0.52 | 0.62 | 0.33 | 0.48 | 0.62 | 0.57 | 0.38 | 0.24 | 0.38 | 0.68 |
...
| `rf_belebele_ary_Arab` | 0.24 | 0.62 | 0.67 | 0.38 | 0.48 | 0.29 | **0.76** | 0.67 | 0.33 | 0.21 |
| `rf_belebele_ars_Arab` | 0.57 | 0.38 | 0.62 | 0.14 | 0.62 | 0.57 | 0.38 | 0.48 | 0.57 | 0.21 |
...
| `rf_belebele_apc_Arab` | 0.52 | 0.43 | 0.33 | 0.57 | **0.86** | 0.19 | 0.52 | 0.24 | 0.43 | 0.39 |
| `belebele_ary_Arab` | 0.24 | 0.33 | 0.71 | 0.48 | 0.71 | 0.29 | 0.38 | 0.43 | 0.52 | 0.39 |
| `rf_include_base_44` | 0.38 | 0.62 | 0.57 | 0.33 | 0.29 | **0.81** | 0.38 | 0.33 | 0.29 | 0.46 |
...
| `rf_belebele_arb_Arab` | 0.52 | 0.67 | 0.14 | 0.62 | **0.76** | 0.38 | 0.24 | 0.14 | 0.29 | 0.43 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **1.00** | 0.17 | **0.83** | **1.00** | 0.17 | **0.83** | **1.00** | 0.00 | 0.00 | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.47 | 0.73 | **0.83** | **0.80** | **0.80** | **0.83** | 0.73 | 0.33 | **0.80** |
| `rf_belebele_ben_Latn` | 0.40 | 0.53 | 0.20 | **0.80** | 0.33 | 0.73 | 0.60 | 0.47 | 0.47 | 0.46 |
...
| `rf_global_mmlu_full` | 0.40 | 0.73 | 0.33 | 0.40 | 0.40 | 0.53 | 0.73 | 0.33 | 0.40 | 0.57 |
| `global_mmlu_full` | 0.40 | 0.33 | 0.60 | 0.47 | 0.40 | 0.67 | 0.67 | 0.33 | 0.20 | 0.71 |
| `rf_include_base_44` | 0.40 | 0.53 | 0.27 | 0.53 | 0.60 | 0.20 | 0.33 | 0.53 | 0.73 | 0.57 |
| `belebele_ben_Beng` | 0.27 | 0.60 | 0.60 | **0.87** | 0.33 | 0.07 | 0.33 | 0.47 | 0.60 | 0.50 |
| `rf_belebele_ben_Beng` | 0.47 | 0.47 | 0.67 | 0.53 | 0.13 | 0.73 | 0.07 | 0.20 | **0.93** | 0.39 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.70 | 0.40 | **0.80** | **0.83** | 0.70 | **0.90** | 0.67 | 0.60 | 0.33 | 0.70 |
| `multiblimp` | **0.80** | 0.50 | 0.50 | 0.60 | 0.70 | 0.50 | 0.40 | 0.20 | 0.30 | 0.67 |
| `rf_global_mmlu_full` | 0.70 | 0.40 | 0.50 | 0.40 | 0.50 | 0.60 | 0.10 | 0.50 | 0.40 | 0.33 |
| `belebele` | 0.60 | 0.60 | 0.30 | 0.40 | 0.60 | 0.30 | 0.30 | 0.30 | 0.60 | 0.40 |
| `rf_belebele` | 0.60 | 0.30 | 0.70 | 0.50 | 0.70 | 0.40 | 0.20 | 0.30 | 0.10 | 0.60 |
...
| `bpb` | 0.67 | 0.17 | 0.67 | **1.00** | 0.50 | **1.00** | 0.67 | 0.50 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.58 | **0.76** | **0.82** | **0.91** | **0.91** | **0.79** | **0.82** | 0.71 | **0.85** |
| `hellaswag` | 0.62 | 0.55 | 0.64 | 0.56 | **0.78** | 0.69 | **0.80** | **0.84** | **0.87** | **0.80** |
| `lambada_openai_mt` | 0.62 | 0.60 | **0.78** | 0.73 | 0.55 | 0.62 | 0.67 | 0.71 | 0.55 | 0.71 |
| `xnli` | 0.49 | 0.67 | 0.75 | 0.58 | 0.44 | 0.40 | 0.67 | **0.84** | 0.51 | 0.49 |
| `arc` | 0.38 | 0.62 | 0.56 | 0.45 | 0.58 | 0.44 | 0.55 | 0.60 | 0.67 | 0.69 |
| `multiblimp` | 0.58 | 0.67 | 0.58 | 0.45 | 0.53 | 0.49 | 0.45 | 0.62 | 0.55 | 0.54 |
| `paws` | 0.29 | 0.67 | 0.42 | 0.40 | 0.51 | 0.51 | 0.51 | 0.56 | 0.47 | 0.73 |
| `rf_belebele` | 0.53 | 0.64 | 0.38 | 0.38 | 0.45 | 0.45 | 0.40 | 0.65 | 0.53 | 0.52 |
| `rf_global_mmlu_full` | 0.36 | 0.53 | 0.40 | 0.38 | 0.35 | 0.40 | 0.40 | 0.65 | 0.60 | 0.71 |
| `global_piqa_parallel_cloze` | 0.29 | 0.36 | 0.53 | 0.44 | 0.67 | 0.53 | 0.38 | 0.42 | 0.47 | 0.49 |
| `include_base_44` | 0.20 | 0.64 | 0.55 | 0.64 | 0.38 | 0.36 | 0.47 | 0.29 | 0.51 | 0.53 |
| `global_mmlu_full` | 0.29 | 0.45 | 0.45 | 0.35 | 0.29 | 0.58 | 0.58 | 0.42 | 0.56 | 0.42 |
| `belebele` | 0.35 | 0.27 | 0.49 | 0.73 | 0.47 | 0.22 | 0.22 | 0.49 | 0.31 | 0.55 |
| `rf_include_base_44` | 0.16 | 0.40 | 0.64 | 0.18 | 0.47 | 0.24 | 0.58 | 0.29 | 0.60 | 0.40 |
| `rfgm_include_base_44` | 0.50 | 0.50 | 0.33 | 0.17 | 0.17 | 0.67 | 0.17 | 0.00 | 0.50 | 0.50 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.76** | 0.57 | **0.81** | **0.80** | **0.81** | **0.95** | 0.70 | **0.76** | 0.50 | **0.79** |
| `rf_belebele` | 0.52 | 0.29 | 0.52 | 0.62 | 0.57 | 0.62 | 0.43 | 0.71 | 0.67 | 0.60 |
...
| `rf_global_mmlu_full` | 0.38 | 0.29 | 0.43 | 0.38 | 0.62 | 0.57 | 0.52 | **0.76** | 0.43 | 0.44 |
...
| `rf_include_base_44` | 0.43 | 0.57 | 0.48 | 0.33 | 0.38 | 0.52 | 0.38 | 0.05 | 0.14 | 0.53 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `hellaswag` | 0.64 | 0.64 | **0.81** | 0.67 | **0.89** | **0.83** | **0.92** | 0.72 | **0.81** | **0.87** |
| `bpb` | 0.56 | 0.42 | 0.67 | 0.57 | **0.81** | **0.83** | **0.76** | 0.69 | 0.62 | **0.75** |
| `rfgm_include_base_44` | 0.50 | **0.83** | 0.33 | 0.50 | 0.50 | 0.67 | **0.83** | 0.33 | 0.50 | **0.83** |
| `xstorycloze` | 0.33 | 0.39 | 0.44 | 0.33 | 0.67 | 0.58 | **0.78** | 0.69 | **0.89** | 0.67 |
| `rf_global_mmlu_full` | 0.58 | 0.50 | 0.53 | 0.64 | 0.61 | 0.58 | 0.42 | 0.69 | 0.50 | 0.44 |
| `arc` | 0.42 | 0.28 | 0.47 | 0.50 | 0.58 | 0.61 | **0.75** | 0.44 | 0.61 | 0.71 |
| `multiblimp` | 0.47 | 0.53 | 0.44 | **0.81** | 0.25 | 0.53 | 0.64 | 0.53 | 0.42 | 0.60 |
| `lambada_openai_mt` | 0.33 | 0.50 | 0.42 | 0.61 | 0.31 | 0.47 | 0.61 | 0.50 | 0.47 | 0.73 |
| `xnli` | 0.42 | 0.36 | 0.64 | **0.81** | 0.44 | 0.39 | 0.33 | 0.56 | 0.39 | 0.60 |
| `rf_belebele` | 0.42 | 0.31 | 0.33 | 0.42 | 0.56 | 0.56 | 0.47 | 0.61 | **0.81** | 0.36 |
| `paws` | 0.36 | 0.44 | 0.39 | 0.39 | 0.53 | 0.56 | 0.72 | **0.75** | 0.25 | 0.42 |
| `truthfulqa-multi_mc1` | 0.33 | 0.56 | 0.33 | 0.69 | 0.56 | 0.53 | 0.42 | 0.28 | 0.64 | 0.27 |
| `global_piqa_parallel_cloze_spa_latn_mexi` | 0.47 | 0.33 | 0.39 | 0.33 | 0.44 | 0.31 | 0.50 | 0.44 | 0.72 | 0.58 |
| `include_base_44` | 0.33 | 0.53 | 0.47 | 0.69 | 0.39 | 0.56 | 0.33 | 0.39 | 0.42 | 0.36 |
| `global_piqa_parallel_cloze_spa_latn_spai` | 0.36 | 0.11 | 0.42 | 0.53 | 0.53 | 0.36 | 0.58 | 0.53 | 0.42 | 0.62 |
| `belebele` | 0.50 | 0.50 | 0.25 | 0.67 | 0.28 | 0.19 | 0.42 | 0.69 | 0.56 | 0.38 |
| `global_mmlu_full` | 0.36 | 0.67 | 0.25 | 0.44 | 0.56 | 0.61 | 0.47 | 0.28 | 0.33 | 0.42 |
| `global_piqa_parallel_cloze_spa_latn_peru` | 0.47 | 0.47 | 0.44 | 0.36 | 0.58 | 0.25 | 0.19 | 0.31 | 0.47 | 0.56 |
| `rf_include_base_44` | 0.42 | 0.42 | 0.17 | 0.53 | 0.44 | 0.53 | 0.31 | 0.42 | 0.42 | 0.44 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.75** | 0.61 | **0.78** | 0.73 | **0.86** | **0.86** | **0.87** | **0.78** | 0.67 | **0.83** |
| `multiblimp` | **0.78** | 0.61 | 0.53 | 0.64 | 0.72 | 0.50 | 0.58 | 0.53 | 0.50 | 0.55 |
| `rf_include_base_44` | 0.72 | 0.50 | 0.56 | 0.58 | 0.53 | 0.53 | 0.61 | 0.44 | 0.64 | 0.47 |
| `rf_global_mmlu_full` | 0.50 | 0.67 | 0.47 | 0.44 | 0.56 | 0.53 | 0.31 | 0.42 | 0.50 | 0.70 |
| `include_base_44` | 0.58 | 0.56 | 0.64 | 0.56 | 0.33 | 0.33 | 0.14 | 0.69 | 0.58 | 0.65 |
| `rf_belebele` | 0.25 | 0.53 | 0.44 | 0.56 | 0.61 | 0.44 | 0.53 | 0.58 | 0.47 | 0.42 |
...
| `rfgm_include_base_44` | 0.00 | 0.00 | 0.00 | 0.33 | 0.67 | **1.00** | 0.33 | 0.67 | 0.67 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | 0.33 | **0.83** | **1.00** | 0.17 | **1.00** | **1.00** | 0.17 | 0.33 | **1.00** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `hellaswag` | 0.64 | 0.67 | 0.58 | 0.47 | **0.92** | **0.83** | **0.78** | **0.86** | **0.81** | **0.84** |
| `bpb` | 0.58 | 0.42 | 0.72 | 0.71 | **0.83** | **0.81** | **0.76** | 0.69 | 0.62 | **0.79** |
| `lambada_openai_mt` | 0.67 | 0.72 | 0.72 | **0.81** | 0.50 | 0.56 | 0.58 | **0.78** | **0.75** | **0.76** |
| `rf_belebele` | 0.56 | **0.78** | 0.69 | 0.44 | 0.58 | 0.72 | 0.64 | 0.69 | 0.53 | 0.67 |
| `arc` | 0.69 | 0.64 | 0.53 | 0.72 | 0.44 | **0.75** | 0.69 | 0.50 | 0.53 | 0.64 |
| `rf_global_mmlu_full` | 0.39 | 0.50 | 0.36 | 0.31 | 0.67 | **0.75** | 0.64 | **0.75** | 0.42 | 0.60 |
| `multiblimp` | 0.56 | 0.50 | 0.58 | 0.33 | 0.47 | 0.56 | 0.50 | 0.50 | 0.67 | 0.58 |
| `paws` | 0.33 | 0.33 | 0.72 | 0.58 | 0.42 | 0.42 | 0.61 | 0.61 | 0.25 | 0.51 |
| `xnli` | 0.36 | 0.42 | 0.69 | 0.64 | 0.50 | 0.36 | 0.44 | 0.36 | 0.39 | 0.53 |
| `rfgm_include_base_44` | 0.50 | 0.50 | 0.67 | 0.67 | 0.00 | **0.83** | 0.50 | 0.17 | 0.50 | 0.33 |
| `belebele` | 0.50 | 0.58 | 0.50 | 0.58 | 0.25 | 0.44 | 0.50 | 0.47 | 0.28 | 0.51 |
| `rf_include_base_44` | 0.39 | 0.42 | 0.53 | 0.50 | 0.36 | 0.53 | 0.69 | 0.33 | 0.36 | 0.42 |
| `include_base_44` | 0.47 | 0.42 | 0.61 | 0.25 | 0.56 | 0.47 | 0.33 | 0.33 | 0.61 | 0.42 |
| `global_mmlu_full` | 0.11 | 0.53 | 0.42 | 0.58 | 0.53 | 0.53 | 0.53 | 0.33 | 0.39 | 0.51 |
| `global_piqa_parallel_cloze_fra_latn_cana` | 0.33 | 0.47 | 0.22 | 0.53 | 0.69 | 0.47 | 0.39 | 0.39 | 0.53 | 0.42 |
| `xwinograd` | 0.31 | 0.56 | 0.33 | 0.64 | 0.47 | 0.69 | 0.25 | 0.50 | 0.44 | 0.22 |
| `global_piqa_parallel_cloze_fra_latn_fran` | 0.42 | 0.36 | 0.39 | 0.22 | 0.64 | 0.50 | 0.36 | 0.31 | 0.39 | 0.31 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.83** | 0.67 | 0.67 |  | **0.83** | **0.83** |  | **1.00** |  | **0.83** |
| `rf_global_mmlu_full` | 0.67 | 0.33 | 0.67 | 0.67 | 0.67 | 0.67 | 0.67 | 0.33 | 0.33 | **0.93** |
...
| `rf_belebele` | 0.33 | 0.67 | 0.50 | 0.50 | 0.17 | 0.00 | **0.83** | **0.83** | 0.33 | 0.40 |
...
| `rf_include_base_44` | 0.33 | 0.33 | 0.00 | 0.17 | **0.83** | 0.67 | 0.33 | 0.50 | 0.17 | 0.47 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.47 | 0.67 | **0.83** | **0.80** | 0.60 | 0.67 | 0.67 | 0.17 | 0.73 |
| `rf_belebele_hin_Deva` | 0.40 | 0.27 | 0.47 | 0.20 | 0.73 | 0.67 | 0.67 | 0.67 | **0.93** | 0.57 |
| `rf_belebele_hin_Latn` | 0.40 | 0.53 | 0.20 | 0.53 | 0.73 | 0.67 | 0.60 | 0.67 | 0.60 | 0.43 |
| `hellaswag` | 0.53 | 0.60 | 0.47 | 0.73 | 0.53 | 0.40 | **0.80** | 0.20 | 0.60 | 0.43 |
| `rf_global_mmlu_full` | 0.53 | **0.93** | 0.40 | 0.33 | 0.47 | 0.53 | 0.67 | 0.33 | 0.27 | 0.68 |
...
| `rf_include_base_44` | 0.13 | 0.60 | 0.60 | 0.47 | 0.20 | 0.13 | 0.47 | 0.60 | 0.33 | 0.46 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `rf_belebele` | **0.90** | **0.80** | 0.40 | 0.50 | 0.70 | 0.30 | 0.40 | 0.40 | 0.70 | 0.47 |
| `hellaswag` | 0.60 | 0.50 | 0.30 | 0.50 | 0.30 | 0.50 | 0.50 | 0.60 | **0.80** | 0.73 |
| `bpb` | 0.60 | 0.10 | 0.70 | 0.67 | 0.50 | **0.90** | 0.50 | 0.40 | 0.17 | 0.50 |
...
| `rf_include_base_44` | 0.30 | 0.10 | **0.90** | 0.40 | 0.40 | 0.30 | 0.10 | 0.20 | 0.70 | 0.47 |
...
| `bpb` | 0.62 | 0.38 | 0.67 | 0.60 | **0.76** | **0.95** | **0.80** | 0.71 | 0.60 | **0.80** |
| `rf_global_mmlu_full` | 0.43 | 0.52 | 0.71 | 0.62 | 0.62 | 0.52 | 0.62 | 0.52 | 0.52 | **0.75** |
...
| `rf_include_base_44` | 0.38 | 0.62 | 0.62 | 0.57 | 0.10 | 0.29 | 0.33 | 0.71 | 0.67 | 0.39 |
| `rfgm_include_base_44` | **1.00** | 0.33 | 0.00 | 0.33 | 0.33 | 0.00 | 0.33 | 0.67 | **1.00** | 0.67 |
| `global_mmlu_full` | 0.52 | 0.52 | 0.43 | 0.43 | 0.43 | 0.52 | 0.29 | 0.43 | 0.52 | 0.50 |
| `rf_belebele` | 0.57 | 0.62 | 0.43 | 0.14 | 0.52 | 0.19 | 0.48 | 0.29 | 0.43 | 0.32 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.64 | 0.50 | **0.78** | 0.71 | **0.81** | **0.86** | **0.90** | 0.67 | 0.71 | **0.89** |
| `hellaswag` | 0.64 | 0.56 | 0.61 | 0.67 | **0.75** | 0.69 | **0.78** | **0.78** | 0.69 | **0.82** |
| `lambada_openai_mt` | 0.72 | 0.72 | 0.61 | **0.75** | 0.67 | **0.78** | 0.61 | **0.78** | 0.67 | 0.67 |
| `multiblimp` | 0.47 | 0.39 | 0.50 | 0.50 | **0.75** | **0.75** | **0.83** | 0.72 | 0.69 | 0.47 |
| `rf_global_mmlu_full` | 0.58 | 0.39 | 0.69 | 0.69 | 0.58 | 0.69 | 0.64 | 0.42 | 0.47 | 0.60 |
| `belebele` | 0.67 | 0.39 | 0.33 | 0.61 | 0.47 | 0.47 | 0.44 | 0.61 | 0.44 | 0.47 |
| `arc` | 0.50 | 0.53 | 0.39 | 0.47 | 0.42 | 0.50 | 0.58 | 0.47 | 0.56 | 0.40 |
| `xcopa` | 0.31 | 0.39 | 0.28 | 0.44 | 0.31 | 0.61 | 0.61 | 0.58 | 0.50 | 0.71 |
| `global_mmlu_full` | 0.36 | 0.64 | 0.47 | 0.53 | 0.36 | 0.50 | 0.33 | 0.39 | 0.39 | 0.69 |
| `rf_belebele` | 0.31 | 0.36 | 0.50 | 0.53 | 0.50 | 0.58 | 0.53 | 0.25 | 0.33 | 0.47 |
| `rf_include_base_44` | 0.33 | 0.28 | 0.69 | 0.47 | 0.50 | 0.25 | 0.44 | 0.44 | 0.47 | 0.33 |
| `rfgm_include_base_44` | 0.50 | 0.50 | 0.50 | 0.17 | 0.33 | 0.00 | 0.33 | 0.50 | 0.67 | 0.50 |
| `include_base_44` | 0.39 | 0.31 | 0.64 | 0.36 | 0.33 | 0.31 | 0.56 | 0.28 | 0.33 | 0.49 |
| `global_piqa_parallel_cloze` | 0.47 | 0.25 | 0.33 | 0.39 | 0.11 | 0.11 | 0.31 | 0.58 | 0.50 | 0.44 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.58 | 0.75 | **0.79** | **0.91** | **0.93** | **0.82** | **0.84** | **0.75** | **0.89** |
| `rf_global_mmlu_full` | 0.51 | 0.65 | 0.60 | 0.53 | 0.45 | 0.51 | 0.58 | 0.58 | **0.78** | 0.64 |
| `xwinograd` | 0.55 | 0.55 | 0.47 | 0.71 | 0.33 | 0.40 | 0.44 | 0.67 | 0.69 | 0.66 |
| `paws` | 0.51 | 0.67 | 0.42 | 0.60 | 0.55 | 0.73 | 0.58 | 0.38 | 0.38 | 0.57 |
| `rfgm_include_base_44` | 0.33 | 0.00 | 0.00 | 0.33 | 0.67 | 0.67 | 0.67 | **1.00** | 0.67 | 0.67 |
| `include_base_44` | 0.47 | 0.42 | 0.56 | 0.60 | 0.53 | 0.53 | 0.40 | 0.40 | 0.51 | 0.55 |
| `belebele` | 0.38 | 0.56 | 0.55 | 0.51 | 0.36 | 0.42 | 0.29 | 0.53 | 0.60 | 0.56 |
| `global_mmlu_full` | 0.45 | 0.47 | 0.53 | 0.65 | 0.44 | 0.35 | 0.35 | 0.58 | 0.44 | 0.38 |
| `rf_include_base_44` | 0.31 | 0.44 | 0.22 | 0.53 | 0.62 | 0.60 | 0.53 | 0.36 | 0.49 | 0.46 |
| `rf_belebele` | 0.38 | 0.33 | 0.35 | 0.38 | 0.36 | 0.55 | 0.35 | 0.60 | 0.40 | 0.54 |
| `global_piqa_parallel_cloze` | 0.40 | 0.31 | 0.24 | 0.33 | 0.75 | 0.27 | 0.31 | 0.38 | 0.40 | 0.56 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.50 | 0.50 | 0.67 |  | **1.00** | **0.83** |  | **0.83** |  | 0.50 |
| `include_base_44` | 0.17 | 0.33 | 0.67 | **0.83** | **0.83** | 0.50 | 0.33 | 0.67 | 0.50 | 0.67 |
| `rf_include_base_44` | 0.17 | 0.67 | 0.67 | **0.83** | 0.50 | 0.17 | 0.33 | 0.67 | **0.83** | 0.47 |
| `belebele` | 0.67 | 0.67 | 0.50 | 0.67 | 0.33 | 0.17 | 0.33 | 0.50 | 0.67 | 0.53 |
| `rf_belebele` | 0.33 | 0.50 | 0.33 | 0.50 | 0.50 | 0.67 | 0.00 | 0.67 | 0.33 | 0.40 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.47 | **0.80** | 0.67 | **0.80** | **0.87** | **1.00** | 0.67 | 0.50 | **0.80** |
| `rf_belebele` | 0.67 | 0.27 | 0.40 | 0.60 | 0.60 | 0.60 | 0.53 | **0.87** | 0.40 | 0.64 |
| `rf_global_mmlu_full` | 0.47 | 0.60 | 0.60 | 0.67 | 0.73 | 0.47 | 0.40 | 0.47 | 0.40 | 0.71 |
...
| `rf_include_base_44` | 0.53 | 0.20 | 0.27 | 0.20 | 0.20 | 0.40 | 0.13 | 0.27 | **0.80** | 0.39 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.50 | 0.67 | 0.50 |  | **0.83** | **1.00** |  | **0.83** |  | 0.67 |
...
| `rf_include_base_44` | 0.17 | **0.83** | 0.67 | 0.50 | 0.00 | 0.17 | 0.50 | **0.83** | 0.33 | 0.47 |
| `rf_belebele` | 0.17 | 0.17 | **0.83** | 0.50 | 0.50 | 0.17 | 0.67 | 0.33 | 0.17 | 0.33 |
...
| `bpb` | 0.62 | 0.43 | 0.71 | 0.60 | 0.71 | **0.81** | **0.80** | 0.62 | 0.50 | 0.67 |
...
| `rf_global_mmlu_full` | 0.43 | 0.67 | 0.24 | 0.48 | 0.29 | 0.62 | 0.67 | 0.29 | 0.24 | 0.71 |
| `global_mmlu_full` | 0.24 | 0.71 | 0.38 | 0.48 | 0.43 | 0.33 | 0.38 | 0.38 | 0.38 | 0.64 |
| `rf_belebele` | 0.38 | 0.43 | **0.90** | 0.24 | 0.43 | 0.38 | 0.52 | 0.48 | 0.33 | 0.25 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **1.00** | 0.17 | **1.00** | 0.67 | 0.17 | **1.00** | 0.67 | 0.17 | 0.33 | 0.67 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `rfgm_include_base_44` | 0.67 | 0.67 | 0.67 | 0.67 | **1.00** | 0.33 | **1.00** | 0.33 | **1.00** | 0.33 |
| `bpb` | 0.62 | 0.38 | 0.67 | 0.50 | 0.67 | **0.86** | **0.80** | 0.62 | 0.50 | 0.67 |
| `rf_global_mmlu_full` | 0.57 | **0.86** | 0.24 | 0.52 | 0.62 | 0.57 | 0.38 | 0.38 | 0.48 | 0.43 |
...
| `rf_belebele` | 0.48 | 0.38 | 0.62 | 0.43 | 0.38 | 0.29 | 0.43 | 0.62 | 0.52 | 0.57 |
| `belebele` | 0.29 | 0.33 | 0.38 | 0.57 | 0.33 | 0.29 | 0.38 | **0.81** | 0.67 | 0.64 |
| `rf_include_base_44` | 0.29 | 0.38 | 0.48 | 0.52 | 0.38 | 0.52 | 0.48 | 0.33 | 0.24 | **0.79** |
...
| `bpb` | 0.71 | 0.43 | **0.81** | 0.60 | 0.71 | **0.81** | **0.90** | 0.52 | 0.50 | **0.80** |
| `multiblimp` | **0.76** | 0.52 | 0.62 | 0.67 | 0.57 | 0.67 | 0.62 | 0.71 | 0.71 | 0.61 |
| `arc` | **0.81** | **0.76** | 0.62 | 0.43 | 0.57 | **0.76** | 0.52 | 0.48 | 0.38 | 0.46 |
| `rf_belebele` | 0.52 | 0.48 | 0.62 | **0.81** | 0.67 | 0.57 | 0.38 | 0.48 | 0.29 | 0.50 |
| `rf_global_mmlu_full` | 0.52 | 0.48 | 0.38 | 0.43 | 0.38 | 0.38 | 0.71 | 0.62 | 0.38 | 0.64 |
...
| `rf_include_base_44` | 0.29 | 0.57 | 0.19 | 0.38 | 0.57 | 0.57 | 0.52 | 0.24 | **0.76** | 0.32 |
| `rfgm_include_base_44` | 0.33 | 0.33 | 0.33 | 0.33 | **1.00** | 0.33 | 0.67 | 0.33 | 0.67 | 0.00 |
...
| `bpb` | 0.70 | 0.20 | **0.90** | 0.67 | 0.50 | **0.80** | **1.00** | 0.30 | 0.50 | **0.80** |
| `rf_belebele` | 0.70 | 0.30 | **0.80** | 0.60 | 0.20 | **0.90** | 0.70 | 0.30 | 0.50 | 0.67 |
| `belebele` | 0.60 | 0.20 | 0.60 | 0.20 | 0.60 | 0.40 | 0.40 | 0.60 | **0.80** | 0.47 |
| `rf_global_mmlu_full` | 0.10 | **0.80** | **0.90** | 0.20 | 0.30 | 0.20 | 0.70 | **0.90** | 0.20 | 0.33 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.81** | 0.71 | **0.83** | **0.87** | **0.90** | **0.92** | **0.93** | **0.80** | **0.80** | **0.92** |
| `hellaswag` | 0.68 | 0.63 | 0.64 | 0.71 | **0.82** | **0.91** | **0.90** | **0.82** | **0.82** | **0.84** |
| `xstorycloze` | **0.78** | 0.65 | 0.59 | 0.67 | 0.65 | 0.58 | 0.72 | 0.71 | **0.78** | 0.61 |
| `multiblimp` | **0.77** | **0.76** | 0.56 | 0.59 | **0.86** | 0.50 | 0.69 | 0.55 | 0.63 | 0.52 |
| `rf_global_mmlu_full` | 0.67 | 0.42 | 0.42 | 0.47 | 0.71 | 0.62 | 0.69 | **0.79** | 0.72 | **0.78** |
| `rfgm_include_base_44` | 0.50 | **0.83** | **0.83** | 0.17 | 0.70 | **0.80** | 0.60 | **0.80** | 0.50 | 0.40 |
| `arc` | 0.65 | 0.56 | 0.50 | 0.68 | 0.62 | 0.50 | 0.59 | **0.82** | 0.59 | 0.62 |
| `rf_belebele` | 0.58 | 0.58 | 0.55 | 0.64 | 0.62 | 0.68 | 0.60 | 0.62 | 0.54 | 0.64 |
| `xnli` | 0.51 | 0.53 | 0.52 | 0.55 | 0.46 | 0.53 | 0.32 | 0.61 | 0.71 | 0.57 |
| `belebele` | 0.46 | 0.71 | 0.68 | 0.59 | 0.44 | 0.48 | 0.36 | 0.55 | 0.63 | 0.35 |
| `rf_include_base_44` | 0.38 | 0.42 | 0.44 | 0.49 | 0.54 | 0.47 | 0.58 | 0.48 | 0.68 | 0.51 |
| `include_base_44` | 0.51 | 0.33 | 0.52 | 0.51 | 0.56 | 0.64 | 0.47 | 0.50 | 0.50 | 0.38 |
| `global_mmlu_full` | 0.49 | 0.46 | 0.30 | 0.63 | 0.46 | 0.35 | 0.50 | 0.50 | 0.58 | 0.50 |
| `xwinograd` | 0.41 | 0.38 | 0.61 | 0.36 | 0.42 | 0.39 | 0.50 | 0.32 | 0.53 | 0.55 |
| `global_piqa_parallel_cloze` | 0.35 | 0.25 | 0.45 | 0.44 | 0.38 | 0.48 | 0.41 | 0.41 | 0.47 | 0.63 |
...
| `bpb` | 0.60 | 0.40 | 0.60 | 0.50 | 0.60 | **1.00** | 0.67 | 0.60 | 0.50 | **0.80** |
| `hellaswag` | 0.60 | 0.30 | 0.40 | 0.60 | 0.70 | 0.60 | 0.60 | 0.50 | 0.50 | 0.60 |
| `rf_belebele` | 0.20 | 0.60 | 0.70 | **0.90** | 0.40 | 0.50 | 0.30 | 0.30 | 0.70 | 0.60 |
| `arc` | 0.50 | 0.30 | **0.80** | 0.60 | 0.20 | 0.40 | 0.50 | 0.40 | 0.70 | 0.67 |
| `rf_global_mmlu_full` | 0.60 | 0.40 | 0.20 | 0.50 | 0.60 | 0.40 | 0.50 | 0.60 | 0.70 | 0.53 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.67 | 0.50 | 0.50 |  | **0.83** | **0.83** |  | **1.00** |  | 0.67 |
| `rf_belebele` | 0.50 | 0.67 | 0.00 | 0.50 | 0.50 | 0.50 | **0.83** | 0.33 | 0.50 | 0.60 |
...
| `rf_include_base_44` | 0.33 | 0.50 | 0.50 | 0.33 | 0.50 | 0.17 | 0.67 | 0.17 | **0.83** | 0.07 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | **0.76** | 0.57 | **0.86** | **0.80** | **0.81** | **0.90** | **1.00** | 0.71 | 0.70 | **0.93** |
...
| `rf_belebele` | 0.52 | 0.43 | 0.38 | 0.52 | 0.43 | 0.38 | 0.52 | 0.29 | 0.62 | 0.33 |
...
| `bpb` | 0.60 | 0.10 | 0.70 | **0.83** | 0.50 | **0.90** | 0.67 | 0.40 | 0.33 | 0.60 |
...
| `rf_belebele` | 0.50 | 0.40 | 0.50 | 0.60 | 0.50 | 0.30 | 0.60 | 0.40 | 0.50 | 0.27 |
| `xcopa` | 0.50 | 0.40 | 0.40 | 0.40 | 0.10 | 0.10 | 0.50 | **0.80** | 0.60 | 0.60 |
| `rf_global_mmlu_full` | 0.20 | 0.40 | 0.50 | **0.90** | 0.40 | 0.50 | 0.30 | 0.30 | 0.30 | 0.53 |
| `rf_include_base_44` | 0.60 | 0.60 | 0.20 | 0.30 | 0.70 | 0.30 | 0.30 | 0.40 | 0.40 | 0.40 |
...
| `bpb` | **0.80** | 0.20 | **0.90** | 0.67 | 0.40 | 0.70 | **0.83** | 0.10 | 0.50 | **0.80** |
...
| `rf_global_mmlu_full` | 0.40 | 0.20 | 0.70 | 0.70 | 0.40 | 0.50 | 0.50 | 0.30 | 0.30 | 0.73 |
...
| `rf_include_base_44` | 0.50 | 0.70 | 0.40 | 0.40 | 0.30 | 0.40 | 0.60 | 0.50 | 0.40 | 0.13 |
| `arc` | 0.50 | 0.60 | 0.40 | 0.20 | 0.30 | 0.50 | 0.60 | 0.60 | 0.20 | 0.33 |
| `rf_belebele` | 0.40 | 0.10 | 0.40 | 0.40 | 0.60 | 0.40 | 0.70 | 0.40 | 0.70 | 0.07 |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.62 | 0.43 | **0.86** | 0.60 | **0.81** | **0.76** | **0.90** | 0.57 | 0.70 | **0.87** |
| `xcopa` | 0.48 | **0.76** | 0.52 | 0.71 | 0.29 | 0.57 | 0.71 | 0.38 | 0.57 | 0.71 |
| `hellaswag` | 0.57 | 0.43 | 0.57 | 0.52 | 0.29 | 0.52 | 0.52 | 0.67 | 0.62 | **0.86** |
| `rfgm_include_base_44` | **1.00** | 0.67 | 0.67 | 0.00 | 0.67 | 0.67 | 0.00 | **1.00** | 0.33 | 0.33 |
...
| `rf_include_base_44` | 0.48 | 0.67 | 0.52 | 0.43 | 0.24 | 0.38 | 0.24 | 0.38 | 0.48 | 0.61 |
| `rf_belebele` | 0.33 | 0.62 | 0.67 | 0.48 | 0.19 | 0.48 | 0.43 | 0.38 | 0.38 | 0.36 |
| `rf_global_mmlu_full` | 0.29 | 0.52 | 0.57 | 0.48 | 0.43 | 0.24 | 0.29 | 0.33 | 0.33 | **0.82** |
...
| benchmark | 175M→350M | 175M→600M | 175M→1B | 175M→1.7B | 350M→600M | 350M→1B | 350M→1.7B | 600M→1B | 600M→1.7B | 1B→1.7B |
|---|---|---|---|---|---|---|---|---|---|---|
| `bpb` | 0.69 | 0.55 | 0.75 | 0.71 | **0.85** | **0.95** | **0.82** | **0.80** | 0.71 | **0.84** |
| `xstorycloze` | 0.75 | 0.53 | 0.67 | 0.64 | 0.53 | 0.73 | 0.64 | 0.60 | 0.60 | 0.57 |
| `rfgm_include_base_44` | 0.50 | 0.33 | 0.67 | 0.67 | 0.50 | 0.50 | **0.83** | 0.50 | 0.67 | 0.67 |
| `rf_belebele_zho_Hant` | 0.47 | 0.56 | 0.47 | 0.53 | 0.62 | 0.56 | 0.58 | 0.64 | 0.45 | 0.51 |
| `rf_include_base_44` | 0.45 | 0.40 | 0.53 | 0.64 | 0.49 | 0.64 | 0.55 | 0.56 | 0.51 | 0.60 |
| `rf_global_mmlu_full` | 0.36 | 0.47 | 0.33 | 0.42 | 0.47 | 0.64 | **0.80** | 0.62 | 0.53 | 0.69 |
| `belebele_zho_Hant` | 0.65 | 0.47 | 0.56 | 0.53 | 0.56 | 0.47 | 0.60 | 0.65 | 0.44 | 0.37 |
| `arc` | 0.45 | 0.55 | 0.53 | 0.49 | 0.49 | 0.71 | 0.38 | 0.49 | 0.67 | 0.49 |
| `paws` | 0.47 | 0.69 | 0.42 | 0.55 | 0.65 | 0.51 | 0.44 | 0.56 | 0.42 | 0.38 |
| `global_mmlu_full` | 0.44 | 0.53 | 0.53 | 0.60 | 0.51 | 0.33 | 0.55 | 0.45 | 0.42 | 0.55 |
| `rf_belebele_zho_Hans` | 0.58 | 0.73 | 0.45 | 0.29 | 0.55 | 0.53 | 0.33 | 0.62 | 0.27 | 0.47 |
| `xnli` | 0.35 | 0.55 | 0.67 | 0.22 | 0.60 | 0.49 | 0.42 | 0.67 | 0.31 | 0.49 |
| `belebele_zho_Hans` | 0.58 | 0.60 | 0.47 | 0.40 | 0.31 | 0.33 | 0.33 | 0.55 | 0.53 | 0.58 |
| `include_base_44` | 0.55 | 0.40 | 0.75 | 0.27 | 0.51 | 0.56 | 0.36 | 0.42 | 0.33 | 0.38 |
| `xwinograd` | 0.38 | 0.35 | 0.20 | 0.22 | 0.36 | 0.62 | 0.45 | 0.64 | 0.60 | 0.54 |
| `global_piqa_parallel_cloze_cmn_hant` | 0.47 | 0.44 | 0.53 | 0.42 | 0.25 | 0.51 | 0.47 | 0.38 | 0.42 | 0.45 |
| `xcopa` | 0.38 | 0.38 | 0.45 | 0.51 | 0.25 | 0.51 | 0.35 | 0.40 | 0.53 | 0.47 |
| `global_piqa_parallel_cloze_cmn_hans` | 0.45 | 0.55 | 0.58 | 0.36 | 0.36 | 0.51 | 0.38 | 0.31 | 0.42 | 0.27 |
