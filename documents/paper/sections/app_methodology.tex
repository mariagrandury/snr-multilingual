...
\centering
\small
\caption{The scheme-A grid: seeds per $(N, L)$ cell. The shallow architecture uses the same seed grid. $L=100$ is trained only under the flattened AT3 scheme. In total the scheme-A deep analysis grid has 50 runs.}
\label{tab:grid}
