...
Examples:
    ...
    # One command
    cd /iopsstor/scratch/cscs/mariagrandury/pretrain/megatron/data-mix-small/ && git pull && conda activate && python launch_trainings.py --size 175M --mix_en 60 --seed 28
...
def submit(
    job_name: str, export_vars: str, dry_run: bool, nodes: Optional[int] = None
) -> None:
    cmd = [
        "sbatch",
        f"--job-name={job_name}",
