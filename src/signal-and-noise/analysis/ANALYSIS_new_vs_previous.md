...
(git HEAD, `analysis/rq03_noise_and_snr/seeds_*`). Supersedes the earlier draft at
`results/pretraining/ANALYSIS_new_vs_previous.md`.

## Output layout (new)

`results/<analysis>/<stage>/<pool>/`, e.g.
`analysis/rq03_noise_and_snr/pretraining/custom_swissai_hf/`,
`analysis/rq00_gate_and_curves/pretraining/seeds_28_1797_1904/`,
`analysis/rq09_benchmark_design/pretraining/<pool>/`,
`analysis/rq07_external_frameworks/pretraining/<pool>/`,
`analysis/rq08_subset_selection/pretraining/<pool>/`.
...
under `analysis/rq08_subset_selection/pretraining/<pool>/`. Per-item (Option-D)
