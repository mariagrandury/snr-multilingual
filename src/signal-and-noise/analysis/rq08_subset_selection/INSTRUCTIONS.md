...
- [analysis/rq08_subset_selection/smooth_subtasks.py](../../analysis/rq08_subset_selection/smooth_subtasks.py)
  — three cases:
...
- [analysis/rq08_subset_selection/smooth_subtasks_per_sample.py](../../analysis/rq08_subset_selection/smooth_subtasks_per_sample.py)
...
```bash
python analysis/rq08_subset_selection/smooth_subtasks.py
```
...
- Documents the method (cite
  `analysis/rq08_subset_selection/smooth_subtasks_per_sample.py`).
...
```bash
python analysis/rq08_subset_selection/smooth_subtasks_per_sample.py
```
...
Write `analysis/rq08_subset_selection/README.md`:
