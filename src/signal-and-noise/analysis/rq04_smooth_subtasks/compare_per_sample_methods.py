...
Usage:
    python analysis/rq04_smooth_subtasks/compare_per_sample_methods.py
    python analysis/rq04_smooth_subtasks/compare_per_sample_methods.py --methods A,D
"""
...
PER_SAMPLE_ROOT = SMOOTH_SUBTASKS / "per_sample"
...
def write_highlights(path, merged, agg, ov, bextra, cacorr, methods):
    ...
    L.append(f"_{n_cells} (language, benchmark, size) cells; methods compared: "
             f"{', '.join(labels)}._\n")
    L.append("> Generated by `analysis/rq04_smooth_subtasks/compare_per_sample_methods.py`. Per-sample "
