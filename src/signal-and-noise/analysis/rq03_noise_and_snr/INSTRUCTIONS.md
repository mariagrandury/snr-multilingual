...
- [analysis/rq03_noise_and_snr/run_apertus_snr_variants.py](../../analysis/rq03_noise_and_snr/run_apertus_snr_variants.py)
...
- [analysis/rq04_surrogates/analyze_snr_variants.py](../../analysis/rq04_surrogates/analyze_snr_variants.py)
...
```bash
python analysis/rq03_noise_and_snr/run_apertus_snr_variants.py
```

Confirms the loader works against the local parquet. Should write
`analysis/rq03_noise_and_snr/snr_variants_per_task.csv` (~280 columns × ~820
tasks).

### Step 2 — render existing plot grid

```bash
python analysis/rq04_surrogates/analyze_snr_variants.py
```
...
Save a new file `analysis/rq03_noise_and_snr/best_variant_per_language.csv`
...
Write `analysis/rq03_noise_and_snr/README.md`:
